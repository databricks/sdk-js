...
export const unmarshalCreateTableSchema: z.ZodType<CreateTable> = z
  .object({
    name: z.string().optional(),
...
export const unmarshalCreateTableConstraintSchema: z.ZodType<CreateTableConstraint> =
  z
    .object({
      ...
      constraint: z.lazy(() => unmarshalTableConstraintSchema).optional(),
    })
    .transform(d => ({
...
export const unmarshalUpdateTableSchema: z.ZodType<UpdateTable> = z
  .object({
    full_name_arg: z.string().optional(),
    name: z.string().optional(),
    catalog_name: z.string().optional(),
...
export const marshalConditionalDisplaySchema = z
  .object({
...
export const marshalCreateTableSchema = z
  .object({
    name: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCreateTable_PropertiesEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const marshalCreateTableConstraintSchema = z
  .object({
...
export const marshalDeleteTableSchema = z
  .object({
    fullNameArg: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteTable_ResponseSchema = z.object({});

export const marshalDeleteTableConstraintSchema = z
  .object({
    fullNameArg: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteTableConstraint_ResponseSchema = z.object({});
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeltaRuntimePropertiesKvPairs_DeltaRuntimePropertiesEntrySchema =
  z
    .object({
      key: z.string().optional(),
      value: z.string().optional(),
...
export const marshalGetTableSchema = z
  .object({
    fullNameArg: z.string().optional(),
...
export const marshalListTableSummariesSchema = z
  .object({
    catalogName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListTableSummaries_ResponseSchema = z
  .object({
    tables: z.array(z.lazy(() => marshalTableSummarySchema)).optional(),
...
export const marshalListTablesSchema = z
  .object({
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
    maxResults: z.number().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListTables_ResponseSchema = z
  .object({
    tables: z.array(z.lazy(() => marshalTableInfoSchema)).optional(),
    nextPageToken: z.string().optional(),
  })
  .transform(d => ({
    tables: d.tables,
...
export const marshalTableExistsSchema = z
  .object({
    fullNameArg: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalTableExists_ResponseSchema = z
  .object({
    tableExists: z.boolean().optional(),
  })
  .transform(d => ({
    table_exists: d.tableExists,
  }));

export const marshalTableInfoSchema = z
  .object({
    name: z.string().optional(),
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalTableInfo_PropertiesEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const marshalTableSummarySchema = z
  .object({
    fullName: z.string().optional(),
    tableType: z.enum(TableType).optional(),
    securableKindManifest: z
...
export const marshalUpdateTableSchema = z
  .object({
    fullNameArg: z.string().optional(),
    name: z.string().optional(),
    catalogName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateTable_PropertiesEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateTable_ResponseSchema = z.object({});
