...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCreateTable_PropertiesEntrySchema: z.ZodType<CreateTable_PropertiesEntry> = z
  .object({
...
export const unmarshalCreateTableConstraintSchema: z.ZodType<CreateTableConstraint> = z
  .object({
...
export const unmarshalDeleteTableConstraintSchema: z.ZodType<DeleteTableConstraint> = z
  .object({
    full_name_arg: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeltaRuntimePropertiesKvPairs_DeltaRuntimePropertiesEntrySchema: z.ZodType<DeltaRuntimePropertiesKvPairs_DeltaRuntimePropertiesEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const unmarshalListTableSummariesSchema: z.ZodType<ListTableSummaries> = z
  .object({
    catalog_name: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalTableInfo_PropertiesEntrySchema: z.ZodType<TableInfo_PropertiesEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalUpdateTable_PropertiesEntrySchema: z.ZodType<UpdateTable_PropertiesEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteTable_ResponseSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteTableConstraint_ResponseSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeltaRuntimePropertiesKvPairs_DeltaRuntimePropertiesEntrySchema: z.ZodType = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListTables_ResponseSchema: z.ZodType = z
  .object({
...
export const marshalTableInfoSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateTable_ResponseSchema: z.ZodType = z
  .object({
  });
