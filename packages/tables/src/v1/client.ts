...
export class Client {
   ...
   */
  async createTable(req: CreateTableRequest, options?: CallOptions): Promise<TableInfo> {
   ...
   */
  async createTableConstraint(req: CreateTableConstraintRequest, options?: CallOptions): Promise<TableConstraint> {
   ...
   */
  async deleteTable(req: DeleteTableRequest, options?: CallOptions): Promise<DeleteTableRequest_Response> {
   ...
   */
  async deleteTableConstraint(req: DeleteTableConstraintRequest, options?: CallOptions): Promise<DeleteTableConstraintRequest_Response> {
   ...
   */
  async getTable(req: GetTableRequest, options?: CallOptions): Promise<TableInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/tables/${req.fullNameArg ?? ''}`;
    const params = new URLSearchParams();
   ...
   */
  async listTableSummaries(req: ListTableSummariesRequest, options?: CallOptions): Promise<ListTableSummariesRequest_Response> {
  ...
  async *listTableSummariesIter(req: ListTableSummariesRequest, options?: CallOptions): AsyncGenerator<TableSummary> {
   ...
   * Clients must continue reading pages until next_page_token is absent, which is the only indication that the end of results has been reached.
   */
  async listTables(req: ListTablesRequest, options?: CallOptions): Promise<ListTablesRequest_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/tables`;
    const params = new URLSearchParams();
    if (req.catalogName !== undefined) {
      params.append('catalog_name', req.catalogName);
  ...
  async *listTablesIter(req: ListTablesRequest, options?: CallOptions): AsyncGenerator<TableInfo> {
   ...
   */
  async tableExists(req: TableExistsRequest, options?: CallOptions): Promise<TableExistsRequest_Response> {
   ...
   * or be the owner of the table and have the **USE_CATALOG** privilege on the parent catalog and the **USE_SCHEMA** privilege on the parent schema.
   */
  async updateTable(req: UpdateTableRequest, options?: CallOptions): Promise<UpdateTableRequest_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/tables/${req.fullNameArg ?? ''}`;
