...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalListQueries_ResponseSchema: z.ZodType<ListQueries_Response> = z
  .object({
...
export const marshalQueryMetricsSchema: z.ZodType = z
  .object({
    ...
    taskTimeOverTimeRange: z.lazy(() => marshalTaskTimeOverRangeSchema).optional(),
...
export const marshalTaskTimeOverRangeSchema: z.ZodType = z
  .object({
    entries: z.array(z.lazy(() => marshalTaskTimeOverRangeEntrySchema)).optional(),
    interval: z.number().optional(),
  })
  .transform(d => ({
    entries: d.entries,
