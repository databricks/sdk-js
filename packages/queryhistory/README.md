...
```bash
npm install @databricks/sdk-queryhistory
```

## Usage

```typescript
import {QueryHistoryClient} from '@databricks/sdk-queryhistory/v1';

const client = new QueryHistoryClient({});
```
