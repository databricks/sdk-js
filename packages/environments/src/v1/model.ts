...
export const unmarshalCreateWorkspaceBaseEnvironmentRequestSchema = z
  .object({
...
export const unmarshalDefaultWorkspaceBaseEnvironmentSchema = z
  .object({
...
export const unmarshalDeleteWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const unmarshalGetDefaultWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const unmarshalGetWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const unmarshalListWorkspaceBaseEnvironmentsRequestSchema = z
  .object({
...
export const unmarshalListWorkspaceBaseEnvironmentsResponseSchema = z
  .object({
...
export const unmarshalRefreshWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const unmarshalUpdateDefaultWorkspaceBaseEnvironmentRequestSchema = z
  .object({
...
export const unmarshalUpdateWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
    workspace_base_environment: z
      .lazy(() => unmarshalWorkspaceBaseEnvironmentSchema)
...
export const unmarshalWorkspaceBaseEnvironmentSchema = z
  .object({
    name: z.string().optional(),
...
export const unmarshalWorkspaceBaseEnvironmentCacheSchema = z.object({});

export const unmarshalWorkspaceBaseEnvironmentOperationMetadataSchema =
  z.object({});

export const marshalCreateWorkspaceBaseEnvironmentRequestSchema = z
  .object({
...
export const marshalDefaultWorkspaceBaseEnvironmentSchema = z
  .object({
    name: z.string().optional(),
...
export const marshalDeleteWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalGetDefaultWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalGetWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalListWorkspaceBaseEnvironmentsRequestSchema = z
  .object({
...
export const marshalListWorkspaceBaseEnvironmentsResponseSchema = z
  .object({
...
export const marshalRefreshWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalUpdateDefaultWorkspaceBaseEnvironmentRequestSchema = z
  .object({
...
export const marshalUpdateWorkspaceBaseEnvironmentRequestSchema = z
  .object({
    name: z.string().optional(),
    workspaceBaseEnvironment: z
      .lazy(() => marshalWorkspaceBaseEnvironmentSchema)
...
export const marshalWorkspaceBaseEnvironmentSchema = z
  .object({
    name: z.string().optional(),
...
export const marshalWorkspaceBaseEnvironmentCacheSchema = z.object({});

export const marshalWorkspaceBaseEnvironmentOperationMetadataSchema = z.object(
  {}
);
