...
export const marshalCreateRegisteredModelSchema = z
  .object({
    name: z.string().optional(),
...
export const marshalDeleteModelVersionSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteModelVersion_ResponseSchema = z.object({});

export const marshalDeleteRegisteredModelSchema = z
  .object({
    fullNameArg: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteRegisteredModel_ResponseSchema = z.object({});

export const marshalDeleteRegisteredModelAliasSchema = z
  .object({
    fullNameArg: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteRegisteredModelAlias_ResponseSchema = z.object({});
...
export const marshalGetModelVersionSchema = z
  .object({
    fullNameArg: z.string().optional(),
    versionArg: z.number().optional(),
...
export const marshalGetModelVersionByAliasSchema = z
  .object({
    fullNameArg: z.string().optional(),
    aliasArg: z.string().optional(),
    includeAliases: z.boolean().optional(),
...
export const marshalGetRegisteredModelSchema = z
  .object({
    fullNameArg: z.string().optional(),
    includeAliases: z.boolean().optional(),
    includeBrowse: z.boolean().optional(),
...
export const marshalListModelVersionsSchema = z
  .object({
    fullNameArg: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListModelVersions_ResponseSchema = z
  .object({
    modelVersions: z
...
export const marshalListRegisteredModelsSchema = z
  .object({
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
    includeBrowse: z.boolean().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListRegisteredModels_ResponseSchema = z
  .object({
    registeredModels: z
...
export const marshalModelVersionInfoSchema = z
  .object({
...
export const marshalRegisteredModelAliasInfoSchema = z
  .object({
...
export const marshalRegisteredModelInfoSchema = z
  .object({
    name: z.string().optional(),
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
...
export const marshalSetRegisteredModelAliasSchema = z
  .object({
    fullNameArg: z.string().optional(),
    aliasArg: z.string().optional(),
    versionNum: z.number().optional(),
...
export const marshalUpdateModelVersionSchema = z
  .object({
    fullNameArg: z.string().optional(),
    versionArg: z.number().optional(),
    modelName: z.string().optional(),
...
export const marshalUpdateRegisteredModelSchema = z
  .object({
    fullNameArg: z.string().optional(),
