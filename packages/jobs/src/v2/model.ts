...
export const marshalCreateJobRequestSchema: z.ZodType = z
  .object({
    ...
    trigger: z.lazy(() => marshalTriggerSettingsSchema).optional(),
    continuous: z.lazy(() => marshalContinuousSettingsSchema).optional(),
    maxConcurrentRuns: z.number().optional(),
    tasks: z.array(z.lazy(() => marshalTaskSettingsSchema)).optional(),
...
export const marshalModelTriggerConfigurationSchema: z.ZodType = z
  .object({
