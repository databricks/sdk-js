...
export interface UpdateToken {
  ...
  updateMask?: FieldMask<FieldPaths<AdminTokenInfo>> | undefined;
}
...
export const unmarshalCreateOnBehalfOfTokenSchema: z.ZodType<CreateOnBehalfOfToken> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCreateOnBehalfOfToken_ResponseSchema: z.ZodType<CreateOnBehalfOfToken_Response> = z
  .object({
...
export const unmarshalUpdateTokenSchema: z.ZodType<UpdateToken> = z
  .object({
    ...
    update_mask: z.string().transform(s => FieldMask.of(...(s === '' ? [] : s.split(','))) as FieldMask<FieldPaths<AdminTokenInfo>>).optional(),
  })
  .transform(d => ({
    token: d.token,
...
export const marshalUpdateTokenSchema: z.ZodType = z
  .object({
    ...
    updateMask: z.any().transform((d: FieldMask<FieldPaths<AdminTokenInfo>>) => d.paths.join(',')).optional(),
  })
  .transform(d => ({
    token: d.token,
