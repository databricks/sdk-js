...
export class Client {
  ...
  async createOnBehalfOfToken(signal: AbortSignal | undefined, req: CreateOnBehalfOfToken, options?: Options): Promise<CreateOnBehalfOfToken_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      resp = parseResponse(respBody, unmarshalCreateOnBehalfOfToken_ResponseSchema);
    };
  ...
  async deleteToken(signal: AbortSignal | undefined, req: RevokeToken, options?: Options): Promise<RevokeToken_Response> {
  ...
  async getToken(signal: AbortSignal | undefined, req: GetToken, options?: Options): Promise<GetToken_Response> {
    const url = `${this.host}/api/2.0/token-management/tokens/${req.tokenId ?? ''}`;
  ...
  async listTokens(signal: AbortSignal | undefined, req: ListTokens, options?: Options): Promise<ListTokens_Response> {
  ...
  async updateToken(signal: AbortSignal | undefined, req: UpdateToken, options?: Options): Promise<AdminTokenInfo> {
