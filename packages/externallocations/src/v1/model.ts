...
export const unmarshalCreateExternalLocationSchema: z.ZodType<CreateExternalLocation> = z
  .object({
...
export const unmarshalDeleteExternalLocationSchema: z.ZodType<DeleteExternalLocation> = z
  .object({
...
export const unmarshalGetExternalLocationSchema: z.ZodType<GetExternalLocation> = z
  .object({
    name_arg: z.string().optional(),
...
export const unmarshalListExternalLocationsSchema: z.ZodType<ListExternalLocations> = z
  .object({
    include_browse: z.boolean().optional(),
...
export const unmarshalUpdateExternalLocationSchema: z.ZodType<UpdateExternalLocation> = z
  .object({
    name_arg: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteExternalLocation_ResponseSchema: z.ZodType = z
  .object({
  });
...
export const marshalListExternalLocations_ResponseSchema: z.ZodType = z
  .object({
    externalLocations: z.array(z.lazy(() => marshalExternalLocationInfoSchema)).optional(),
