...
export const marshalExternalLocationInfoSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    url: z.string().optional(),
    credentialName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListExternalLocations_ResponseSchema: z.ZodType = z
  .object({
    externalLocations: z
...
const awsSqsQueueFieldMaskSchema: FieldMaskSchema = {
  managedResourceId: {wire: 'managed_resource_id'},
  queueUrl: {wire: 'queue_url'},
};

export function awsSqsQueueFieldMask(
  ...paths: string[]
): FieldMask<AwsSqsQueue> {
  return FieldMask.build<AwsSqsQueue>(paths, awsSqsQueueFieldMaskSchema);
}

const azureQueueStorageFieldMaskSchema: FieldMaskSchema = {
  managedResourceId: {wire: 'managed_resource_id'},
  queueUrl: {wire: 'queue_url'},
...
export function azureQueueStorageFieldMask(
  ...paths: string[]
): FieldMask<AzureQueueStorage> {
  return FieldMask.build<AzureQueueStorage>(
    paths,
    azureQueueStorageFieldMaskSchema
  );
}

const createExternalLocationFieldMaskSchema: FieldMaskSchema = {
  ...
  effectiveEnableFileEvents: {wire: 'effective_enable_file_events'},
  effectiveFileEventQueue: {
    wire: 'effective_file_event_queue',
    children: () => fileEventQueueFieldMaskSchema,
  },
  enableFileEvents: {wire: 'enable_file_events'},
  encryptionDetails: {
...
export function createExternalLocationFieldMask(
  ...paths: string[]
): FieldMask<CreateExternalLocation> {
  return FieldMask.build<CreateExternalLocation>(
    paths,
    createExternalLocationFieldMaskSchema
  );
}

const deleteExternalLocationFieldMaskSchema: FieldMaskSchema = {
  force: {wire: 'force'},
  nameArg: {wire: 'name_arg'},
};

export function deleteExternalLocationFieldMask(
  ...paths: string[]
): FieldMask<DeleteExternalLocation> {
  return FieldMask.build<DeleteExternalLocation>(
    paths,
    deleteExternalLocationFieldMaskSchema
  );
}

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
const deleteExternalLocation_ResponseFieldMaskSchema: FieldMaskSchema = {};

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export function deleteExternalLocation_ResponseFieldMask(
  ...paths: string[]
): FieldMask<DeleteExternalLocation_Response> {
  return FieldMask.build<DeleteExternalLocation_Response>(
    paths,
    deleteExternalLocation_ResponseFieldMaskSchema
  );
}
...
const externalLocationInfoFieldMaskSchema: FieldMaskSchema = {
  browseOnly: {wire: 'browse_only'},
  comment: {wire: 'comment'},
  createdAt: {wire: 'created_at'},
  createdBy: {wire: 'created_by'},
...
export function externalLocationInfoFieldMask(
  ...paths: string[]
): FieldMask<ExternalLocationInfo> {
  return FieldMask.build<ExternalLocationInfo>(
    paths,
    externalLocationInfoFieldMaskSchema
  );
}

const fileEventQueueFieldMaskSchema: FieldMaskSchema = {
  managedAqs: {
    wire: 'managed_aqs',
    children: () => azureQueueStorageFieldMaskSchema,
  },
  managedPubsub: {
    wire: 'managed_pubsub',
    children: () => gcpPubsubFieldMaskSchema,
  },
  managedSqs: {wire: 'managed_sqs', children: () => awsSqsQueueFieldMaskSchema},
  providedAqs: {
    wire: 'provided_aqs',
    children: () => azureQueueStorageFieldMaskSchema,
  },
  providedPubsub: {
    wire: 'provided_pubsub',
    children: () => gcpPubsubFieldMaskSchema,
  },
  providedSqs: {
    wire: 'provided_sqs',
    children: () => awsSqsQueueFieldMaskSchema,
  },
};

export function fileEventQueueFieldMask(
  ...paths: string[]
): FieldMask<FileEventQueue> {
  return FieldMask.build<FileEventQueue>(paths, fileEventQueueFieldMaskSchema);
}

const gcpPubsubFieldMaskSchema: FieldMaskSchema = {
  managedResourceId: {wire: 'managed_resource_id'},
  subscriptionName: {wire: 'subscription_name'},
};

export function gcpPubsubFieldMask(...paths: string[]): FieldMask<GcpPubsub> {
  return FieldMask.build<GcpPubsub>(paths, gcpPubsubFieldMaskSchema);
}

const getExternalLocationFieldMaskSchema: FieldMaskSchema = {
  includeBrowse: {wire: 'include_browse'},
  nameArg: {wire: 'name_arg'},
};

export function getExternalLocationFieldMask(
  ...paths: string[]
): FieldMask<GetExternalLocation> {
  return FieldMask.build<GetExternalLocation>(
    paths,
    getExternalLocationFieldMaskSchema
  );
}

const listExternalLocationsFieldMaskSchema: FieldMaskSchema = {
  includeBrowse: {wire: 'include_browse'},
...
export function listExternalLocationsFieldMask(
  ...paths: string[]
): FieldMask<ListExternalLocations> {
  return FieldMask.build<ListExternalLocations>(
    paths,
    listExternalLocationsFieldMaskSchema
  );
}

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
const listExternalLocations_ResponseFieldMaskSchema: FieldMaskSchema = {
  externalLocations: {wire: 'external_locations'},
  nextPageToken: {wire: 'next_page_token'},
};

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export function listExternalLocations_ResponseFieldMask(
  ...paths: string[]
): FieldMask<ListExternalLocations_Response> {
  return FieldMask.build<ListExternalLocations_Response>(
    paths,
    listExternalLocations_ResponseFieldMaskSchema
  );
}
...
const updateExternalLocationFieldMaskSchema: FieldMaskSchema = {
  browseOnly: {wire: 'browse_only'},
  comment: {wire: 'comment'},
  createdAt: {wire: 'created_at'},
  createdBy: {wire: 'created_by'},
...
export function updateExternalLocationFieldMask(
  ...paths: string[]
): FieldMask<UpdateExternalLocation> {
  return FieldMask.build<UpdateExternalLocation>(
    paths,
    updateExternalLocationFieldMaskSchema
  );
}
