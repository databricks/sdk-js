...
export const unmarshalDownloadRequestSchema = z
  .object({
...
export const unmarshalDownloadResponseSchema = z
  .object({
...
export const marshalDownloadRequestSchema = z
  .object({
...
export const marshalDownloadResponseSchema = z
  .object({
    content: z.string().optional(),
  })
  .transform(d => ({
