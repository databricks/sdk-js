...
export const unmarshalAllowedAppsUserApiScopesMessageSchema: z.ZodType<AllowedAppsUserApiScopesMessage> = z
  .object({
...
export const unmarshalOperationalEmailCustomRecipientMessageSchema: z.ZodType<OperationalEmailCustomRecipientMessage> = z
  .object({
...
export const unmarshalSettingSchema: z.ZodType<Setting> = z
  .object({
    ...
    allowed_apps_user_api_scopes: z.lazy(() => unmarshalAllowedAppsUserApiScopesMessageSchema).optional(),
    operational_email_custom_recipient: z.lazy(() => unmarshalOperationalEmailCustomRecipientMessageSchema).optional(),
    ...
    effective_allowed_apps_user_api_scopes: z.lazy(() => unmarshalAllowedAppsUserApiScopesMessageSchema).optional(),
    effective_operational_email_custom_recipient: z.lazy(() => unmarshalOperationalEmailCustomRecipientMessageSchema).optional(),
  })
  .transform(d => ({
    name: d.name,
    value: d.boolean_val !== undefined ? { $case: 'booleanVal' as const, booleanVal: d.boolean_val } : d.string_val !== undefined ? { $case: 'stringVal' as const, stringVal: d.string_val } : d.integer_val !== undefined ? { $case: 'integerVal' as const, integerVal: d.integer_val } : d.automatic_cluster_update_workspace !== undefined ? { $case: 'automaticClusterUpdateWorkspace' as const, automaticClusterUpdateWorkspace: d.automatic_cluster_update_workspace } : d.aibi_dashboard_embedding_approved_domains !== undefined ? { $case: 'aibiDashboardEmbeddingApprovedDomains' as const, aibiDashboardEmbeddingApprovedDomains: d.aibi_dashboard_embedding_approved_domains } : d.aibi_dashboard_embedding_access_policy !== undefined ? { $case: 'aibiDashboardEmbeddingAccessPolicy' as const, aibiDashboardEmbeddingAccessPolicy: d.aibi_dashboard_embedding_access_policy } : d.restrict_workspace_admins !== undefined ? { $case: 'restrictWorkspaceAdmins' as const, restrictWorkspaceAdmins: d.restrict_workspace_admins } : d.personal_compute !== undefined ? { $case: 'personalCompute' as const, personalCompute: d.personal_compute } : d.allowed_apps_user_api_scopes !== undefined ? { $case: 'allowedAppsUserApiScopes' as const, allowedAppsUserApiScopes: d.allowed_apps_user_api_scopes } : d.operational_email_custom_recipient !== undefined ? { $case: 'operationalEmailCustomRecipient' as const, operationalEmailCustomRecipient: d.operational_email_custom_recipient } : undefined,
    effectiveValue: d.effective_boolean_val !== undefined ? { $case: 'effectiveBooleanVal' as const, effectiveBooleanVal: d.effective_boolean_val } : d.effective_string_val !== undefined ? { $case: 'effectiveStringVal' as const, effectiveStringVal: d.effective_string_val } : d.effective_integer_val !== undefined ? { $case: 'effectiveIntegerVal' as const, effectiveIntegerVal: d.effective_integer_val } : d.effective_automatic_cluster_update_workspace !== undefined ? { $case: 'effectiveAutomaticClusterUpdateWorkspace' as const, effectiveAutomaticClusterUpdateWorkspace: d.effective_automatic_cluster_update_workspace } : d.effective_aibi_dashboard_embedding_approved_domains !== undefined ? { $case: 'effectiveAibiDashboardEmbeddingApprovedDomains' as const, effectiveAibiDashboardEmbeddingApprovedDomains: d.effective_aibi_dashboard_embedding_approved_domains } : d.effective_aibi_dashboard_embedding_access_policy !== undefined ? { $case: 'effectiveAibiDashboardEmbeddingAccessPolicy' as const, effectiveAibiDashboardEmbeddingAccessPolicy: d.effective_aibi_dashboard_embedding_access_policy } : d.effective_restrict_workspace_admins !== undefined ? { $case: 'effectiveRestrictWorkspaceAdmins' as const, effectiveRestrictWorkspaceAdmins: d.effective_restrict_workspace_admins } : d.effective_personal_compute !== undefined ? { $case: 'effectivePersonalCompute' as const, effectivePersonalCompute: d.effective_personal_compute } : d.effective_allowed_apps_user_api_scopes !== undefined ? { $case: 'effectiveAllowedAppsUserApiScopes' as const, effectiveAllowedAppsUserApiScopes: d.effective_allowed_apps_user_api_scopes } : d.effective_operational_email_custom_recipient !== undefined ? { $case: 'effectiveOperationalEmailCustomRecipient' as const, effectiveOperationalEmailCustomRecipient: d.effective_operational_email_custom_recipient } : undefined,
  }));
...
export const unmarshalUserPreferenceSchema: z.ZodType<UserPreference> = z
  ...
  .transform(d => ({
    name: d.name,
    userId: d.user_id,
    value: d.boolean_val !== undefined ? { $case: 'booleanVal' as const, booleanVal: d.boolean_val } : d.string_val !== undefined ? { $case: 'stringVal' as const, stringVal: d.string_val } : undefined,
    effectiveValue: d.effective_boolean_val !== undefined ? { $case: 'effectiveBooleanVal' as const, effectiveBooleanVal: d.effective_boolean_val } : d.effective_string_val !== undefined ? { $case: 'effectiveStringVal' as const, effectiveStringVal: d.effective_string_val } : undefined,
  }));
...
export const marshalSettingSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    value: z.discriminatedUnion('$case', [z.object({ $case: z.literal('booleanVal'), booleanVal: z.lazy(() => marshalBooleanMessageSchema) }), z.object({ $case: z.literal('stringVal'), stringVal: z.lazy(() => marshalStringMessageSchema) }), z.object({ $case: z.literal('integerVal'), integerVal: z.lazy(() => marshalIntegerMessageSchema) }), z.object({ $case: z.literal('automaticClusterUpdateWorkspace'), automaticClusterUpdateWorkspace: z.lazy(() => marshalClusterAutoRestartMessageSchema) }), z.object({ $case: z.literal('aibiDashboardEmbeddingApprovedDomains'), aibiDashboardEmbeddingApprovedDomains: z.lazy(() => marshalAibiDashboardEmbeddingApprovedDomainsSchema) }), z.object({ $case: z.literal('aibiDashboardEmbeddingAccessPolicy'), aibiDashboardEmbeddingAccessPolicy: z.lazy(() => marshalAibiDashboardEmbeddingAccessPolicySchema) }), z.object({ $case: z.literal('restrictWorkspaceAdmins'), restrictWorkspaceAdmins: z.lazy(() => marshalRestrictWorkspaceAdminsMessageSchema) }), z.object({ $case: z.literal('personalCompute'), personalCompute: z.lazy(() => marshalPersonalComputeMessageSchema) }), z.object({ $case: z.literal('allowedAppsUserApiScopes'), allowedAppsUserApiScopes: z.lazy(() => marshalAllowedAppsUserApiScopesMessageSchema) }), z.object({ $case: z.literal('operationalEmailCustomRecipient'), operationalEmailCustomRecipient: z.lazy(() => marshalOperationalEmailCustomRecipientMessageSchema) })]).optional(),
    effectiveValue: z.discriminatedUnion('$case', [z.object({ $case: z.literal('effectiveBooleanVal'), effectiveBooleanVal: z.lazy(() => marshalBooleanMessageSchema) }), z.object({ $case: z.literal('effectiveStringVal'), effectiveStringVal: z.lazy(() => marshalStringMessageSchema) }), z.object({ $case: z.literal('effectiveIntegerVal'), effectiveIntegerVal: z.lazy(() => marshalIntegerMessageSchema) }), z.object({ $case: z.literal('effectiveAutomaticClusterUpdateWorkspace'), effectiveAutomaticClusterUpdateWorkspace: z.lazy(() => marshalClusterAutoRestartMessageSchema) }), z.object({ $case: z.literal('effectiveAibiDashboardEmbeddingApprovedDomains'), effectiveAibiDashboardEmbeddingApprovedDomains: z.lazy(() => marshalAibiDashboardEmbeddingApprovedDomainsSchema) }), z.object({ $case: z.literal('effectiveAibiDashboardEmbeddingAccessPolicy'), effectiveAibiDashboardEmbeddingAccessPolicy: z.lazy(() => marshalAibiDashboardEmbeddingAccessPolicySchema) }), z.object({ $case: z.literal('effectiveRestrictWorkspaceAdmins'), effectiveRestrictWorkspaceAdmins: z.lazy(() => marshalRestrictWorkspaceAdminsMessageSchema) }), z.object({ $case: z.literal('effectivePersonalCompute'), effectivePersonalCompute: z.lazy(() => marshalPersonalComputeMessageSchema) }), z.object({ $case: z.literal('effectiveAllowedAppsUserApiScopes'), effectiveAllowedAppsUserApiScopes: z.lazy(() => marshalAllowedAppsUserApiScopesMessageSchema) }), z.object({ $case: z.literal('effectiveOperationalEmailCustomRecipient'), effectiveOperationalEmailCustomRecipient: z.lazy(() => marshalOperationalEmailCustomRecipientMessageSchema) })]).optional(),
  })
  .transform(d => ({
    name: d.name,
    ...
    ...(d.value?.$case === 'automaticClusterUpdateWorkspace' && { automatic_cluster_update_workspace: d.value.automaticClusterUpdateWorkspace }),
    ...(d.value?.$case === 'aibiDashboardEmbeddingApprovedDomains' && { aibi_dashboard_embedding_approved_domains: d.value.aibiDashboardEmbeddingApprovedDomains }),
    ...(d.value?.$case === 'aibiDashboardEmbeddingAccessPolicy' && { aibi_dashboard_embedding_access_policy: d.value.aibiDashboardEmbeddingAccessPolicy }),
    ...(d.value?.$case === 'restrictWorkspaceAdmins' && { restrict_workspace_admins: d.value.restrictWorkspaceAdmins }),
    ...(d.value?.$case === 'personalCompute' && { personal_compute: d.value.personalCompute }),
    ...(d.value?.$case === 'allowedAppsUserApiScopes' && { allowed_apps_user_api_scopes: d.value.allowedAppsUserApiScopes }),
    ...(d.value?.$case === 'operationalEmailCustomRecipient' && { operational_email_custom_recipient: d.value.operationalEmailCustomRecipient }),
    ...(d.effectiveValue?.$case === 'effectiveBooleanVal' && { effective_boolean_val: d.effectiveValue.effectiveBooleanVal }),
    ...(d.effectiveValue?.$case === 'effectiveStringVal' && { effective_string_val: d.effectiveValue.effectiveStringVal }),
    ...(d.effectiveValue?.$case === 'effectiveIntegerVal' && { effective_integer_val: d.effectiveValue.effectiveIntegerVal }),
    ...(d.effectiveValue?.$case === 'effectiveAutomaticClusterUpdateWorkspace' && { effective_automatic_cluster_update_workspace: d.effectiveValue.effectiveAutomaticClusterUpdateWorkspace }),
    ...(d.effectiveValue?.$case === 'effectiveAibiDashboardEmbeddingApprovedDomains' && { effective_aibi_dashboard_embedding_approved_domains: d.effectiveValue.effectiveAibiDashboardEmbeddingApprovedDomains }),
    ...(d.effectiveValue?.$case === 'effectiveAibiDashboardEmbeddingAccessPolicy' && { effective_aibi_dashboard_embedding_access_policy: d.effectiveValue.effectiveAibiDashboardEmbeddingAccessPolicy }),
    ...(d.effectiveValue?.$case === 'effectiveRestrictWorkspaceAdmins' && { effective_restrict_workspace_admins: d.effectiveValue.effectiveRestrictWorkspaceAdmins }),
    ...(d.effectiveValue?.$case === 'effectivePersonalCompute' && { effective_personal_compute: d.effectiveValue.effectivePersonalCompute }),
    ...(d.effectiveValue?.$case === 'effectiveAllowedAppsUserApiScopes' && { effective_allowed_apps_user_api_scopes: d.effectiveValue.effectiveAllowedAppsUserApiScopes }),
    ...(d.effectiveValue?.$case === 'effectiveOperationalEmailCustomRecipient' && { effective_operational_email_custom_recipient: d.effectiveValue.effectiveOperationalEmailCustomRecipient }),
  }));
...
export const marshalUserPreferenceSchema: z.ZodType = z
  .object({
    ...
    value: z.discriminatedUnion('$case', [z.object({ $case: z.literal('booleanVal'), booleanVal: z.lazy(() => marshalBooleanMessageSchema) }), z.object({ $case: z.literal('stringVal'), stringVal: z.lazy(() => marshalStringMessageSchema) })]).optional(),
    effectiveValue: z.discriminatedUnion('$case', [z.object({ $case: z.literal('effectiveBooleanVal'), effectiveBooleanVal: z.lazy(() => marshalBooleanMessageSchema) }), z.object({ $case: z.literal('effectiveStringVal'), effectiveStringVal: z.lazy(() => marshalStringMessageSchema) })]).optional(),
  })
  .transform(d => ({
    name: d.name,
    user_id: d.userId,
