...
export function aibiDashboardEmbeddingAccessPolicyFieldMask(
  ...paths: string[]
): FieldMask<AibiDashboardEmbeddingAccessPolicy> {
  return FieldMask.build<AibiDashboardEmbeddingAccessPolicy>(
    paths,
    aibiDashboardEmbeddingAccessPolicyFieldMaskSchema
  );
}
...
export function aibiDashboardEmbeddingApprovedDomainsFieldMask(
  ...paths: string[]
): FieldMask<AibiDashboardEmbeddingApprovedDomains> {
  return FieldMask.build<AibiDashboardEmbeddingApprovedDomains>(
    paths,
    aibiDashboardEmbeddingApprovedDomainsFieldMaskSchema
  );
}
...
export function booleanMessageFieldMask(
  ...paths: string[]
): FieldMask<BooleanMessage> {
  return FieldMask.build<BooleanMessage>(paths, booleanMessageFieldMaskSchema);
}
...
export function clusterAutoRestartMessageFieldMask(
  ...paths: string[]
): FieldMask<ClusterAutoRestartMessage> {
  return FieldMask.build<ClusterAutoRestartMessage>(
    paths,
    clusterAutoRestartMessageFieldMaskSchema
  );
}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export function clusterAutoRestartMessage_EnablementDetailsFieldMask(
  ...paths: string[]
): FieldMask<ClusterAutoRestartMessage_EnablementDetails> {
  return FieldMask.build<ClusterAutoRestartMessage_EnablementDetails>(
    paths,
    clusterAutoRestartMessage_EnablementDetailsFieldMaskSchema
  );
}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export function clusterAutoRestartMessage_MaintenanceWindowFieldMask(
  ...paths: string[]
): FieldMask<ClusterAutoRestartMessage_MaintenanceWindow> {
  return FieldMask.build<ClusterAutoRestartMessage_MaintenanceWindow>(
    paths,
    clusterAutoRestartMessage_MaintenanceWindowFieldMaskSchema
  );
}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export function clusterAutoRestartMessage_MaintenanceWindow_WeekDayBasedScheduleFieldMask(
  ...paths: string[]
): FieldMask<ClusterAutoRestartMessage_MaintenanceWindow_WeekDayBasedSchedule> {
  return FieldMask.build<ClusterAutoRestartMessage_MaintenanceWindow_WeekDayBasedSchedule>(
    paths,
    clusterAutoRestartMessage_MaintenanceWindow_WeekDayBasedScheduleFieldMaskSchema
  );
}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export function clusterAutoRestartMessage_MaintenanceWindow_WindowStartTimeFieldMask(
  ...paths: string[]
): FieldMask<ClusterAutoRestartMessage_MaintenanceWindow_WindowStartTime> {
  return FieldMask.build<ClusterAutoRestartMessage_MaintenanceWindow_WindowStartTime>(
    paths,
    clusterAutoRestartMessage_MaintenanceWindow_WindowStartTimeFieldMaskSchema
  );
}

const getPublicAccountSettingRequestFieldMaskSchema: FieldMaskSchema = {
  accountId: {wire: 'account_id'},
  name: {wire: 'name'},
};

export function getPublicAccountSettingRequestFieldMask(
  ...paths: string[]
): FieldMask<GetPublicAccountSettingRequest> {
  return FieldMask.build<GetPublicAccountSettingRequest>(
    paths,
    getPublicAccountSettingRequestFieldMaskSchema
  );
}

const getPublicAccountUserPreferenceRequestFieldMaskSchema: FieldMaskSchema = {
  accountId: {wire: 'account_id'},
  name: {wire: 'name'},
  userId: {wire: 'user_id'},
};

export function getPublicAccountUserPreferenceRequestFieldMask(
  ...paths: string[]
): FieldMask<GetPublicAccountUserPreferenceRequest> {
  return FieldMask.build<GetPublicAccountUserPreferenceRequest>(
    paths,
    getPublicAccountUserPreferenceRequestFieldMaskSchema
  );
}
...
export function getPublicWorkspaceSettingRequestFieldMask(
  ...paths: string[]
): FieldMask<GetPublicWorkspaceSettingRequest> {
  return FieldMask.build<GetPublicWorkspaceSettingRequest>(
    paths,
    getPublicWorkspaceSettingRequestFieldMaskSchema
  );
}

const integerMessageFieldMaskSchema: FieldMaskSchema = {
  value: {wire: 'value'},
};

export function integerMessageFieldMask(
  ...paths: string[]
): FieldMask<IntegerMessage> {
  return FieldMask.build<IntegerMessage>(paths, integerMessageFieldMaskSchema);
}

const listAccountSettingsMetadataRequestFieldMaskSchema: FieldMaskSchema = {
  accountId: {wire: 'account_id'},
  pageSize: {wire: 'page_size'},
  pageToken: {wire: 'page_token'},
};

export function listAccountSettingsMetadataRequestFieldMask(
  ...paths: string[]
): FieldMask<ListAccountSettingsMetadataRequest> {
  return FieldMask.build<ListAccountSettingsMetadataRequest>(
    paths,
    listAccountSettingsMetadataRequestFieldMaskSchema
  );
}

const listAccountSettingsMetadataResponseFieldMaskSchema: FieldMaskSchema = {
  nextPageToken: {wire: 'next_page_token'},
  settingsMetadata: {wire: 'settings_metadata'},
};

export function listAccountSettingsMetadataResponseFieldMask(
  ...paths: string[]
): FieldMask<ListAccountSettingsMetadataResponse> {
  return FieldMask.build<ListAccountSettingsMetadataResponse>(
    paths,
    listAccountSettingsMetadataResponseFieldMaskSchema
  );
}

const listAccountUserPreferencesMetadataRequestFieldMaskSchema: FieldMaskSchema =
  {
    accountId: {wire: 'account_id'},
    pageSize: {wire: 'page_size'},
    pageToken: {wire: 'page_token'},
...
export function listAccountUserPreferencesMetadataRequestFieldMask(
  ...paths: string[]
): FieldMask<ListAccountUserPreferencesMetadataRequest> {
  return FieldMask.build<ListAccountUserPreferencesMetadataRequest>(
    paths,
    listAccountUserPreferencesMetadataRequestFieldMaskSchema
  );
}

const listAccountUserPreferencesMetadataResponseFieldMaskSchema: FieldMaskSchema =
  {
    nextPageToken: {wire: 'next_page_token'},
    settingsMetadata: {wire: 'settings_metadata'},
  };

export function listAccountUserPreferencesMetadataResponseFieldMask(
  ...paths: string[]
): FieldMask<ListAccountUserPreferencesMetadataResponse> {
  return FieldMask.build<ListAccountUserPreferencesMetadataResponse>(
    paths,
    listAccountUserPreferencesMetadataResponseFieldMaskSchema
  );
}

const listWorkspaceSettingsMetadataRequestFieldMaskSchema: FieldMaskSchema = {
  pageSize: {wire: 'page_size'},
  pageToken: {wire: 'page_token'},
};

export function listWorkspaceSettingsMetadataRequestFieldMask(
  ...paths: string[]
): FieldMask<ListWorkspaceSettingsMetadataRequest> {
  return FieldMask.build<ListWorkspaceSettingsMetadataRequest>(
    paths,
    listWorkspaceSettingsMetadataRequestFieldMaskSchema
  );
}

const listWorkspaceSettingsMetadataResponseFieldMaskSchema: FieldMaskSchema = {
  nextPageToken: {wire: 'next_page_token'},
  settingsMetadata: {wire: 'settings_metadata'},
};

export function listWorkspaceSettingsMetadataResponseFieldMask(
  ...paths: string[]
): FieldMask<ListWorkspaceSettingsMetadataResponse> {
  return FieldMask.build<ListWorkspaceSettingsMetadataResponse>(
    paths,
    listWorkspaceSettingsMetadataResponseFieldMaskSchema
  );
}

const patchPublicAccountSettingRequestFieldMaskSchema: FieldMaskSchema = {
  accountId: {wire: 'account_id'},
  name: {wire: 'name'},
  setting: {wire: 'setting', children: () => settingFieldMaskSchema},
};

export function patchPublicAccountSettingRequestFieldMask(
  ...paths: string[]
): FieldMask<PatchPublicAccountSettingRequest> {
  return FieldMask.build<PatchPublicAccountSettingRequest>(
    paths,
    patchPublicAccountSettingRequestFieldMaskSchema
  );
}

const patchPublicAccountUserPreferenceRequestFieldMaskSchema: FieldMaskSchema =
  {
    accountId: {wire: 'account_id'},
    name: {wire: 'name'},
    setting: {wire: 'setting', children: () => userPreferenceFieldMaskSchema},
    userId: {wire: 'user_id'},
  };

export function patchPublicAccountUserPreferenceRequestFieldMask(
  ...paths: string[]
): FieldMask<PatchPublicAccountUserPreferenceRequest> {
  return FieldMask.build<PatchPublicAccountUserPreferenceRequest>(
    paths,
    patchPublicAccountUserPreferenceRequestFieldMaskSchema
  );
}

const patchPublicWorkspaceSettingRequestFieldMaskSchema: FieldMaskSchema = {
  name: {wire: 'name'},
  setting: {wire: 'setting', children: () => settingFieldMaskSchema},
};

export function patchPublicWorkspaceSettingRequestFieldMask(
  ...paths: string[]
): FieldMask<PatchPublicWorkspaceSettingRequest> {
  return FieldMask.build<PatchPublicWorkspaceSettingRequest>(
    paths,
    patchPublicWorkspaceSettingRequestFieldMaskSchema
  );
}

const personalComputeMessageFieldMaskSchema: FieldMaskSchema = {
  value: {wire: 'value'},
};

export function personalComputeMessageFieldMask(
  ...paths: string[]
): FieldMask<PersonalComputeMessage> {
  return FieldMask.build<PersonalComputeMessage>(
    paths,
    personalComputeMessageFieldMaskSchema
  );
}
...
export function restrictWorkspaceAdminsMessageFieldMask(
  ...paths: string[]
): FieldMask<RestrictWorkspaceAdminsMessage> {
  return FieldMask.build<RestrictWorkspaceAdminsMessage>(
    paths,
    restrictWorkspaceAdminsMessageFieldMaskSchema
  );
}

const settingFieldMaskSchema: FieldMaskSchema = {
  aibiDashboardEmbeddingAccessPolicy: {
  ...
  effectiveAibiDashboardEmbeddingAccessPolicy: {
    wire: 'effective_aibi_dashboard_embedding_access_policy',
    children: () => aibiDashboardEmbeddingAccessPolicyFieldMaskSchema,
  },
  effectiveAibiDashboardEmbeddingApprovedDomains: {
    wire: 'effective_aibi_dashboard_embedding_approved_domains',
    children: () => aibiDashboardEmbeddingApprovedDomainsFieldMaskSchema,
  },
  effectiveAutomaticClusterUpdateWorkspace: {
    wire: 'effective_automatic_cluster_update_workspace',
    children: () => clusterAutoRestartMessageFieldMaskSchema,
  },
  effectiveBooleanVal: {
    wire: 'effective_boolean_val',
    children: () => booleanMessageFieldMaskSchema,
  },
  effectiveIntegerVal: {
    wire: 'effective_integer_val',
    children: () => integerMessageFieldMaskSchema,
  },
  effectivePersonalCompute: {
    wire: 'effective_personal_compute',
    children: () => personalComputeMessageFieldMaskSchema,
  },
  effectiveRestrictWorkspaceAdmins: {
    wire: 'effective_restrict_workspace_admins',
    children: () => restrictWorkspaceAdminsMessageFieldMaskSchema,
  },
  effectiveStringVal: {
    wire: 'effective_string_val',
    children: () => stringMessageFieldMaskSchema,
  },
  integerVal: {
    wire: 'integer_val',
    children: () => integerMessageFieldMaskSchema,
...
export function settingFieldMask(...paths: string[]): FieldMask<Setting> {
  return FieldMask.build<Setting>(paths, settingFieldMaskSchema);
}

const settingsMetadataFieldMaskSchema: FieldMaskSchema = {
  description: {wire: 'description'},
  displayName: {wire: 'display_name'},
  docsLink: {wire: 'docs_link'},
  name: {wire: 'name'},
  previewPhase: {wire: 'preview_phase'},
  type: {wire: 'type'},
};

export function settingsMetadataFieldMask(
  ...paths: string[]
): FieldMask<SettingsMetadata> {
  return FieldMask.build<SettingsMetadata>(
    paths,
    settingsMetadataFieldMaskSchema
  );
}
...
export function stringMessageFieldMask(
  ...paths: string[]
): FieldMask<StringMessage> {
  return FieldMask.build<StringMessage>(paths, stringMessageFieldMaskSchema);
}

const userPreferenceFieldMaskSchema: FieldMaskSchema = {
  booleanVal: {
    wire: 'boolean_val',
    children: () => booleanMessageFieldMaskSchema,
  },
...
export function userPreferenceFieldMask(
  ...paths: string[]
): FieldMask<UserPreference> {
  return FieldMask.build<UserPreference>(paths, userPreferenceFieldMaskSchema);
}
