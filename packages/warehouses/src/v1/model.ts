...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCreateWarehouseRequest_ResponseSchema: z.ZodType<CreateWarehouseRequest_Response> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalGetWarehouseRequest_ResponseSchema: z.ZodType<GetWarehouseRequest_Response> = z
  .object({
    id: z.string().optional(),
    name: z.string().optional(),
    cluster_size: z.string().optional(),
