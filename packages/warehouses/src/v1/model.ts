...
export const unmarshalSetWorkspaceWarehouseConfigRequestSchema: z.ZodType<SetWorkspaceWarehouseConfigRequest> =
  z
    .object({
      security_policy: z.enum(EndpointSecurityPolicy).optional(),
      data_access_config: z
...
export const marshalCreateDefaultWarehouseOverrideRequestSchema = z
  .object({
...
export const marshalCreateWarehouseSchema = z
  .object({
    name: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCreateWarehouse_ResponseSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalDeleteDefaultWarehouseOverrideRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEditWarehouseRequest_ResponseSchema = z.object({});
...
export const marshalEndpointHealthSchema = z
  .object({
    status: z.enum(EndpointHealth_Status).optional(),
    message: z.string().optional(),
...
export const marshalEndpointInfoSchema = z
  .object({
    id: z.string().optional(),
    name: z.string().optional(),
    clusterSize: z.string().optional(),
...
export const marshalGetDefaultWarehouseOverrideRequestSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalGetWarehouseSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetWarehouse_ResponseSchema = z
  .object({
    id: z.string().optional(),
    name: z.string().optional(),
    clusterSize: z.string().optional(),
...
export const marshalGetWorkspaceWarehouseConfigRequestSchema = z.object({});

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetWorkspaceWarehouseConfigRequest_ResponseSchema = z
  .object({
...
export const marshalListDefaultWarehouseOverridesRequestSchema = z
  .object({
...
export const marshalListDefaultWarehouseOverridesResponseSchema = z
  .object({
    defaultWarehouseOverrides: z
      .array(z.lazy(() => marshalDefaultWarehouseOverrideSchema))
      .optional(),
...
export const marshalOdbcParamsSchema = z
  .object({
    hostname: z.string().optional(),
    path: z.string().optional(),
    protocol: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalSetWorkspaceWarehouseConfigRequest_ResponseSchema =
  z.object({});

export const marshalTerminationReasonSchema = z
  .object({
    code: z.enum(TerminationCode).optional(),
    type: z.enum(TerminationType).optional(),
    parameters: z.record(z.string(), z.string()).optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalTerminationReason_ParametersEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const marshalUpdateDefaultWarehouseOverrideRequestSchema = z
  .object({
    defaultWarehouseOverride: z
      .lazy(() => marshalDefaultWarehouseOverrideSchema)
      .optional(),
...
export const marshalDeleteWarehouseRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteWarehouseRequest_ResponseSchema = z.object({});

export const marshalListWarehousesRequestSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListWarehousesRequest_ResponseSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalStartRequest_ResponseSchema = z.object({});
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalStopRequest_ResponseSchema = z.object({});
