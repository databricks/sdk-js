...
export const marshalEffectivePrivilegeSchema = z
  .object({
    privilege: z.string().optional(),
...
export const marshalEffectivePrivilegeAssignmentSchema = z
  .object({
    principal: z.string().optional(),
    privileges: z
...
export const marshalGetEffectivePermissionsSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetEffectivePermissions_ResponseSchema = z
  .object({
...
export const marshalGetPermissionsSchema = z
  .object({
    securableType: z.string().optional(),
    securableFullName: z.string().optional(),
    principal: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetPermissions_ResponseSchema = z
  .object({
    nextPageToken: z.string().optional(),
    privilegeAssignments: z
...
export const marshalListPrivilegeAssignmentsRequestSchema = z
  .object({
    securableType: z.string().optional(),
...
export const marshalListPrivilegeAssignmentsResponseSchema = z
  .object({
    privilegeAssignments: z
      .array(z.lazy(() => marshalPrivilegeAssignmentSchema))
      .optional(),
...
export const marshalPrivilegeAssignmentSchema = z
  .object({
    principal: z.string().optional(),
    privileges: z.array(z.string()).optional(),
    principalId: z.number().optional(),
...
export const marshalUpdatePermissionsSchema = z
  .object({
    securableType: z.string().optional(),
    securableFullName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdatePermissions_ResponseSchema = z
  .object({
    privilegeAssignments: z
      .array(z.lazy(() => marshalPrivilegeAssignmentSchema))
      .optional(),
