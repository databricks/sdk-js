...
export const marshalCreateMetastoreSchema = z
  .object({
    name: z.string().optional(),
...
export const marshalCreateMetastoreAssignmentSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCreateMetastoreAssignment_ResponseSchema = z.object({});

export const marshalDeleteMetastoreSchema = z
  .object({
    id: z.string().optional(),
    force: z.boolean().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteMetastore_ResponseSchema = z.object({});

export const marshalDeleteMetastoreAssignmentSchema = z
  .object({
    workspaceId: z.number().optional(),
    metastoreId: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteMetastoreAssignment_ResponseSchema = z.object({});

export const marshalDeltaSharingScopeSchema = z.object({});

export const marshalGetCurrentMetastoreAssignmentSchema = z.object({});

export const marshalGetMetastoreSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalGetMetastoreSummarySchema = z.object({});

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetMetastoreSummary_ResponseSchema = z
  .object({
    metastoreId: z.string().optional(),
    name: z.string().optional(),
    defaultDataAccessConfigId: z.string().optional(),
...
export const marshalListGlobalMetastoresRequestSchema = z
  .object({
...
export const marshalListGlobalMetastoresResponseSchema = z
  .object({
...
export const marshalListMetastoresSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListMetastores_ResponseSchema = z
  .object({
    metastores: z.array(z.lazy(() => marshalMetastoreInfoSchema)).optional(),
    nextPageToken: z.string().optional(),
  })
...
export const marshalMetastoreAssignmentSchema = z
  .object({
    workspaceId: z.number().optional(),
    metastoreId: z.string().optional(),
    defaultCatalogName: z.string().optional(),
...
export const marshalMetastoreInfoSchema = z
  .object({
    name: z.string().optional(),
    storageRoot: z.string().optional(),
    defaultDataAccessConfigId: z.string().optional(),
...
export const marshalUpdateMetastoreSchema = z
  .object({
    id: z.string().optional(),
...
export const marshalUpdateMetastoreAssignmentSchema = z
  .object({
    workspaceId: z.number().optional(),
    metastoreId: z.string().optional(),
    defaultCatalogName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateMetastoreAssignment_ResponseSchema = z.object({});
