...
export class Client {
   ...
   */
  async createMetastore(signal: AbortSignal | undefined, req: CreateMetastore, options?: Options): Promise<MetastoreInfo> {
   ...
   */
  async createMetastoreAssignment(signal: AbortSignal | undefined, req: CreateMetastoreAssignment, options?: Options): Promise<CreateMetastoreAssignment_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalCreateMetastoreAssignment_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async deleteMetastore(signal: AbortSignal | undefined, req: DeleteMetastore, options?: Options): Promise<DeleteMetastore_Response> {
  ...
  async deleteMetastoreAssignment(signal: AbortSignal | undefined, req: DeleteMetastoreAssignment, options?: Options): Promise<DeleteMetastoreAssignment_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/workspaces/${String(req.workspaceId ?? '')}/metastore`;
    const params = new URLSearchParams();
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('DELETE', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalDeleteMetastoreAssignment_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async getCurrentMetastoreAssignment(signal: AbortSignal | undefined, _req: GetCurrentMetastoreAssignment, options?: Options): Promise<MetastoreAssignment> {
  ...
  async getMetastore(signal: AbortSignal | undefined, req: GetMetastore, options?: Options): Promise<MetastoreInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/metastores/${req.id ?? ''}`;
    let resp: MetastoreInfo | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   */
  async getMetastoreSummary(signal: AbortSignal | undefined, _req: GetMetastoreSummary, options?: Options): Promise<GetMetastoreSummary_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', url, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetMetastoreSummary_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async listMetastores(signal: AbortSignal | undefined, req: ListMetastores, options?: Options): Promise<ListMetastores_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/metastores`;
    const params = new URLSearchParams();
  ...
  async *listMetastoresIter(signal: AbortSignal | undefined, req: ListMetastores, options?: Options): AsyncGenerator<MetastoreInfo> {
   ...
   * to the System User.
   */
  async updateMetastore(signal: AbortSignal | undefined, req: UpdateMetastore, options?: Options): Promise<MetastoreInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/metastores/${req.id ?? ''}`;
   ...
   */
  async updateMetastoreAssignment(signal: AbortSignal | undefined, req: UpdateMetastoreAssignment, options?: Options): Promise<UpdateMetastoreAssignment_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/workspaces/${String(req.workspaceId ?? '')}/metastore`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('PATCH', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdateMetastoreAssignment_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
