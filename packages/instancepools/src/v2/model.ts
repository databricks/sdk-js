...
export interface CreateInstancePool_CustomTagsEntry {
  /**
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface CreateInstancePool_Response {
...
export interface DeleteInstancePool_Response {}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface EditInstancePool_CustomTagsEntry {
  /**
   * The key of the tag. The key length must be between 1 and 127 UTF-8 characters, inclusive.
   * For a list of all restrictions, see the AWS docs here:
   * http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#tag-restrictions
...
// eslint-disable-next-line @typescript-eslint/naming-convention, @typescript-eslint/no-empty-object-type -- Proto-style nested message name.
export interface EditInstancePool_Response {}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface GetInstancePool_Response {
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface GetInstancePool_Response_CustomTagsEntry {
  /**
   * The key of the tag. The key length must be between 1 and 127 UTF-8 characters, inclusive.
   * For a list of all restrictions, see the AWS docs here:
   * http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#tag-restrictions
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface GetInstancePool_Response_DefaultTagsEntry {
  /**
   * The key of the tag. The key length must be between 1 and 127 UTF-8 characters, inclusive.
   * For a list of all restrictions, see the AWS docs here:
   * http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#tag-restrictions
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface ListInstancePools_Response {
...
export const unmarshalCreateInstancePoolSchema: z.ZodType<CreateInstancePool> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCreateInstancePool_CustomTagsEntrySchema: z.ZodType<CreateInstancePool_CustomTagsEntry> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCreateInstancePool_ResponseSchema: z.ZodType<CreateInstancePool_Response> = z
  .object({
...
export const unmarshalDeleteInstancePoolSchema: z.ZodType<DeleteInstancePool> = z
  .object({
    instance_pool_id: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeleteInstancePool_ResponseSchema: z.ZodType<DeleteInstancePool_Response> = z
  .object({
  });
...
export const unmarshalEditInstancePoolSchema: z.ZodType<EditInstancePool> = z
  .object({
    instance_pool_id: z.string().optional(),
    instance_pool_name: z.string().optional(),
    min_idle_instances: z.number().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalEditInstancePool_CustomTagsEntrySchema: z.ZodType<EditInstancePool_CustomTagsEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalEditInstancePool_ResponseSchema: z.ZodType<EditInstancePool_Response> = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalGetInstancePool_ResponseSchema: z.ZodType<GetInstancePool_Response> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalGetInstancePool_Response_CustomTagsEntrySchema: z.ZodType<GetInstancePool_Response_CustomTagsEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalGetInstancePool_Response_DefaultTagsEntrySchema: z.ZodType<GetInstancePool_Response_DefaultTagsEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalInstancePoolAndStats_CustomTagsEntrySchema: z.ZodType<InstancePoolAndStats_CustomTagsEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalInstancePoolAndStats_DefaultTagsEntrySchema: z.ZodType<InstancePoolAndStats_DefaultTagsEntry> = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const unmarshalListInstancePoolsSchema: z.ZodType<ListInstancePools> = z
  .object({
  });

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalListInstancePools_ResponseSchema: z.ZodType<ListInstancePools_Response> = z
  .object({
...
export const marshalCreateInstancePoolSchema: z.ZodType = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCreateInstancePool_ResponseSchema: z.ZodType = z
  .object({
...
export const marshalDeleteInstancePoolSchema: z.ZodType = z
  .object({
    instancePoolId: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteInstancePool_ResponseSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEditInstancePool_ResponseSchema: z.ZodType = z
  .object({
  });
...
export const marshalGetInstancePool_ResponseSchema: z.ZodType = z
  .object({
    ...
    status: z.lazy(() => marshalInstancePoolStatusSchema).optional(),
    instancePoolId: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetInstancePool_Response_CustomTagsEntrySchema: z.ZodType = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetInstancePool_Response_DefaultTagsEntrySchema: z.ZodType = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const marshalInstancePoolStatsSchema: z.ZodType = z
  .object({
    usedCount: z.number().optional(),
    idleCount: z.number().optional(),
    pendingUsedCount: z.number().optional(),
    pendingIdleCount: z.number().optional(),
  })
  .transform(d => ({
    used_count: d.usedCount,
    idle_count: d.idleCount,
    pending_used_count: d.pendingUsedCount,
    pending_idle_count: d.pendingIdleCount,
  }));

export const marshalInstancePoolStatusSchema: z.ZodType = z
  .object({
    pendingInstanceErrors: z.array(z.lazy(() => marshalPendingInstanceErrorSchema)).optional(),
  })
  .transform(d => ({
    pending_instance_errors: d.pendingInstanceErrors,
  }));

export const marshalListInstancePoolsSchema: z.ZodType = z
  .object({
  });
...
export const marshalListInstancePools_ResponseSchema: z.ZodType = z
  .object({
    instancePools: z.array(z.lazy(() => marshalInstancePoolAndStatsSchema)).optional(),
  })
  .transform(d => ({
    instance_pools: d.instancePools,
  }));
...
export const marshalPendingInstanceErrorSchema: z.ZodType = z
  .object({
