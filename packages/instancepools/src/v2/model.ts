...
export const unmarshalCreateInstancePoolSchema: z.ZodType<CreateInstancePool> =
  z
    .object({
...
export const unmarshalDeleteInstancePoolSchema: z.ZodType<DeleteInstancePool> =
  z
    .object({
      instance_pool_id: z.string().optional(),
    })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeleteInstancePool_ResponseSchema: z.ZodType<DeleteInstancePool_Response> =
  z.object({});
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteInstancePool_ResponseSchema: z.ZodType = z.object({});
...
export const marshalInstancePoolStatusSchema: z.ZodType = z
  .object({
    pendingInstanceErrors: z
      .array(z.lazy(() => marshalPendingInstanceErrorSchema))
      .optional(),
  })
  .transform(d => ({
...
export const marshalListInstancePools_ResponseSchema: z.ZodType = z
  .object({
    instancePools: z
      .array(z.lazy(() => marshalInstancePoolAndStatsSchema))
      .optional(),
  })
  .transform(d => ({
