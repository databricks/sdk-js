...
export class Client {
  ...
  async batchCreateMaterializedFeatures(req: BatchCreateMaterializedFeaturesRequest, options?: CallOptions): Promise<BatchCreateMaterializedFeaturesResponse> {
  ...
  /** Create a Feature. */
  async createFeature(req: CreateFeatureRequest, options?: CallOptions): Promise<Feature> {
   ...
   */
  async createKafkaConfig(req: CreateKafkaConfigRequest, options?: CallOptions): Promise<KafkaConfig> {
  ...
  async createMaterializedFeature(req: CreateMaterializedFeatureRequest, options?: CallOptions): Promise<MaterializedFeature> {
  ...
  /** Delete a Feature. */
  async deleteFeature(req: DeleteFeatureRequest, options?: CallOptions): Promise<void> {
   ...
   * Only the creator of the Kafka config can delete it.
   */
  async deleteKafkaConfig(req: DeleteKafkaConfigRequest, options?: CallOptions): Promise<void> {
  ...
  async deleteMaterializedFeature(req: DeleteMaterializedFeatureRequest, options?: CallOptions): Promise<void> {
  ...
  /** Get a Feature. */
  async getFeature(req: GetFeatureRequest, options?: CallOptions): Promise<Feature> {
    const url = `${this.host}/api/2.0/feature-engineering/features/${req.fullName ?? ''}`;
    let resp: Feature | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   * Only the creator of the Kafka config can delete it.
   */
  async getKafkaConfig(req: GetKafkaConfigRequest, options?: CallOptions): Promise<KafkaConfig> {
    const url = `${this.host}/api/2.0/feature-engineering/features/kafka-configs/${req.name ?? ''}`;
    let resp: KafkaConfig | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
  ...
  async getMaterializedFeature(req: GetMaterializedFeatureRequest, options?: CallOptions): Promise<MaterializedFeature> {
    const url = `${this.host}/api/2.0/feature-engineering/materialized-features/${req.materializedFeatureId ?? ''}`;
    let resp: MaterializedFeature | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
  ...
  /** List Features. */
  async listFeatures(req: ListFeaturesRequest, options?: CallOptions): Promise<ListFeaturesResponse> {
    const url = `${this.host}/api/2.0/feature-engineering/features`;
  ...
  async *listFeaturesIter(req: ListFeaturesRequest, options?: CallOptions): AsyncGenerator<Feature> {
   ...
   * Only the creator of the Kafka config can delete it.
   */
  async listKafkaConfigs(req: ListKafkaConfigsRequest, options?: CallOptions): Promise<ListKafkaConfigsResponse> {
    const url = `${this.host}/api/2.0/feature-engineering/features/kafka-configs`;
    const params = new URLSearchParams();
    if (req.pageToken !== undefined) {
      params.append('page_token', req.pageToken);
  ...
  async *listKafkaConfigsIter(req: ListKafkaConfigsRequest, options?: CallOptions): AsyncGenerator<KafkaConfig> {
  ...
  async listMaterializedFeatures(req: ListMaterializedFeaturesRequest, options?: CallOptions): Promise<ListMaterializedFeaturesResponse> {
    const url = `${this.host}/api/2.0/feature-engineering/materialized-features`;
    const params = new URLSearchParams();
  ...
  async *listMaterializedFeaturesIter(req: ListMaterializedFeaturesRequest, options?: CallOptions): AsyncGenerator<MaterializedFeature> {
  ...
  /** Update a Feature. */
  async updateFeature(req: UpdateFeatureRequest, options?: CallOptions): Promise<Feature> {
   ...
   * Only the creator of the Kafka config can delete it.
   */
  async updateKafkaConfig(req: UpdateKafkaConfigRequest, options?: CallOptions): Promise<KafkaConfig> {
  ...
  async updateMaterializedFeature(req: UpdateMaterializedFeatureRequest, options?: CallOptions): Promise<MaterializedFeature> {
