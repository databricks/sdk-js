...
export interface BatchCreateMaterializedFeaturesRequest {
  ...
  requests?: CreateCreateMaterializedFeatureRequest[] | undefined;
}
...
export interface CreateCreateMaterializedFeatureRequest {
...
export interface CreateFeatureRequest {
  /** Feature to create. */
  feature?: CreateFeature | undefined;
}
...
export interface CreateKafkaConfigRequest {
  kafkaConfig?: CreateKafkaConfig | undefined;
}
...
export interface CreateMaterializedFeatureRequest {
  /** The materialized feature to create. */
  materializedFeature?: CreateMaterializedFeature | undefined;
}
...
export const marshalBatchCreateMaterializedFeaturesRequestSchema: z.ZodType = z
  .object({
    requests: z
      .array(z.lazy(() => marshalCreateCreateMaterializedFeatureRequestSchema))
      .optional(),
  })
  .transform(d => ({
    requests: d.requests,
...
export const marshalCreateCreateMaterializedFeatureRequestSchema: z.ZodType = z
  .object({
