...
export const unmarshalIngestionConfigSchema: z.ZodType<IngestionConfig> = z
  .object({
    ...
    ingestion_job_id: z.number().optional(),
    backfill_job_id: z.number().optional(),
  })
  .transform(d => ({
...
export const marshalIngestionConfigSchema: z.ZodType = z
  .object({
    ...
    ingestionJobId: z.number().optional(),
    backfillJobId: z.number().optional(),
  })
  .transform(d => ({
