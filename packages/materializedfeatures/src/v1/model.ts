...
export interface UpdateFeatureTagRequest {
  ...
  updateMask?: FieldMask<FieldPaths<FeatureTag>> | undefined;
}

export const unmarshalCreateFeatureTagRequestSchema: z.ZodType<CreateFeatureTagRequest> = z
  .object({
...
export const unmarshalDeleteFeatureTagRequestSchema: z.ZodType<DeleteFeatureTagRequest> = z
  .object({
    table_name: z.string().optional(),
    feature_name: z.string().optional(),
...
export const unmarshalGetFeatureLineageRequestSchema: z.ZodType<GetFeatureLineageRequest> = z
  .object({
    feature_name: z.string().optional(),
    table_name: z.string().optional(),
  })
...
export const unmarshalGetFeatureTagRequestSchema: z.ZodType<GetFeatureTagRequest> = z
  .object({
    table_name: z.string().optional(),
    feature_name: z.string().optional(),
    key: z.string().optional(),
...
export const unmarshalListFeatureTagsRequestSchema: z.ZodType<ListFeatureTagsRequest> = z
  .object({
    table_name: z.string().optional(),
    feature_name: z.string().optional(),
...
export const unmarshalUpdateFeatureTagRequestSchema: z.ZodType<UpdateFeatureTagRequest> = z
  .object({
    table_name: z.string().optional(),
    feature_name: z.string().optional(),
    feature_tag: z.lazy(() => unmarshalFeatureTagSchema).optional(),
    update_mask: z.string().transform(s => FieldMask.of(...(s === '' ? [] : s.split(','))) as FieldMask<FieldPaths<FeatureTag>>).optional(),
  })
  .transform(d => ({
    tableName: d.table_name,
    featureName: d.feature_name,
...
export const marshalFeatureLineageSchema: z.ZodType = z
  .object({
    ...
    featureSpecs: z.array(z.lazy(() => marshalFeatureLineage_FeatureSpecSchema)).optional(),
    onlineFeatures: z.array(z.lazy(() => marshalFeatureLineage_OnlineFeatureSchema)).optional(),
  })
  .transform(d => ({
    models: d.models,
...
export const marshalUpdateFeatureTagRequestSchema: z.ZodType = z
  .object({
    ...
    featureName: z.string().optional(),
    featureTag: z.lazy(() => marshalFeatureTagSchema).optional(),
    updateMask: z.any().transform((d: FieldMask<FieldPaths<FeatureTag>>) => d.paths.join(',')).optional(),
  })
  .transform(d => ({
    table_name: d.tableName,
    feature_name: d.featureName,
