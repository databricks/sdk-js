...
export const unmarshalGetAssignableRolesForResourceRequestSchema = z
  .object({
...
export const unmarshalGetAssignableRolesForResourceResponseSchema = z
  .object({
...
export const unmarshalGetRuleSetRequestSchema = z
  .object({
    account_id: z.string().optional(),
...
export const unmarshalGrantRuleSchema = z
  .object({
...
export const unmarshalRuleSetSchema = z
  .object({
    name: z.string().optional(),
    etag: z.string().optional(),
...
export const unmarshalRuleSetUpdateRequestSchema = z
  .object({
    name: z.string().optional(),
    etag: z.string().optional(),
    grant_rules: z.array(z.lazy(() => unmarshalGrantRuleSchema)).optional(),
...
export const unmarshalUpdateRuleSetRequestSchema = z
  .object({
    account_id: z.string().optional(),
    name: z.string().optional(),
...
export const marshalGetAssignableRolesForResourceRequestSchema = z
  .object({
...
export const marshalGetAssignableRolesForResourceResponseSchema = z
  .object({
...
export const marshalGetRuleSetRequestSchema = z
  .object({
    accountId: z.string().optional(),
    name: z.string().optional(),
    etag: z.string().optional(),
...
export const marshalGrantRuleSchema = z
  .object({
    principals: z.array(z.string()).optional(),
    role: z.string().optional(),
  })
...
export const marshalRuleSetSchema = z
  .object({
    name: z.string().optional(),
    etag: z.string().optional(),
...
export const marshalUpdateRuleSetRequestSchema = z
  .object({
    accountId: z.string().optional(),
    name: z.string().optional(),
