...
export class Client {
   ...
   */
  async createLogDeliveryConfiguration(req: CreateLogDeliveryConfigurationRequest, options?: CallOptions): Promise<CreateLogDeliveryConfigurationRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      resp = parseResponse(respBody, unmarshalCreateLogDeliveryConfigurationRequest_ResponseSchema);
    };
  ...
  async getLogDeliveryConfiguration(req: GetLogDeliveryConfigurationRequest, options?: CallOptions): Promise<GetLogDeliveryConfigurationRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetLogDeliveryConfigurationRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async listLogDeliveryConfiguration(req: ListLogDeliveryConfigurationRequest, options?: CallOptions): Promise<ListLogDeliveryConfigurationRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalListLogDeliveryConfigurationRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *listLogDeliveryConfigurationIter(req: ListLogDeliveryConfigurationRequest, options?: CallOptions): AsyncGenerator<LogDeliveryConfiguration> {
   ...
   */
  async updateLogDeliveryConfiguration(req: UpdateLogDeliveryConfigurationRequest, options?: CallOptions): Promise<UpdateLogDeliveryConfigurationRequest_Response> {
    const url = `${this.host}/api/2.0/accounts/${req.accountId ?? this.accountId ?? ''}/log-delivery/${req.configId ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdateLogDeliveryConfigurationRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
