...
export class Client {
   ...
   */
  async createFederationPolicy(req: CreateFederationPolicyRequest, options?: CallOptions): Promise<FederationPolicy> {
   ...
   */
  async createProvider(req: CreateProviderRequest, options?: CallOptions): Promise<ProviderInfo> {
   ...
   */
  async createRecipient(req: CreateRecipientRequest, options?: CallOptions): Promise<RecipientInfo> {
   ...
   */
  async createShare(req: CreateShareRequest, options?: CallOptions): Promise<ShareInfo> {
   ...
   * The caller must be the owner of the recipient.
   */
  async deleteFederationPolicy(req: DeleteFederationPolicyRequest, options?: CallOptions): Promise<void> {
  ...
  async deleteRecipient(req: DeleteRecipientRequest, options?: CallOptions): Promise<DeleteRecipientRequest_Response> {
  ...
  async deleteShare(req: DeleteShareRequest, options?: CallOptions): Promise<DeleteShareRequest_Response> {
  ...
  async getActivationUrlInfo(req: GetActivationUrlInfoRequest, options?: CallOptions): Promise<GetActivationUrlInfoRequest_Response> {
   ...
   */
  async getFederationPolicy(req: GetFederationPolicyRequest, options?: CallOptions): Promise<FederationPolicy> {
    const url = `${this.host}/api/2.0/data-sharing/recipients/${req.recipientName ?? ''}/federation-policies/${req.name ?? ''}`;
    let resp: FederationPolicy | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   */
  async getProvider(req: GetProviderRequest, options?: CallOptions): Promise<ProviderInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/providers/${req.nameArg ?? ''}`;
    let resp: ProviderInfo | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   * * A metastore admin
   */
  async getRecipient(req: GetRecipientRequest, options?: CallOptions): Promise<RecipientInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/recipients/${req.name ?? ''}`;
    let resp: RecipientInfo | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
  ...
  async getRecipientSharePermissions(req: GetRecipientSharePermissionsRequest, options?: CallOptions): Promise<GetRecipientSharePermissionsRequest_Response> {
  ...
  async getShare(req: GetShareRequest, options?: CallOptions): Promise<ShareInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/shares/${req.name ?? ''}`;
    const params = new URLSearchParams();
   ...
   */
  async getSharePermissions(req: GetSharePermissionsRequest, options?: CallOptions): Promise<GetSharePermissionsRequest_Response> {
   ...
   * The caller must have read access to the recipient.
   */
  async listFederationPolicies(req: ListFederationPoliciesRequest, options?: CallOptions): Promise<ListFederationPoliciesResponse> {
    const url = `${this.host}/api/2.0/data-sharing/recipients/${req.recipientName ?? ''}/federation-policies`;
    const params = new URLSearchParams();
    if (req.maxResults !== undefined) {
      params.append('max_results', String(req.maxResults));
  ...
  async *listFederationPoliciesIter(req: ListFederationPoliciesRequest, options?: CallOptions): AsyncGenerator<FederationPolicy> {
   ...
   */
  async listProviderShareAssets(req: ListProviderShareAssetsRequest, options?: CallOptions): Promise<ListProviderShareAssetsResponse> {
   ...
   */
  async listProviderShares(req: ListProviderSharesRequest, options?: CallOptions): Promise<ListProviderSharesRequest_Response> {
  ...
  async *listProviderSharesIter(req: ListProviderSharesRequest, options?: CallOptions): AsyncGenerator<ProviderShare> {
   ...
   * There is no guarantee of a specific ordering of the elements in the array.
   */
  async listRecipients(req: ListRecipientsRequest, options?: CallOptions): Promise<ListRecipientsRequest_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/recipients`;
    const params = new URLSearchParams();
  ...
  async *listRecipientsIter(req: ListRecipientsRequest, options?: CallOptions): AsyncGenerator<RecipientInfo> {
   ...
   * There is no guarantee of a specific ordering of the elements in the array.
   */
  async listShares(req: ListSharesRequest, options?: CallOptions): Promise<ListSharesRequest_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/shares`;
    const params = new URLSearchParams();
    if (req.maxResults !== undefined) {
      params.append('max_results', String(req.maxResults));
  ...
  async *listSharesIter(req: ListSharesRequest, options?: CallOptions): AsyncGenerator<ShareInfo> {
   ...
   */
  async retrieveAccessToken(req: RetrieveToken, options?: CallOptions): Promise<RetrieveToken_Response> {
   ...
   * The caller must be the owner of the recipient.
   */
  async rotateRecipientToken(req: RotateRecipientTokenRequest, options?: CallOptions): Promise<RecipientInfo> {
   ...
   */
  async updateProvider(req: UpdateProviderRequest, options?: CallOptions): Promise<ProviderInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/providers/${req.nameArg ?? ''}`;
   ...
   */
  async updateRecipient(req: UpdateRecipientRequest, options?: CallOptions): Promise<RecipientInfo> {
   ...
   */
  async updateShare(req: UpdateShareRequest, options?: CallOptions): Promise<ShareInfo> {
   ...
   */
  async updateSharePermissions(req: UpdateSharePermissionsRequest, options?: CallOptions): Promise<UpdateSharePermissionsRequest_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/shares/${req.name ?? ''}/permissions`;
