...
export const marshalGetQuotaSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetQuota_ResponseSchema = z
  .object({
...
export const marshalListQuotasSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListQuotas_ResponseSchema = z
  .object({
...
export const marshalQuotaInfoSchema = z
  .object({
