# @databricks/sdk-storageconfigurations
...
```bash
npm install @databricks/sdk-storageconfigurations
```

## Usage

```typescript
import {StorageConfigurationsClient} from '@databricks/sdk-storageconfigurations/v1';

const client = new StorageConfigurationsClient({});
```
