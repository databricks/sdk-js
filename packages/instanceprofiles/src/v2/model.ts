...
export const unmarshalAddInstanceProfileSchema: z.ZodType<AddInstanceProfile> = z
  .object({
...
export const unmarshalEditInstanceProfileSchema: z.ZodType<EditInstanceProfile> = z
  .object({
    instance_profile_arn: z.string().optional(),
    is_meta_instance_profile: z.boolean().optional(),
    iam_role_arn: z.string().optional(),
...
export const unmarshalListInstanceProfilesSchema: z.ZodType<ListInstanceProfiles> = z
  .object({
  });
...
export const unmarshalRemoveInstanceProfileSchema: z.ZodType<RemoveInstanceProfile> = z
  .object({
    instance_profile_arn: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalAddInstanceProfile_ResponseSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEditInstanceProfile_ResponseSchema: z.ZodType = z
  .object({
  });
...
export const marshalListInstanceProfilesSchema: z.ZodType = z
  .object({
  });
...
export const marshalListInstanceProfiles_ResponseSchema: z.ZodType = z
  .object({
    instanceProfiles: z.array(z.lazy(() => marshalInstanceProfileSchema)).optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalRemoveInstanceProfile_ResponseSchema: z.ZodType = z
  .object({
  });
