...
export const unmarshalConfigSchema = z
  .object({
...
export const unmarshalCreateNotificationDestinationRequestSchema = z
  .object({
...
export const unmarshalDeleteNotificationDestinationRequestSchema = z
  .object({
...
export const unmarshalEmailConfigSchema = z
  .object({
...
export const unmarshalEmptySchema = z.object({});

export const unmarshalGenericWebhookConfigSchema = z
  .object({
...
export const unmarshalGetNotificationDestinationRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const unmarshalListNotificationDestinationsRequestSchema = z
  .object({
...
export const unmarshalListNotificationDestinationsResponseSchema = z
  .object({
    results: z
...
export const unmarshalListNotificationDestinationsResultSchema = z
  .object({
    id: z.string().optional(),
    display_name: z.string().optional(),
...
export const unmarshalMicrosoftTeamsConfigSchema = z
  .object({
    url: z.string().optional(),
    url_set: z.boolean().optional(),
...
export const unmarshalNotificationDestinationSchema = z
  .object({
    id: z.string().optional(),
    display_name: z.string().optional(),
    destination_type: z.enum(DestinationType).optional(),
...
export const unmarshalPagerdutyConfigSchema = z
  .object({
...
export const unmarshalSlackConfigSchema = z
  .object({
    url: z.string().optional(),
    url_set: z.boolean().optional(),
...
export const unmarshalUpdateNotificationDestinationRequestSchema = z
  .object({
    id: z.string().optional(),
    display_name: z.string().optional(),
    config: z.lazy(() => unmarshalConfigSchema).optional(),
...
export const marshalConfigSchema = z
  .object({
...
export const marshalCreateNotificationDestinationRequestSchema = z
  .object({
...
export const marshalDeleteNotificationDestinationRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalEmailConfigSchema = z
  .object({
    addresses: z.array(z.string()).optional(),
  })
  .transform(d => ({
...
export const marshalEmptySchema = z.object({});

export const marshalGenericWebhookConfigSchema = z
  .object({
    url: z.string().optional(),
...
export const marshalGetNotificationDestinationRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalListNotificationDestinationsRequestSchema = z
  .object({
...
export const marshalListNotificationDestinationsResponseSchema = z
  .object({
    results: z
...
export const marshalListNotificationDestinationsResultSchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
...
export const marshalMicrosoftTeamsConfigSchema = z
  .object({
    url: z.string().optional(),
    urlSet: z.boolean().optional(),
...
export const marshalPagerdutyConfigSchema = z
  .object({
...
export const marshalSlackConfigSchema = z
  .object({
    url: z.string().optional(),
    urlSet: z.boolean().optional(),
...
export const marshalUpdateNotificationDestinationRequestSchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    config: z.lazy(() => marshalConfigSchema).optional(),
