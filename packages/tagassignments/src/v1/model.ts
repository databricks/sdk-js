...
export const unmarshalCreateTagAssignmentRequestSchema = z
  .object({
...
export const unmarshalDeleteTagAssignmentRequestSchema = z
  .object({
...
export const unmarshalGetTagAssignmentRequestSchema = z
  .object({
    entity_type: z.string().optional(),
    entity_id: z.string().optional(),
    tag_key: z.string().optional(),
...
export const unmarshalListTagAssignmentsRequestSchema = z
  .object({
    entity_type: z.string().optional(),
    entity_id: z.string().optional(),
...
export const unmarshalListTagAssignmentsResponseSchema = z
  .object({
    tag_assignments: z
...
export const unmarshalTagAssignmentSchema = z
  .object({
    entity_type: z.string().optional(),
    entity_id: z.string().optional(),
    tag_key: z.string().optional(),
...
export const unmarshalUpdateTagAssignmentRequestSchema = z
  .object({
    tag_assignment: z.lazy(() => unmarshalTagAssignmentSchema).optional(),
...
export const marshalCreateTagAssignmentRequestSchema = z
  .object({
...
export const marshalDeleteTagAssignmentRequestSchema = z
  .object({
...
export const marshalGetTagAssignmentRequestSchema = z
  .object({
    entityType: z.string().optional(),
    entityId: z.string().optional(),
    tagKey: z.string().optional(),
...
export const marshalListTagAssignmentsRequestSchema = z
  .object({
    entityType: z.string().optional(),
    entityId: z.string().optional(),
...
export const marshalListTagAssignmentsResponseSchema = z
  .object({
    tagAssignments: z
...
export const marshalTagAssignmentSchema = z
  .object({
    entityType: z.string().optional(),
    entityId: z.string().optional(),
    tagKey: z.string().optional(),
...
export const marshalUpdateTagAssignmentRequestSchema = z
  .object({
    tagAssignment: z.lazy(() => marshalTagAssignmentSchema).optional(),
