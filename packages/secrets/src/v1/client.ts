...
export class Client {
   ...
   */
  async createScope(signal: AbortSignal | undefined, req: CreateScope, options?: Options): Promise<CreateScope_Response> {
   ...
   */
  async deleteAcl(signal: AbortSignal | undefined, req: DeleteAcl, options?: Options): Promise<DeleteAcl_Response> {
   ...
   */
  async deleteScope(signal: AbortSignal | undefined, req: DeleteScope, options?: Options): Promise<DeleteScope_Response> {
   ...
   */
  async deleteSecret(signal: AbortSignal | undefined, req: DeleteSecret, options?: Options): Promise<DeleteSecret_Response> {
   ...
   * Throws ``INVALID_PARAMETER_VALUE`` if the permission or principal is invalid.
   */
  async getAcl(signal: AbortSignal | undefined, req: GetAcl, options?: Options): Promise<AclItem> {
   ...
   */
  async getSecret(signal: AbortSignal | undefined, req: GetSecret, options?: Options): Promise<GetSecret_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async listAcls(signal: AbortSignal | undefined, req: ListAcls, options?: Options): Promise<ListAcls_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async listScopes(signal: AbortSignal | undefined, _req: ListScopes, options?: Options): Promise<ListScopes_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async listSecrets(signal: AbortSignal | undefined, req: ListSecrets, options?: Options): Promise<ListSecrets_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async putAcl(signal: AbortSignal | undefined, req: PutAcl, options?: Options): Promise<PutAcl_Response> {
   ...
   */
  async putSecret(signal: AbortSignal | undefined, req: PutSecret, options?: Options): Promise<PutSecret_Response> {
