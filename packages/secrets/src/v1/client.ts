...
export class Client {
   ...
   */
  async createScope(req: CreateScopeRequest, options?: CallOptions): Promise<CreateScopeRequest_Response> {
   ...
   */
  async deleteAcl(req: DeleteAclRequest, options?: CallOptions): Promise<DeleteAclRequest_Response> {
   ...
   */
  async deleteScope(req: DeleteScopeRequest, options?: CallOptions): Promise<DeleteScopeRequest_Response> {
   ...
   */
  async deleteSecret(req: DeleteSecretRequest, options?: CallOptions): Promise<DeleteSecretRequest_Response> {
   ...
   */
  async getSecret(req: GetSecretRequest, options?: CallOptions): Promise<GetSecretRequest_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async listAcls(req: ListAclsRequest, options?: CallOptions): Promise<ListAclsRequest_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async listScopes(_req: ListScopesRequest, options?: CallOptions): Promise<ListScopesRequest_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async listSecrets(req: ListSecretsRequest, options?: CallOptions): Promise<ListSecretsRequest_Response> {
   ...
   * Throws ``PERMISSION_DENIED`` if the user does not have permission to make this API call.
   */
  async putAcl(req: PutAclRequest, options?: CallOptions): Promise<PutAclRequest_Response> {
   ...
   */
  async putSecret(req: PutSecretRequest, options?: CallOptions): Promise<PutSecretRequest_Response> {
