...
export const unmarshalAzureKeyVaultSecretScopeMetadataSchema: z.ZodType<AzureKeyVaultSecretScopeMetadata> = z
  .object({
...
export const unmarshalCreateScopeSchema: z.ZodType<CreateScope> = z
  .object({
    ...
    backend_azure_keyvault: z.lazy(() => unmarshalAzureKeyVaultSecretScopeMetadataSchema).optional(),
  })
  .transform(d => ({
    scope: d.scope,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCreateScope_ResponseSchema: z.ZodType<CreateScope_Response> = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeleteAcl_ResponseSchema: z.ZodType<DeleteAcl_Response> = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeleteScope_ResponseSchema: z.ZodType<DeleteScope_Response> = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeleteSecret_ResponseSchema: z.ZodType<DeleteSecret_Response> = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalGetSecret_ResponseSchema: z.ZodType<GetSecret_Response> = z
  .object({
    key: z.string().optional(),
    value: z.string().transform(s => Uint8Array.from(atob(s), c => c.charCodeAt(0))).optional(),
  })
  .transform(d => ({
    key: d.key,
    value: d.value,
...
export const unmarshalListScopesSchema: z.ZodType<ListScopes> = z
  .object({
  });

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalListScopes_ResponseSchema: z.ZodType<ListScopes_Response> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalListSecrets_ResponseSchema: z.ZodType<ListSecrets_Response> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalPutAcl_ResponseSchema: z.ZodType<PutAcl_Response> = z
  .object({
  });
...
export const unmarshalPutSecretSchema: z.ZodType<PutSecret> = z
  .object({
    ...
    bytes_value: z.string().transform(s => Uint8Array.from(atob(s), c => c.charCodeAt(0))).optional(),
  })
  .transform(d => ({
    scope: d.scope,
    key: d.key,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalPutSecret_ResponseSchema: z.ZodType<PutSecret_Response> = z
  .object({
  });
...
export const unmarshalSecretScopeSchema: z.ZodType<SecretScope> = z
  .object({
    ...
    keyvault_metadata: z.lazy(() => unmarshalAzureKeyVaultSecretScopeMetadataSchema).optional(),
  })
  .transform(d => ({
    name: d.name,
...
export const marshalCreateScopeSchema: z.ZodType = z
  .object({
    ...
    backendAzureKeyvault: z.lazy(() => marshalAzureKeyVaultSecretScopeMetadataSchema).optional(),
  })
  .transform(d => ({
    scope: d.scope,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCreateScope_ResponseSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteAcl_ResponseSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteScope_ResponseSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteSecret_ResponseSchema: z.ZodType = z
  .object({
  });
...
export const marshalGetSecret_ResponseSchema: z.ZodType = z
  .object({
    key: z.string().optional(),
    value: z.any().transform((d: Uint8Array) => btoa(Array.from(d, b => String.fromCharCode(b)).join(''))).optional(),
  })
  .transform(d => ({
    key: d.key,
    value: d.value,
...
export const marshalListScopesSchema: z.ZodType = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalPutAcl_ResponseSchema: z.ZodType = z
  .object({
  });
...
export const marshalPutSecretSchema: z.ZodType = z
  .object({
    ...
    bytesValue: z.any().transform((d: Uint8Array) => btoa(Array.from(d, b => String.fromCharCode(b)).join(''))).optional(),
  })
  .transform(d => ({
    scope: d.scope,
    key: d.key,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalPutSecret_ResponseSchema: z.ZodType = z
  .object({
  });
...
export const marshalSecretScopeSchema: z.ZodType = z
  .object({
    ...
    keyvaultMetadata: z.lazy(() => marshalAzureKeyVaultSecretScopeMetadataSchema).optional(),
  })
  .transform(d => ({
    name: d.name,
