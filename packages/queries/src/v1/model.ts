...
export const marshalCreateQueryRequestSchema = z
  .object({
...
export const marshalCreateQueryRequestQuerySchema = z
  .object({
    id: z.string().optional(),
...
export const marshalDateRangeSchema = z
  .object({
    start: z.string().optional(),
    end: z.string().optional(),
  })
...
export const marshalDateRangeValueSchema = z
  .object({
...
export const marshalDateValueSchema = z
  .object({
...
export const marshalEnumValueSchema = z
  .object({
    values: z.array(z.string()).optional(),
...
export const marshalGetQueryRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalListQueriesRequestSchema = z
  .object({
...
export const marshalListQueriesResponseSchema = z
  .object({
    results: z
...
export const marshalListQueryObjectsResponseQuerySchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    description: z.string().optional(),
...
export const marshalListVisualizationsForQueryRequestSchema = z
  .object({
    id: z.string().optional(),
    pageToken: z.string().optional(),
    pageSize: z.number().optional(),
...
export const marshalListVisualizationsForQueryResponseSchema = z
  .object({
...
export const marshalMultiValuesOptionsSchema = z
  .object({
    prefix: z.string().optional(),
    separator: z.string().optional(),
    suffix: z.string().optional(),
...
export const marshalNumericValueSchema = z
  .object({
    value: z.number().optional(),
  })
  .transform(d => ({
...
export const marshalQuerySchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    description: z.string().optional(),
...
export const marshalQueryBackedValueSchema = z
  .object({
    values: z.array(z.string()).optional(),
...
export const marshalQueryParameterSchema = z
  .object({
    title: z.string().optional(),
    name: z.string().optional(),
...
export const marshalTextValueSchema = z
  .object({
    value: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalTrashQueryRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalUpdateQueryRequestSchema = z
  .object({
...
export const marshalUpdateQueryRequestQuerySchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    description: z.string().optional(),
...
export const marshalVisualizationSchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    type: z.string().optional(),
