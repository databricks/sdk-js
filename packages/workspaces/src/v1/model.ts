...
export interface Workspace {
  ...
  networkConfig?:
    ...
    | { $case: 'gcpManagedNetworkConfig'; gcpManagedNetworkConfig: GcpManagedNetworkConfig }
    | undefined;
  pricingTier?: PricingTier | undefined;
  /**
   * ID of the workspace's private access settings object. Only used for PrivateLink. You must specify this ID if you are using [AWS PrivateLink](https://aws.amazon.com/privatelink/) for either front-end (user-to-workspace connection), back-end (data plane to control plane connection), or both connection types.
...
export const unmarshalAzureWorkspaceInfoSchema: z.ZodType<AzureWorkspaceInfo> = z
  .object({
...
export const unmarshalCloudResourceContainerSchema: z.ZodType<CloudResourceContainer> = z
  .object({
    gcp: z.lazy(() => unmarshalGcpCloudResourceContainerSchema).optional(),
  })
  .transform(d => ({
    cloudResourceContainer: d.gcp !== undefined ? { $case: 'gcp' as const, gcp: d.gcp } : undefined,
  }));

export const unmarshalGcpCloudResourceContainerSchema: z.ZodType<GcpCloudResourceContainer> = z
  .object({
...
export const unmarshalGcpCommonNetworkConfigSchema: z.ZodType<GcpCommonNetworkConfig> = z
  .object({
...
export const unmarshalGcpManagedNetworkConfigSchema: z.ZodType<GcpManagedNetworkConfig> = z
  .object({
...
export const unmarshalWorkspaceSchema: z.ZodType<Workspace> = z
  ...
  .transform(d => ({
    ...
    networkConfig: d.network_id !== undefined ? { $case: 'networkId' as const, networkId: d.network_id } : d.gcp_managed_network_config !== undefined ? { $case: 'gcpManagedNetworkConfig' as const, gcpManagedNetworkConfig: d.gcp_managed_network_config } : undefined,
...
export const unmarshalWorkspaceNetworkSchema: z.ZodType<WorkspaceNetwork> = z
  ...
  .transform(d => ({
    network: d.gcp_managed_network_config !== undefined ? { $case: 'gcpManagedNetworkConfig' as const, gcpManagedNetworkConfig: d.gcp_managed_network_config } : d.network_id !== undefined ? { $case: 'networkId' as const, networkId: d.network_id } : undefined,
...
export const marshalCloudResourceContainerSchema: z.ZodType = z
  .object({
    cloudResourceContainer: z.discriminatedUnion('$case', [z.object({ $case: z.literal('gcp'), gcp: z.lazy(() => marshalGcpCloudResourceContainerSchema) })]).optional(),
  })
  .transform(d => ({
    ...(d.cloudResourceContainer?.$case === 'gcp' && { gcp: d.cloudResourceContainer.gcp }),
  }));
...
export const marshalWorkspaceSchema: z.ZodType = z
  .object({
    ...
    networkConfig: z.discriminatedUnion('$case', [z.object({ $case: z.literal('networkId'), networkId: z.string() }), z.object({ $case: z.literal('gcpManagedNetworkConfig'), gcpManagedNetworkConfig: z.lazy(() => marshalGcpManagedNetworkConfigSchema) })]).optional(),
    pricingTier: z.enum(PricingTier).optional(),
    privateAccessSettingsId: z.string().optional(),
    managedServicesCustomerManagedKeyId: z.string().optional(),
    storageCustomerManagedKeyId: z.string().optional(),
...
export const marshalWorkspaceNetworkSchema: z.ZodType = z
  .object({
    network: z.discriminatedUnion('$case', [z.object({ $case: z.literal('gcpManagedNetworkConfig'), gcpManagedNetworkConfig: z.lazy(() => marshalGcpManagedNetworkConfigSchema) }), z.object({ $case: z.literal('networkId'), networkId: z.string() })]).optional(),
...
const workspaceFieldMaskSchema: FieldMaskSchema = {
  ...
  azureWorkspaceInfo: {wire: 'azure_workspace_info', children: () => azureWorkspaceInfoFieldMaskSchema},
  cloud: {wire: 'cloud'},
  cloudResourceContainer: {wire: 'cloud_resource_container', children: () => cloudResourceContainerFieldMaskSchema},
  ...
  gcpManagedNetworkConfig: {wire: 'gcp_managed_network_config', children: () => gcpManagedNetworkConfigFieldMaskSchema},
...
const workspaceNetworkFieldMaskSchema: FieldMaskSchema = {
  gcpCommonNetworkConfig: {wire: 'gcp_common_network_config', children: () => gcpCommonNetworkConfigFieldMaskSchema},
  gcpManagedNetworkConfig: {wire: 'gcp_managed_network_config', children: () => gcpManagedNetworkConfigFieldMaskSchema},
  networkId: {wire: 'network_id'},
};
