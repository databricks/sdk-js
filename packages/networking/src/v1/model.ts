...
export enum CustomerFacingIngressNetworkPolicy_ApiScopeConstraint {
  READ = 'READ',
  ALL = 'ALL',
}
...
export enum EndpointUseCase_EndpointUseCase {
  ...
  /** general-access frontend private link connectivity. */
  GENERAL_ACCESS = 'GENERAL_ACCESS',
}
...
export interface CustomerFacingIngressNetworkPolicy_AccountApiDestination {
  ...
  scopeConstraint?:
    | CustomerFacingIngressNetworkPolicy_ApiScopeConstraint
    | undefined;
...
/**
 * A <Databricks>-managed IP range identified by name (e.g., "powerbi", "dbt"),
 * optionally scoped to specific partner regions. Customers reference a name
 * instead of raw CIDRs; <Databricks> keeps the underlying IP list current.
 */
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface CustomerFacingIngressNetworkPolicy_ManagedIpRange {
  /** Name of the managed IP range, e.g., "powerbi". */
  name?: string | undefined;
  /**
   * Partner regions to allow, e.g., ["EastUS", "WestEurope"]. Each region
   * must belong to the partner named in `name`. Empty list means all regions
   * of the partner. Region casing matches the partner's source (e.g.,
   * Microsoft uses "EastUS"), so values are stored verbatim, not lowercased.
   */
...
export interface CustomerFacingIngressNetworkPolicy_PublicRequestOrigin {
  source?:
    ...
    | {
         ...
         */
        managedIpRange: CustomerFacingIngressNetworkPolicy_ManagedIpRange;
      }
    | undefined;
}
...
export interface NetworkConnectivityConfigEgressConfig_DefaultRule {
  ...
  awsStableIpRule?:
    ...
    | undefined;
  gcpProjectIdRule?:
    | NetworkConnectivityConfigEgressConfig_DefaultRule_GcpProjectIdRule
    | undefined;
}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface NetworkConnectivityConfigEgressConfig_DefaultRule_GcpProjectIdRule {
  /**
   * A list of <Databricks> internal project IDs from where network access originates for serverless DBSQL,
   * This list is stable and will not change once the NCC object is created.
   */
...
export const unmarshalCustomerFacingIngressNetworkPolicy_AccountApiDestinationSchema: z.ZodType<CustomerFacingIngressNetworkPolicy_AccountApiDestination> =
  z
    .object({
      ...
      scope_constraint: z
        .enum(CustomerFacingIngressNetworkPolicy_ApiScopeConstraint)
        .optional(),
      scope_qualifier: z
    ...
    .transform(d => ({
      scopes: d.scopes,
      scopeConstraint: d.scope_constraint,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCustomerFacingIngressNetworkPolicy_ManagedIpRangeSchema: z.ZodType<CustomerFacingIngressNetworkPolicy_ManagedIpRange> =
  z
    .object({
...
export const unmarshalCustomerFacingIngressNetworkPolicy_PublicRequestOriginSchema: z.ZodType<CustomerFacingIngressNetworkPolicy_PublicRequestOrigin> =
  z
    .object({
      ...
      managed_ip_range: z
        .lazy(
          () => unmarshalCustomerFacingIngressNetworkPolicy_ManagedIpRangeSchema
        )
        .optional(),
    })
    .transform(d => ({
        ...
        d.all_ip_ranges !== undefined
          ...
          : d.included_ip_ranges !== undefined
            ...
            : d.excluded_ip_ranges !== undefined
              ...
              : d.managed_ip_range !== undefined
                ? {
                    $case: 'managedIpRange' as const,
                    managedIpRange: d.managed_ip_range,
                  }
                : undefined,
    }));
  ...
  z
    .object({
      ...
      aws_stable_ip_rule: z
        ...
        .optional(),
      gcp_project_id_rule: z
        .lazy(
          () =>
            unmarshalNetworkConnectivityConfigEgressConfig_DefaultRule_GcpProjectIdRuleSchema
        )
        .optional(),
    })
    .transform(d => ({
      ...
      gcpProjectIdRule: d.gcp_project_id_rule,
    }));
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalNetworkConnectivityConfigEgressConfig_DefaultRule_GcpProjectIdRuleSchema: z.ZodType<NetworkConnectivityConfigEgressConfig_DefaultRule_GcpProjectIdRule> =
  z
    .object({
...
export const marshalCustomerFacingIngressNetworkPolicy_AccountApiDestinationSchema: z.ZodType =
  z
    ...
    .transform(d => ({
      scopes: d.scopes,
      scope_constraint: d.scopeConstraint,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCustomerFacingIngressNetworkPolicy_ManagedIpRangeSchema: z.ZodType =
  z
    .object({
      name: z.string().optional(),
      regions: z.array(z.string()).optional(),
...
export const marshalCustomerFacingIngressNetworkPolicy_PublicRequestOriginSchema: z.ZodType =
  z
    .object({
      source: z
        .discriminatedUnion('$case', [
          ...
          z.object({
            $case: z.literal('managedIpRange'),
            managedIpRange: z.lazy(
              () =>
                marshalCustomerFacingIngressNetworkPolicy_ManagedIpRangeSchema
            ),
          }),
        ])
        .optional(),
    ...
    .transform(d => ({
      ...
      ...(d.source?.$case === 'managedIpRange' && {
        managed_ip_range: d.source.managedIpRange,
      }),
    }));
  ...
  z
    .object({
      ...
      gcpProjectIdRule: z
        .lazy(
          () =>
            marshalNetworkConnectivityConfigEgressConfig_DefaultRule_GcpProjectIdRuleSchema
        )
        .optional(),
    })
    .transform(d => ({
      ...
      gcp_project_id_rule: d.gcpProjectIdRule,
    }));
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalNetworkConnectivityConfigEgressConfig_DefaultRule_GcpProjectIdRuleSchema: z.ZodType =
  z
    .object({
