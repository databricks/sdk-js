...
export const unmarshalCancelCommandRequestSchema: z.ZodType<CancelCommandRequest> =
  z
    .object({
...
export const unmarshalCreateContextRequestSchema: z.ZodType<CreateContextRequest> =
  z
    .object({
      clusterId: z.string().optional(),
...
export const unmarshalDestroyContextRequestSchema: z.ZodType<DestroyContextRequest> =
  z
    .object({
      clusterId: z.string().optional(),
      contextId: z.string().optional(),
...
export const unmarshalExecuteCommandRequestSchema: z.ZodType<ExecuteCommandRequest> =
  z
    .object({
      clusterId: z.string().optional(),
      contextId: z.string().optional(),
...
export const unmarshalGetCommandStatusRequestSchema: z.ZodType<GetCommandStatusRequest> =
  z
    .object({
      clusterId: z.string().optional(),
      contextId: z.string().optional(),
...
export const unmarshalGetContextStatusRequestSchema: z.ZodType<GetContextStatusRequest> =
  z
    .object({
      clusterId: z.string().optional(),
      contextId: z.string().optional(),
...
export const marshalCancelResponseSchema: z.ZodType = z.object({});
...
export const marshalCreateResponseSchema: z.ZodType = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalDestroyResponseSchema: z.ZodType = z.object({});
...
export const marshalGetCommandStatusRequestSchema: z.ZodType = z
  .object({
    clusterId: z.string().optional(),
    contextId: z.string().optional(),
    commandId: z.string().optional(),
...
export const marshalGetCommandStatusResponseSchema: z.ZodType = z
  .object({
    id: z.string().optional(),
    status: z.enum(CommandStatus).optional(),
    results: z.lazy(() => marshalResultsSchema).optional(),
  })
  .transform(d => ({
    id: d.id,
    status: d.status,
...
export const marshalGetContextStatusRequestSchema: z.ZodType = z
  .object({
    clusterId: z.string().optional(),
    contextId: z.string().optional(),
  })
...
export const marshalGetContextStatusResponseSchema: z.ZodType = z
  .object({
    id: z.string().optional(),
    status: z.enum(ContextStatus).optional(),
  })
...
export const marshalResultsSchema: z.ZodType = z
  .object({
    cause: z.string().optional(),
    data: z.record(z.string(), z.unknown()).optional(),
    fileName: z.string().optional(),
