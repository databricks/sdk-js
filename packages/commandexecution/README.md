...
```bash
npm install @databricks/sdk-commandexecution
```

## Usage

```typescript
import {CommandExecutionClient} from '@databricks/sdk-commandexecution/v2';

const client = new CommandExecutionClient({});
```
