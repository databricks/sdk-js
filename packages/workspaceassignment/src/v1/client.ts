...
export class Client {
  ...
  async deleteWorkspacePermissionAssignment(
    ...
    const url = `${this.host}/api/2.0/preview/accounts//workspaces/${String(req.workspaceId ?? '')}/permissionassignments/principals/${String(req.principalId ?? '')}`;
  ...
  async getWorkspacePermissionAssignments(
    ...
    const url = `${this.host}/api/2.0/preview/accounts//workspaces/${String(req.workspaceId ?? '')}/permissionassignments`;
    const params = new URLSearchParams();
    if (req.accountId !== undefined) {
      params.append('account_id', req.accountId);
    }
  ...
  async listWorkspacePermissions(
    ...
    const url = `${this.host}/api/2.0/preview/accounts//workspaces/${String(req.workspaceId ?? '')}/permissionassignments/permissions`;
    const params = new URLSearchParams();
    if (req.accountId !== undefined) {
      params.append('account_id', req.accountId);
    }
