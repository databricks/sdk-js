...
export const unmarshalUpdateFunctionSchema: z.ZodType<UpdateFunction> = z
  .object({
    full_name_arg: z.string().optional(),
    name: z.string().optional(),
    catalog_name: z.string().optional(),
...
export const marshalDeleteFunctionSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteFunction_ResponseSchema = z.object({});
...
export const marshalFunctionInfoSchema = z
  .object({
    name: z.string().optional(),
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
...
export const marshalGetFunctionSchema = z
  .object({
    fullNameArg: z.string().optional(),
...
export const marshalListFunctionsSchema = z
  .object({
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
    includeBrowse: z.boolean().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListFunctions_ResponseSchema = z
  .object({
    functions: z.array(z.lazy(() => marshalFunctionInfoSchema)).optional(),
...
export const marshalUpdateFunctionSchema = z
  .object({
    fullNameArg: z.string().optional(),
    name: z.string().optional(),
    catalogName: z.string().optional(),
