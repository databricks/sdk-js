...
export class Client {
   ...
   */
  async createFunction(signal: AbortSignal | undefined, req: CreateFunctionRequest, options?: Options): Promise<FunctionInfo> {
   ...
   */
  async deleteFunction(signal: AbortSignal | undefined, req: DeleteFunction, options?: Options): Promise<DeleteFunction_Response> {
   ...
   */
  async getFunction(signal: AbortSignal | undefined, req: GetFunction, options?: Options): Promise<FunctionInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/functions/${req.fullNameArg ?? ''}`;
    const params = new URLSearchParams();
   ...
   */
  async listFunctions(signal: AbortSignal | undefined, req: ListFunctions, options?: Options): Promise<ListFunctions_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/functions`;
    const params = new URLSearchParams();
  ...
  async *listFunctionsIter(signal: AbortSignal | undefined, req: ListFunctions, options?: Options): AsyncGenerator<FunctionInfo> {
   ...
   */
  async updateFunction(signal: AbortSignal | undefined, req: UpdateFunction, options?: Options): Promise<FunctionInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/functions/${req.fullNameArg ?? ''}`;
