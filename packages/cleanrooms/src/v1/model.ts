...
// eslint-disable-next-line @typescript-eslint/naming-convention, @typescript-eslint/no-empty-object-type -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateForeignTable {}

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateForeignTableLocalDetails {
  /**
   * The fully qualified name of the foreign table in its owner's local metastore,
   * in the format of *catalog*.*schema*.*foreign_table_name*
   */
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateNotebook {
  /**
   * Base 64 representation of the notebook contents.
   * This is the same format as returned by [workspace/export](https://docs.databricks.com/api/workspace/workspace/export) with the format of **HTML**.
   */
...
// eslint-disable-next-line @typescript-eslint/naming-convention, @typescript-eslint/no-empty-object-type -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateTable {}

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateTableLocalDetails {
  /**
   * The fully qualified name of the table in its owner's local metastore,
   * in the format of *catalog*.*schema*.*table_name*
   */
...
// eslint-disable-next-line @typescript-eslint/naming-convention, @typescript-eslint/no-empty-object-type -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateView {}

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateViewLocalDetails {
  /**
   * The fully qualified name of the view in its owner's local metastore,
   * in the format of *catalog*.*schema*.*view_name*
   */
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface CleanRoomAsset_UpdateVolumeLocalDetails {
  /**
   * The fully qualified name of the volume in its owner's local metastore,
   * in the format of *catalog*.*schema*.*volume_name*
   */
...
export interface CreateCleanRoomAutoApprovalRuleRequest {
  autoApprovalRule: CreateCleanRoomAutoApprovalRule;
}
...
export interface CreateCleanRoomOutputCatalogRequest {
  /** Name of the clean room. */
  cleanRoomName?: string | undefined;
  outputCatalog: CreateCleanRoomOutputCatalog;
}
 ...
 */
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface EgressNetworkPolicy_InternetAccessPolicy_UpdateInternetDestination {
  destination?: string | undefined;
  type?:
    | EgressNetworkPolicy_InternetAccessPolicy_InternetDestination_InternetDestinationType
    | undefined;
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface EgressNetworkPolicy_InternetAccessPolicy_UpdateLogOnlyMode {
  logOnlyModeType?:
    | EgressNetworkPolicy_InternetAccessPolicy_LogOnlyMode_LogOnlyModeType
    | undefined;
  workloads?:
...
/** Users can specify accessible storage destinations. */
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface EgressNetworkPolicy_InternetAccessPolicy_UpdateStorageDestination {
  bucketName?: string | undefined;
  region?: string | undefined;
  type?:
    | EgressNetworkPolicy_InternetAccessPolicy_StorageDestination_StorageDestinationType
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export interface EgressNetworkPolicy_UpdateInternetAccessPolicy {
  restrictionMode?:
    | EgressNetworkPolicy_InternetAccessPolicy_RestrictionMode
    | undefined;
  allowedInternetDestinations?:
...
export interface UpdateCleanRoom {
   ...
   * This field will not be filled in the ListCleanRooms call.
   */
  remoteDetailedInfo?: UpdateCleanRoomRemoteDetail | undefined;
  /** This is the <Databricks> username of the owner of the local clean room securable for permission management. */
  owner?: string | undefined;
  comment?: string | undefined;
}
...
/** Metadata of the clean room asset */
export interface UpdateCleanRoomAsset {
  /**
   * The name of the clean room this asset belongs to.
   * This field is required for create operations and populated by the server for responses.
   */
  ...
  localDetails?:
    | {
         ...
         * Present if and only if **asset_type** is **TABLE**
         */
        tableLocalDetails: CleanRoomAsset_UpdateTableLocalDetails;
      }
    | {
        $case: 'volumeLocalDetails';
        /**
         ...
         * Present if and only if **asset_type** is **VOLUME**
         */
        volumeLocalDetails: CleanRoomAsset_UpdateVolumeLocalDetails;
      }
    | {
        $case: 'viewLocalDetails';
        /**
         ...
         * Present if and only if **asset_type** is **VIEW**
         */
        viewLocalDetails: CleanRoomAsset_UpdateViewLocalDetails;
      }
    | {
        $case: 'foreignTableLocalDetails';
        /**
         ...
         * Present if and only if **asset_type** is **FOREIGN_TABLE**
         */
        foreignTableLocalDetails: CleanRoomAsset_UpdateForeignTableLocalDetails;
      }
    | undefined;
  /** the asset-type specific information. Will not be returned by list */
  details?:
    | {
         ...
         * Present if and only if **asset_type** is **TABLE**
         */
        table: CleanRoomAsset_UpdateTable;
      }
    | {
        $case: 'notebook';
        /**
         ...
         * Present if and only if **asset_type** is **NOTEBOOK_FILE**
         */
        notebook: CleanRoomAsset_UpdateNotebook;
      }
    | {
        $case: 'view';
        /**
         ...
         * Present if and only if **asset_type** is **VIEW**
         */
        view: CleanRoomAsset_UpdateView;
      }
    | {
        $case: 'foreignTable';
        /**
         ...
         * Present if and only if **asset_type** is **FOREIGN_TABLE**
         */
        foreignTable: CleanRoomAsset_UpdateForeignTable;
      }
    | undefined;
}
...
export interface UpdateCleanRoomAssetRequest {
   ...
   */
  asset?: UpdateCleanRoomAsset | undefined;
}

export interface UpdateCleanRoomAutoApprovalRule {
  /** The name of the clean room this auto-approval rule belongs to. */
  cleanRoomName?: string | undefined;
  /** A generated UUID identifying the rule. */
  ruleId?: string | undefined;
...
export interface UpdateCleanRoomAutoApprovalRuleRequest {
  ...
  autoApprovalRule?: UpdateCleanRoomAutoApprovalRule | undefined;
}

/** Publicly visible clean room collaborator. */
export interface UpdateCleanRoomCollaborator {
  /** The global Unity Catalog metastore ID of the collaborator. The identifier is of format cloud:region:metastore-uuid. */
  globalMetastoreId?: string | undefined;
  /**
   * Workspace ID of the user who is receiving the clean room "invitation". Must be specified if
...
/** Publicly visible central clean room details. */
export interface UpdateCleanRoomRemoteDetail {
  /** Cloud vendor (aws,azure,gcp) of the central clean room. */
  cloudVendor?: string | undefined;
  /** Region of the central clean room. */
  region?: string | undefined;
   ...
   * 2. Its invite_recipient_email is empty.
   */
  collaborators?: UpdateCleanRoomCollaborator[] | undefined;
  /** Egress network policy to apply to the central clean room workspace. */
  egressNetworkPolicy?: UpdateEgressNetworkPolicy | undefined;
}

export interface UpdateCleanRoomRequest {
  /** Name of the clean room. */
  name?: string | undefined;
  cleanRoom?: UpdateCleanRoom | undefined;
}
...
export interface UpdateEgressNetworkPolicy {
  /** The access policy enforced for egress traffic to the internet. */
  internetAccess?: EgressNetworkPolicy_UpdateInternetAccessPolicy | undefined;
}
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateForeignTableSchema: z.ZodType =
  z.object({});

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateForeignTableLocalDetailsSchema: z.ZodType =
  z
    .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateNotebookSchema: z.ZodType = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateTableSchema: z.ZodType = z.object({});

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateTableLocalDetailsSchema: z.ZodType = z
  .object({
    localName: z.string().optional(),
    partitions: z
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateViewSchema: z.ZodType = z.object({});

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateViewLocalDetailsSchema: z.ZodType = z
  .object({
    localName: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCleanRoomAsset_UpdateVolumeLocalDetailsSchema: z.ZodType = z
  .object({
    localName: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalCreateCleanRoomAutoApprovalRuleRequestSchema: z.ZodType = z
  .object({
    autoApprovalRule: z.lazy(
      () => marshalCreateCleanRoomAutoApprovalRuleSchema
    ),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEgressNetworkPolicy_InternetAccessPolicy_UpdateInternetDestinationSchema: z.ZodType =
  z
    .object({
      destination: z.string().optional(),
      type: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEgressNetworkPolicy_InternetAccessPolicy_UpdateLogOnlyModeSchema: z.ZodType =
  z
    .object({
      logOnlyModeType: z.string().optional(),
      workloads: z.array(z.string()).optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEgressNetworkPolicy_InternetAccessPolicy_UpdateStorageDestinationSchema: z.ZodType =
  z
    .object({
      bucketName: z.string().optional(),
      region: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEgressNetworkPolicy_UpdateInternetAccessPolicySchema: z.ZodType =
  z
    .object({
      restrictionMode: z.string().optional(),
      allowedInternetDestinations: z
        .array(
          z.lazy(
            () =>
              marshalEgressNetworkPolicy_InternetAccessPolicy_UpdateInternetDestinationSchema
          )
        )
        .optional(),
      allowedStorageDestinations: z
        .array(
          z.lazy(
            () =>
              marshalEgressNetworkPolicy_InternetAccessPolicy_UpdateStorageDestinationSchema
          )
        )
        .optional(),
      logOnlyMode: z
        .lazy(
          () =>
            marshalEgressNetworkPolicy_InternetAccessPolicy_UpdateLogOnlyModeSchema
        )
        .optional(),
    })
    .transform(d => ({
...
export const marshalUpdateCleanRoomSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    remoteDetailedInfo: z
      .lazy(() => marshalUpdateCleanRoomRemoteDetailSchema)
      .optional(),
    owner: z.string().optional(),
    comment: z.string().optional(),
  })
...
export const marshalUpdateCleanRoomAssetSchema: z.ZodType = z
  .object({
    cleanRoomName: z.string().optional(),
    name: z.string().optional(),
    assetType: z.string().optional(),
    localDetails: z
      .discriminatedUnion('$case', [
        z.object({
          $case: z.literal('tableLocalDetails'),
          tableLocalDetails: z.lazy(
            () => marshalCleanRoomAsset_UpdateTableLocalDetailsSchema
          ),
        }),
        z.object({
          $case: z.literal('volumeLocalDetails'),
          volumeLocalDetails: z.lazy(
            () => marshalCleanRoomAsset_UpdateVolumeLocalDetailsSchema
          ),
        }),
        z.object({
          $case: z.literal('viewLocalDetails'),
          viewLocalDetails: z.lazy(
            () => marshalCleanRoomAsset_UpdateViewLocalDetailsSchema
          ),
        }),
        z.object({
          $case: z.literal('foreignTableLocalDetails'),
          foreignTableLocalDetails: z.lazy(
            () => marshalCleanRoomAsset_UpdateForeignTableLocalDetailsSchema
          ),
        }),
      ])
      .optional(),
    details: z
      .discriminatedUnion('$case', [
        z.object({
          $case: z.literal('table'),
          table: z.lazy(() => marshalCleanRoomAsset_UpdateTableSchema),
        }),
        z.object({
          $case: z.literal('notebook'),
          notebook: z.lazy(() => marshalCleanRoomAsset_UpdateNotebookSchema),
        }),
        z.object({
          $case: z.literal('view'),
          view: z.lazy(() => marshalCleanRoomAsset_UpdateViewSchema),
        }),
        z.object({
          $case: z.literal('foreignTable'),
          foreignTable: z.lazy(
            () => marshalCleanRoomAsset_UpdateForeignTableSchema
          ),
        }),
      ])
      .optional(),
...
export const marshalUpdateCleanRoomAutoApprovalRuleSchema: z.ZodType = z
  .object({
    cleanRoomName: z.string().optional(),
...
export const marshalUpdateCleanRoomCollaboratorSchema: z.ZodType = z
  .object({
    globalMetastoreId: z.string().optional(),
    inviteRecipientWorkspaceId: z.bigint().optional(),
    inviteRecipientEmail: z.string().optional(),
...
export const marshalUpdateCleanRoomRemoteDetailSchema: z.ZodType = z
  .object({
    cloudVendor: z.string().optional(),
    region: z.string().optional(),
    collaborators: z
      .array(z.lazy(() => marshalUpdateCleanRoomCollaboratorSchema))
      .optional(),
    egressNetworkPolicy: z
      .lazy(() => marshalUpdateEgressNetworkPolicySchema)
      .optional(),
  })
  .transform(d => ({
    cloud_vendor: d.cloudVendor,
...
export const marshalUpdateCleanRoomRequestSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    cleanRoom: z.lazy(() => marshalUpdateCleanRoomSchema).optional(),
  })
  .transform(d => ({
    name: d.name,
...
export const marshalUpdateEgressNetworkPolicySchema: z.ZodType = z
  .object({
    internetAccess: z
      .lazy(() => marshalEgressNetworkPolicy_UpdateInternetAccessPolicySchema)
      .optional(),
  })
  .transform(d => ({
    internet_access: d.internetAccess,
