...
export interface CreateOnlineTableSpec {
  ...
  schedulingPolicy?:
    | {
        ...
        runContinuously: OnlineTableSpec_CreateContinuousSchedulingPolicy;
      }
    | {
        $case: 'runTriggered';
...
// eslint-disable-next-line @typescript-eslint/naming-convention, @typescript-eslint/no-empty-object-type -- Proto-style nested message name.
export interface OnlineTableSpec_CreateContinuousSchedulingPolicy {}

// eslint-disable-next-line @typescript-eslint/naming-convention, @typescript-eslint/no-empty-object-type -- Proto-style nested message name.
export interface OnlineTableSpec_CreateTriggeredSchedulingPolicy {}
...
export const marshalCreateOnlineTableSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    spec: z.lazy(() => marshalCreateOnlineTableSpecSchema).optional(),
  })
  .transform(d => ({
    name: d.name,
    spec: d.spec,
...
export const marshalCreateOnlineTableSpecSchema: z.ZodType = z
  .object({
    schedulingPolicy: z
      .discriminatedUnion('$case', [
        z.object({
          ...
          runContinuously: z.lazy(
            () => marshalOnlineTableSpec_CreateContinuousSchedulingPolicySchema
          ),
        }),
        z.object({
          $case: z.literal('runTriggered'),
          runTriggered: z.lazy(
            () => marshalOnlineTableSpec_CreateTriggeredSchedulingPolicySchema
          ),
        }),
      ])
      .optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalOnlineTableSpec_CreateContinuousSchedulingPolicySchema: z.ZodType =
  z.object({});

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalOnlineTableSpec_CreateTriggeredSchedulingPolicySchema: z.ZodType =
  z.object({});
