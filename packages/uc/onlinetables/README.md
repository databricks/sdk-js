# @databricks/sdk-uc-onlinetables
...
```bash
npm install @databricks/sdk-uc-onlinetables
```

## Usage

```typescript
import {OnlineTablesClient} from '@databricks/sdk-uc-onlinetables/v1';

const client = new OnlineTablesClient({});
```
