# @databricks/sdk-uc-abacpolicies
...
```bash
npm install @databricks/sdk-uc-abacpolicies
```

## Usage

```typescript
import {AbacPoliciesClient} from '@databricks/sdk-uc-abacpolicies/v1';

const client = new AbacPoliciesClient({});
```
