# @databricks/sdk-uc-externallineage
...
```bash
npm install @databricks/sdk-uc-externallineage
```

## Usage

```typescript
import {ExternalLineageClient} from '@databricks/sdk-uc-externallineage/v1';

const client = new ExternalLineageClient({});
```
