...
export type {
  ...
  CreateCreateAccountsStorageCredential,
  ...
  CreateUpdateAccountsStorageCredential,
  CredentialInfo,
  Credentials,
  ...
  GenerateTemporaryServiceCredentialRequest_CreateGcpOptions,
