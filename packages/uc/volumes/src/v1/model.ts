...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeleteVolumeRequest_ResponseSchema: z.ZodType<DeleteVolumeRequest_Response> = z
  .object({
  });
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalListVolumesRequest_ResponseSchema: z.ZodType<ListVolumesRequest_Response> = z
  .object({
