...
export class Client {
   ...
   */
  async createRegisteredModel(req: CreateRegisteredModelRequest, options?: CallOptions): Promise<RegisteredModelInfo> {
   ...
   * privilege on the parent catalog and the **USE_SCHEMA** privilege on the parent schema.
   */
  async deleteRegisteredModelAlias(req: DeleteRegisteredModelAliasRequest, options?: CallOptions): Promise<DeleteRegisteredModelAliasRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('DELETE', url, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalDeleteRegisteredModelAliasRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async getModelVersion(req: GetModelVersionRequest, options?: CallOptions): Promise<ModelVersionInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/models/${req.fullNameArg ?? ''}/versions/${String(req.versionArg ?? '')}`;
   ...
   * on the parent schema.
   */
  async getModelVersionByAlias(req: GetModelVersionByAliasRequest, options?: CallOptions): Promise<ModelVersionInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/models/${req.fullNameArg ?? ''}/aliases/${req.aliasArg ?? ''}`;
    const params = new URLSearchParams();
    if (req.includeAliases !== undefined) {
      params.append('include_aliases', String(req.includeAliases));
   ...
   * on the parent schema.
   */
  async getRegisteredModel(req: GetRegisteredModelRequest, options?: CallOptions): Promise<RegisteredModelInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/models/${req.fullNameArg ?? ''}`;
    const params = new URLSearchParams();
    if (req.includeAliases !== undefined) {
      params.append('include_aliases', String(req.includeAliases));
   ...
   */
  async listModelVersions(req: ListModelVersionsRequest, options?: CallOptions): Promise<ListModelVersionsRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalListModelVersionsRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *listModelVersionsIter(req: ListModelVersionsRequest, options?: CallOptions): AsyncGenerator<ModelVersionInfo> {
  ...
  async *listRegisteredModelsIter(req: ListRegisteredModelsRequest, options?: CallOptions): AsyncGenerator<RegisteredModelInfo> {
   ...
   * privilege on the parent catalog and the **USE_SCHEMA** privilege on the parent schema.
   */
  async setRegisteredModelAlias(req: SetRegisteredModelAliasRequest, options?: CallOptions): Promise<RegisteredModelAliasInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/models/${req.fullNameArg ?? ''}/aliases/${req.aliasArg ?? ''}`;
   ...
   */
  async updateModelVersion(req: UpdateModelVersionRequest, options?: CallOptions): Promise<ModelVersionInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/models/${req.fullNameArg ?? ''}/versions/${String(req.versionArg ?? '')}`;
   ...
   */
  async updateRegisteredModel(req: UpdateRegisteredModelRequest, options?: CallOptions): Promise<RegisteredModelInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/models/${req.fullNameArg ?? ''}`;
