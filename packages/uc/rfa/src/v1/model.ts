...
const accessRequestDestinationsFieldMaskSchema: FieldMaskSchema = {
  ...
  destinationSourceSecurable: {wire: 'destination_source_securable', children: () => securableFieldMaskSchema},
...
export function accessRequestDestinationsFieldMask(...paths: string[]): FieldMask<AccessRequestDestinations> {
  return FieldMask.build<AccessRequestDestinations>(paths, accessRequestDestinationsFieldMaskSchema);
}
