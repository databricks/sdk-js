...
export class Client {
   ...
   */
  async batchCreateAccessRequests(req: BatchCreateAccessRequestsRequest, options?: CallOptions): Promise<BatchCreateAccessRequestsResponse> {
   ...
   * "external_location", "connection", "credential", "function", "registered_model", and "volume".
   */
  async getAccessRequestDestinations(req: GetAccessRequestDestinationsRequest, options?: CallOptions): Promise<AccessRequestDestinations> {
   ...
   * "external_location", "connection", "credential", "function", "registered_model", and "volume".
   */
  async updateAccessRequestDestinations(req: UpdateAccessRequestDestinationsRequest, options?: CallOptions): Promise<AccessRequestDestinations> {
