...
export const unmarshalConflictResolutionPolicySchema = z
  .object({
...
export const unmarshalCreateTagPolicyRequestSchema = z
  .object({
...
export const unmarshalDefaultValueOverridePolicySchema = z
  .object({
...
export const unmarshalDeleteTagPolicyRequestSchema = z
  .object({
...
export const unmarshalGetTagPolicyRequestSchema = z
  .object({
    tag_key: z.string().optional(),
  })
  .transform(d => ({
...
export const unmarshalListTagPoliciesRequestSchema = z
  .object({
...
export const unmarshalPropagationConfigSchema = z
  .object({
...
export const unmarshalUpdateTagPolicyRequestSchema = z
  .object({
    tag_policy: z.lazy(() => unmarshalTagPolicySchema).optional(),
...
export const marshalConflictResolutionPolicySchema = z
  .object({
...
export const marshalCreateTagPolicyRequestSchema = z
  .object({
...
export const marshalDefaultValueOverridePolicySchema = z
  .object({
...
export const marshalDeleteTagPolicyRequestSchema = z
  .object({
...
export const marshalGetTagPolicyRequestSchema = z
  .object({
    tagKey: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalListTagPoliciesRequestSchema = z
  .object({
...
export const marshalListTagPoliciesResponseSchema = z
  .object({
...
export const marshalPropagationConfigSchema = z
  .object({
    enabled: z.boolean().optional(),
...
export const marshalUpdateTagPolicyRequestSchema = z
  .object({
    tagPolicy: z.lazy(() => marshalTagPolicySchema).optional(),
