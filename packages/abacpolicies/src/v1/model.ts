...
export const marshalCreatePolicySchema = z
  .object({
...
export const marshalDeletePolicySchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeletePolicy_ResponseSchema = z.object({});

export const marshalDenyOptionsSchema = z
  .object({
    privileges: z.array(z.string()).optional(),
  })
  .transform(d => ({
...
export const marshalGetPolicySchema = z
  .object({
    onSecurableType: z.string().optional(),
    onSecurableFullname: z.string().optional(),
    name: z.string().optional(),
...
export const marshalGrantOptionsSchema = z
  .object({
    privileges: z.array(z.string()).optional(),
  })
  .transform(d => ({
...
export const marshalListPoliciesSchema = z
  .object({
    onSecurableType: z.string().optional(),
    onSecurableFullname: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListPolicies_ResponseSchema = z
  .object({
...
export const marshalUpdatePolicySchema = z
  .object({
    onSecurableType: z.string().optional(),
    onSecurableFullname: z.string().optional(),
    name: z.string().optional(),
