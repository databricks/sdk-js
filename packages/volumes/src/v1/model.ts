...
export const marshalCreateVolumeSchema = z
  .object({
    name: z.string().optional(),
...
export const marshalDeleteVolumeSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteVolume_ResponseSchema = z.object({});
...
export const marshalGetVolumeSchema = z
  .object({
    fullNameArg: z.string().optional(),
...
export const marshalListVolumesSchema = z
  .object({
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
    includeBrowse: z.boolean().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListVolumes_ResponseSchema = z
  .object({
...
export const marshalUpdateVolumeSchema = z
  .object({
    fullNameArg: z.string().optional(),
...
export const marshalVolumeInfoSchema = z
  .object({
    name: z.string().optional(),
    catalogName: z.string().optional(),
    schemaName: z.string().optional(),
