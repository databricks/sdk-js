...
export const unmarshalAccessRequestDestinationsSchema = z
  .object({
    destinations: z
...
export const unmarshalBatchCreateAccessRequestsRequestSchema = z
  .object({
    requests: z
...
export const unmarshalBatchCreateAccessRequestsResponseSchema = z
  .object({
    responses: z
...
export const unmarshalCreateAccessRequestSchema = z
  .object({
...
export const unmarshalCreateAccessRequestResponseSchema = z
  .object({
    behalf_of: z.lazy(() => unmarshalPrincipalSchema).optional(),
...
export const unmarshalGetAccessRequestDestinationsRequestSchema = z
  .object({
    securable_type: z.string().optional(),
    full_name: z.string().optional(),
  })
...
export const unmarshalPrincipalSchema = z
  .object({
...
export const unmarshalSecurableSchema = z
  .object({
...
export const unmarshalSecurablePermissionsSchema = z
  .object({
    securable: z.lazy(() => unmarshalSecurableSchema).optional(),
...
export const unmarshalUpdateAccessRequestDestinationsRequestSchema = z
  .object({
...
export const marshalAccessRequestDestinationsSchema = z
  .object({
    destinations: z
...
export const marshalBatchCreateAccessRequestsRequestSchema = z
  .object({
    requests: z
...
export const marshalBatchCreateAccessRequestsResponseSchema = z
  .object({
    responses: z
...
export const marshalCreateAccessRequestSchema = z
  .object({
...
export const marshalCreateAccessRequestResponseSchema = z
  .object({
    behalfOf: z.lazy(() => marshalPrincipalSchema).optional(),
...
export const marshalGetAccessRequestDestinationsRequestSchema = z
  .object({
    securableType: z.string().optional(),
    fullName: z.string().optional(),
  })
...
export const marshalPrincipalSchema = z
  .object({
    id: z.string().optional(),
...
export const marshalSecurableSchema = z
  .object({
    type: z.enum(SecurableType).optional(),
    fullName: z.string().optional(),
...
export const marshalSecurablePermissionsSchema = z
  .object({
    securable: z.lazy(() => marshalSecurableSchema).optional(),
    permissions: z.array(z.string()).optional(),
  })
...
export const marshalUpdateAccessRequestDestinationsRequestSchema = z
  .object({
