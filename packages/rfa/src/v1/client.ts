...
export class Client {
   ...
   */
  async batchCreateAccessRequests(signal: AbortSignal | undefined, req: BatchCreateAccessRequestsRequest, options?: Options): Promise<BatchCreateAccessRequestsResponse> {
   ...
   * "external_location", "connection", "credential", "function", "registered_model", and "volume".
   */
  async getAccessRequestDestinations(signal: AbortSignal | undefined, req: GetAccessRequestDestinationsRequest, options?: Options): Promise<AccessRequestDestinations> {
   ...
   * "external_location", "connection", "credential", "function", "registered_model", and "volume".
   */
  async updateAccessRequestDestinations(signal: AbortSignal | undefined, req: UpdateAccessRequestDestinationsRequest, options?: Options): Promise<AccessRequestDestinations> {
