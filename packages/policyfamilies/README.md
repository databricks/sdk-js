...
```bash
npm install @databricks/sdk-policyfamilies
```

## Usage

```typescript
import {PolicyFamiliesClient} from '@databricks/sdk-policyfamilies/v2';

const client = new PolicyFamiliesClient({});
```
