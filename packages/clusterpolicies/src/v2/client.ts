...
export class Client {
  ...
  async createPolicy(signal: AbortSignal | undefined, req: CreatePolicy, options?: Options): Promise<CreatePolicy_Response> {
  ...
  async editPolicy(signal: AbortSignal | undefined, req: EditPolicy, options?: Options): Promise<EditPolicy_Response> {
  ...
  async getPolicy(signal: AbortSignal | undefined, req: GetPolicy, options?: Options): Promise<Policy> {
