...
export const unmarshalCreateQualityMonitorRequestSchema: z.ZodType<CreateQualityMonitorRequest> = z
  .object({
...
export const unmarshalDeleteQualityMonitorRequestSchema: z.ZodType<DeleteQualityMonitorRequest> = z
  .object({
...
export const unmarshalGetQualityMonitorRequestSchema: z.ZodType<GetQualityMonitorRequest> = z
  .object({
    object_type: z.string().optional(),
    object_id: z.string().optional(),
  })
...
export const unmarshalListQualityMonitorRequestSchema: z.ZodType<ListQualityMonitorRequest> = z
  .object({
...
export const unmarshalUpdateQualityMonitorRequestSchema: z.ZodType<UpdateQualityMonitorRequest> = z
  .object({
    object_type: z.string().optional(),
    object_id: z.string().optional(),
    quality_monitor: z.lazy(() => unmarshalQualityMonitorSchema).optional(),
...
export const marshalListQualityMonitorResponseSchema: z.ZodType = z
  .object({
    qualityMonitors: z.array(z.lazy(() => marshalQualityMonitorSchema)).optional(),
