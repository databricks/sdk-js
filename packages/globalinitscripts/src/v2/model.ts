...
export const unmarshalCreateGlobalInitScriptSchema: z.ZodType<CreateGlobalInitScript> = z
  .object({
    name: z.string().optional(),
    script: z.string().transform(s => Uint8Array.from(atob(s), c => c.charCodeAt(0))).optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalCreateGlobalInitScript_ResponseSchema: z.ZodType<CreateGlobalInitScript_Response> = z
  .object({
...
export const unmarshalDeleteGlobalInitScriptSchema: z.ZodType<DeleteGlobalInitScript> = z
  .object({
    script_id: z.string().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalDeleteGlobalInitScript_ResponseSchema: z.ZodType<DeleteGlobalInitScript_Response> = z
  .object({
  });

export const unmarshalGetGlobalInitScriptSchema: z.ZodType<GetGlobalInitScript> = z
  .object({
    script_id: z.string().optional(),
  })
  .transform(d => ({
...
export const unmarshalGlobalInitScriptDetailsSchema: z.ZodType<GlobalInitScriptDetails> = z
  .object({
    script_id: z.string().optional(),
    name: z.string().optional(),
    position: z.number().optional(),
...
export const unmarshalListGlobalInitScriptsSchema: z.ZodType<ListGlobalInitScripts> = z
  .object({
  });

// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalListGlobalInitScripts_ResponseSchema: z.ZodType<ListGlobalInitScripts_Response> = z
  .object({
    scripts: z.array(z.lazy(() => unmarshalGlobalInitScriptDetailsSchema)).optional(),
  })
  .transform(d => ({
    scripts: d.scripts,
  }));

export const unmarshalUpdateGlobalInitScriptSchema: z.ZodType<UpdateGlobalInitScript> = z
  .object({
    script_id: z.string().optional(),
    name: z.string().optional(),
    script: z.string().transform(s => Uint8Array.from(atob(s), c => c.charCodeAt(0))).optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalUpdateGlobalInitScript_ResponseSchema: z.ZodType<UpdateGlobalInitScript_Response> = z
  .object({
  });
...
export const marshalCreateGlobalInitScriptSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    script: z.any().transform((d: Uint8Array) => btoa(Array.from(d, b => String.fromCharCode(b)).join(''))).optional(),
    position: z.number().optional(),
    enabled: z.boolean().optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteGlobalInitScript_ResponseSchema: z.ZodType = z
  .object({
  });
...
export const marshalListGlobalInitScriptsSchema: z.ZodType = z
  .object({
  });
...
export const marshalListGlobalInitScripts_ResponseSchema: z.ZodType = z
  .object({
    scripts: z.array(z.lazy(() => marshalGlobalInitScriptDetailsSchema)).optional(),
  })
  .transform(d => ({
    scripts: d.scripts,
  }));
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateGlobalInitScript_ResponseSchema: z.ZodType = z
  .object({
  });
