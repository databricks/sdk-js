...
export class Client {
  ...
  async createGlobalInitScript(signal: AbortSignal | undefined, req: CreateGlobalInitScript, options?: Options): Promise<CreateGlobalInitScript_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      resp = parseResponse(respBody, unmarshalCreateGlobalInitScript_ResponseSchema);
    };
  ...
  async deleteGlobalInitScript(signal: AbortSignal | undefined, req: DeleteGlobalInitScript, options?: Options): Promise<DeleteGlobalInitScript_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalDeleteGlobalInitScript_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async getGlobalInitScript(signal: AbortSignal | undefined, req: GetGlobalInitScript, options?: Options): Promise<GlobalInitScriptDetails> {
    const url = `${this.host}/api/2.0/global-init-scripts/${req.scriptId ?? ''}`;
   ...
   */
  async listGlobalInitScripts(signal: AbortSignal | undefined, _req: ListGlobalInitScripts, options?: Options): Promise<ListGlobalInitScripts_Response> {
    const url = `${this.host}/api/2.0/global-init-scripts`;
    let resp: ListGlobalInitScripts_Response | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const httpReq = buildHttpRequest('GET', url, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalListGlobalInitScripts_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async updateGlobalInitScript(signal: AbortSignal | undefined, req: UpdateGlobalInitScript, options?: Options): Promise<UpdateGlobalInitScript_Response> {
    const url = `${this.host}/api/2.0/global-init-scripts/${req.scriptId ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdateGlobalInitScript_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
