# @databricks/sdk-clusterlibraries
...
```bash
npm install @databricks/sdk-clusterlibraries
```

## Usage

```typescript
import {ClusterLibrariesClient} from '@databricks/sdk-clusterlibraries/v2';

const client = new ClusterLibrariesClient({});
```
