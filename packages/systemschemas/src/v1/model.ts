...
export const marshalDisableSystemSchemaSchema = z
  .object({
    schema: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDisableSystemSchema_ResponseSchema = z.object({});

export const marshalEnableSystemSchemaSchema = z
  .object({
    schema: z.string().optional(),
    metastoreId: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalEnableSystemSchema_ResponseSchema = z.object({});

export const marshalListSystemSchemasSchema = z
  .object({
    metastoreId: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListSystemSchemas_ResponseSchema = z
  .object({
...
export const marshalSystemSchemaInfoSchema = z
  .object({
    schema: z.string(),
    state: z.string(),
  })
