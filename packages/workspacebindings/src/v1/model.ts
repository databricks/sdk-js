...
export const marshalGetCatalogWorkspaceBindingsSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetCatalogWorkspaceBindings_ResponseSchema = z
  .object({
    workspaces: z.array(z.number()).optional(),
  })
  .transform(d => ({
...
export const marshalGetWorkspaceBindingsSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetWorkspaceBindings_ResponseSchema = z
  .object({
    bindings: z
...
export const marshalUpdateCatalogWorkspaceBindingsSchema = z
  .object({
    catalogName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateCatalogWorkspaceBindings_ResponseSchema = z
  .object({
    workspaces: z.array(z.number()).optional(),
  })
  .transform(d => ({
...
export const marshalUpdateWorkspaceBindingsSchema = z
  .object({
    securableType: z.string().optional(),
    securableFullName: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateWorkspaceBindings_ResponseSchema = z
  .object({
    bindings: z
      .array(z.lazy(() => marshalWorkspaceBindingInfoSchema))
      .optional(),
