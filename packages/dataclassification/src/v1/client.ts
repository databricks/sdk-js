...
export class Client {
   ...
   */
  async createCatalogConfig(signal: AbortSignal | undefined, req: CreateCatalogConfigRequest, options?: Options): Promise<CatalogConfig> {
  ...
  async deleteCatalogConfig(signal: AbortSignal | undefined, req: DeleteCatalogConfigRequest, options?: Options): Promise<void> {
  ...
  async getCatalogConfig(signal: AbortSignal | undefined, req: GetCatalogConfigRequest, options?: Options): Promise<CatalogConfig> {
    const url = `${this.host}/api/data-classification/v1/${req.name ?? ''}`;
    let resp: CatalogConfig | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   */
  async updateCatalogConfig(signal: AbortSignal | undefined, req: UpdateCatalogConfigRequest, options?: Options): Promise<CatalogConfig> {
