...
/** Contains the BudgetPolicy details. */
export interface CreateBudgetPolicy {
  /** The Id of the policy. This field is generated by <Databricks> and globally unique. */
  policyId?: string | undefined;
  /**
   * The name of the policy.
  ...
  policyName?: string | undefined;
  /** A list of tags defined by the customer. At most 20 entries are allowed per policy. */
  customTags?: CreateCustomPolicyTag[] | undefined;
  /**
   * List of workspaces that this budget policy will be exclusively bound to.
   * An empty binding implies that this budget policy is open to any workspace in the account.
   */
...
export interface CreateBudgetPolicyRequest {
   ...
   */
  policy?: CreateBudgetPolicy | undefined;
}

export interface CreateCustomPolicyTag {
  /**
   * The key of the tag.
...
/** Contains the BudgetPolicy details. */
export interface UpdateBudgetPolicy {
  /** The Id of the policy. This field is generated by <Databricks> and globally unique. */
  policyId?: string | undefined;
  /**
   * The name of the policy.
  ...
  policyName?: string | undefined;
  /** A list of tags defined by the customer. At most 20 entries are allowed per policy. */
  customTags?: UpdateCustomPolicyTag[] | undefined;
  /**
   * List of workspaces that this budget policy will be exclusively bound to.
   * An empty binding implies that this budget policy is open to any workspace in the account.
   */
...
export interface UpdateBudgetPolicyRequest {
   ...
   * update.
   */
  policy?: UpdateBudgetPolicy | undefined;
  /** The account Id of the customer */
  accountId?: string | undefined;
...
export interface UpdateCustomPolicyTag {
  /**
   * The key of the tag.
   * - Must be unique among all custom tags of the same policy
   * - Cannot be “budget-policy-name”, “budget-policy-id” or "budget-policy-resolution-result" -
...
export const marshalCreateBudgetPolicySchema: z.ZodType = z
  .object({
    policyId: z.string().optional(),
    policyName: z.string().optional(),
    customTags: z
      .array(z.lazy(() => marshalCreateCustomPolicyTagSchema))
      .optional(),
...
export const marshalCreateBudgetPolicyRequestSchema: z.ZodType = z
  .object({
    ...
    policy: z.lazy(() => marshalCreateBudgetPolicySchema).optional(),
  })
  .transform(d => ({
...
export const marshalCreateCustomPolicyTagSchema: z.ZodType = z
  .object({
    key: z.string(),
    value: z.string().optional(),
  })
...
export const marshalUpdateBudgetPolicySchema: z.ZodType = z
  .object({
    policyId: z.string().optional(),
    policyName: z.string().optional(),
    customTags: z
      .array(z.lazy(() => marshalUpdateCustomPolicyTagSchema))
      .optional(),
    bindingWorkspaceIds: z.array(z.bigint()).optional(),
  })
  .transform(d => ({
...
export const marshalUpdateCustomPolicyTagSchema: z.ZodType = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
