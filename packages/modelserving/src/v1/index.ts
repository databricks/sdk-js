...
export {Client, CreateInferenceEndpointWaiter, CreateProvisionedThroughputInferenceEndpointWaiter, PutInferenceEndpointConfigWaiter, PutProvisionedThroughputInferenceEndpointConfigWaiter} from './client';
