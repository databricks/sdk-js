...
export class Client {
  ...
  async createSpace(req: GenieCreateSpaceRequest, options?: CallOptions): Promise<GenieSpace> {
   ...
   */
  async genieCreateConversationMessage(req: GenieCreateConversationMessageRequest, options?: CallOptions): Promise<GenieMessage> {
...
async genieCreateConversationMessageWaiter(
  ...
  async genieCreateEvalRun(req: GenieCreateEvalRunRequest, options?: CallOptions): Promise<GenieEvalRunResponse> {
  ...
  async genieCreateMessageComment(req: GenieCreateMessageCommentRequest, options?: CallOptions): Promise<GenieMessageComment> {
  ...
  async genieDeleteConversation(req: GenieDeleteConversationRequest, options?: CallOptions): Promise<void> {
  ...
  async genieDeleteConversationMessage(req: GenieDeleteConversationMessageRequest, options?: CallOptions): Promise<void> {
  ...
  async genieExecuteMessageAttachmentQuery(req: GenieExecuteMessageAttachmentQueryRequest, options?: CallOptions): Promise<GenieGetMessageQueryResultResponse> {
  ...
  async genieExecuteMessageQuery(req: GenieExecuteMessageQueryRequest, options?: CallOptions): Promise<GenieGetMessageQueryResultResponse> {
   ...
   * ----
   */
  async genieGenerateDownloadFullQueryResult(req: GenieGenerateDownloadFullQueryResultRequest, options?: CallOptions): Promise<GenieGenerateDownloadFullQueryResultResponse> {
  ...
  async genieGetConversationMessage(req: GenieGetConversationMessageRequest, options?: CallOptions): Promise<GenieMessage> {
    const url = `${this.host}/api/2.0/genie/spaces/${req.spaceId ?? ''}/conversations/${req.conversationId ?? ''}/messages/${req.messageId ?? ''}`;
    let resp: GenieMessage | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   * ----
   */
  async genieGetDownloadFullQueryResult(req: GenieGetDownloadFullQueryResultRequest, options?: CallOptions): Promise<GenieGetDownloadFullQueryResultResponse> {
  ...
  async genieGetEvalResultDetails(req: GenieGetEvalResultDetailsRequest, options?: CallOptions): Promise<GenieEvalResultDetails> {
  ...
  async genieGetEvalRun(req: GenieGetEvalRunRequest, options?: CallOptions): Promise<GenieEvalRunResponse> {
   ...
   */
  async genieGetMessageAttachmentQueryResult(req: GenieGetMessageAttachmentQueryResultRequest, options?: CallOptions): Promise<GenieGetMessageQueryResultResponse> {
  ...
  async genieGetMessageQueryResult(req: GenieGetMessageQueryResultRequest, options?: CallOptions): Promise<GenieGetMessageQueryResultResponse> {
  ...
  /** DEPRECATED: Use [Get Message Attachment Query Result](:method:genie/getmessageattachmentqueryresult) instead. */
  async genieGetQueryResultByAttachment(req: GenieGetQueryResultByAttachmentRequest, options?: CallOptions): Promise<GenieGetMessageQueryResultResponse> {
  ...
  async genieGetSpace(req: GenieGetSpaceRequest, options?: CallOptions): Promise<GenieSpace> {
  ...
  async genieListConversationComments(req: GenieListConversationCommentsRequest, options?: CallOptions): Promise<GenieListConversationCommentsResponse> {
  ...
  async genieListConversationMessages(req: GenieListConversationMessagesRequest, options?: CallOptions): Promise<GenieListConversationMessagesResponse> {
    const url = `${this.host}/api/2.0/genie/spaces/${req.spaceId ?? ''}/conversations/${req.conversationId ?? ''}/messages`;
    const params = new URLSearchParams();
    if (req.pageSize !== undefined) {
      params.append('page_size', String(req.pageSize));
  ...
  async genieListConversations(req: GenieListConversationsRequest, options?: CallOptions): Promise<GenieListConversationsResponse> {
  ...
  async genieListEvalResults(req: GenieListEvalResultsRequest, options?: CallOptions): Promise<GenieListEvalResultsResponse> {
  ...
  async genieListEvalRuns(req: GenieListEvalRunsRequest, options?: CallOptions): Promise<GenieListEvalRunsResponse> {
    const url = `${this.host}/api/2.0/genie/spaces/${req.spaceId ?? ''}/eval-runs`;
    const params = new URLSearchParams();
    if (req.pageSize !== undefined) {
      params.append('page_size', String(req.pageSize));
  ...
  async genieListMessageComments(req: GenieListMessageCommentsRequest, options?: CallOptions): Promise<GenieListMessageCommentsResponse> {
    const url = `${this.host}/api/2.0/genie/spaces/${req.spaceId ?? ''}/conversations/${req.conversationId ?? ''}/messages/${req.messageId ?? ''}/comments`;
    const params = new URLSearchParams();
    if (req.pageSize !== undefined) {
      params.append('page_size', String(req.pageSize));
  ...
  async genieListSpaces(req: GenieListSpacesRequest, options?: CallOptions): Promise<GenieListSpacesResponse> {
    const url = `${this.host}/api/2.0/genie/spaces`;
    const params = new URLSearchParams();
    if (req.pageSize !== undefined) {
      params.append('page_size', String(req.pageSize));
  ...
  async genieSendMessageFeedback(req: GenieSendMessageFeedbackRequest, options?: CallOptions): Promise<void> {
  ...
  async genieStartConversation(req: GenieStartConversationMessageRequest, options?: CallOptions): Promise<GenieStartConversationResponse> {
...
async genieStartConversationWaiter(
  ...
  async genieTrashSpace(req: GenieTrashSpaceRequest, options?: CallOptions): Promise<void> {
    const url = `${this.host}/api/2.0/genie/spaces/${req.spaceId ?? ''}`;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
      headers.set('User-Agent', this.userAgent);
  ...
  async updateSpace(req: GenieUpdateSpaceRequest, options?: CallOptions): Promise<GenieSpace> {
    const url = `${this.host}/api/2.0/genie/spaces/${req.spaceId ?? ''}`;
