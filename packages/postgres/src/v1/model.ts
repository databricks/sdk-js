...
export interface SyncedTable_SyncedTableSpec {
  ...
  extraIndexDefinitions?: SyncedTable_SyncedTableSpec_SecondaryIndex[] | undefined;
  /** Extra PostgreSQL-only columns to add to the synced table. */
  extraColumnDefinitions?: SyncedTable_SyncedTableSpec_ExtraColumnDefinition[] | undefined;
}
...
export interface SyncedTable_SyncedTableSpec_SecondaryIndex {
  ...
  creationPoint?: SyncedTable_SyncedTableSpec_SecondaryIndex_CreationPoint | undefined;
}
...
export const unmarshalDeleteForwardEtlConfigurationResponseSchema: z.ZodType<DeleteForwardEtlConfigurationResponse> = z
  .object({
...
export const unmarshalSyncedTable_SyncedTableSpecSchema: z.ZodType<SyncedTable_SyncedTableSpec> = z
  .object({
    ...
    type_overrides: z.array(z.lazy(() => unmarshalSyncedTable_SyncedTableSpec_TypeOverrideSchema)).optional(),
    extra_index_definitions: z.array(z.lazy(() => unmarshalSyncedTable_SyncedTableSpec_SecondaryIndexSchema)).optional(),
    extra_column_definitions: z.array(z.lazy(() => unmarshalSyncedTable_SyncedTableSpec_ExtraColumnDefinitionSchema)).optional(),
  })
  .transform(d => ({
    postgresDatabase: d.postgres_database,
    branch: d.branch,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalSyncedTable_SyncedTableSpec_ExtraColumnDefinitionSchema: z.ZodType<SyncedTable_SyncedTableSpec_ExtraColumnDefinition> = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalSyncedTable_SyncedTableSpec_SecondaryIndexSchema: z.ZodType<SyncedTable_SyncedTableSpec_SecondaryIndex> = z
  .object({
    name: z.string().optional(),
    definition: z.string().optional(),
    creation_point: z.enum(SyncedTable_SyncedTableSpec_SecondaryIndex_CreationPoint).optional(),
  })
  .transform(d => ({
    name: d.name,
    definition: d.definition,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalSyncedTable_SyncedTableSpec_TypeOverrideSchema: z.ZodType<SyncedTable_SyncedTableSpec_TypeOverride> = z
  .object({
    column_name: z.string().optional(),
...
export const marshalSyncedTable_SyncedTableSpecSchema: z.ZodType = z
  .object({
    ...
    typeOverrides: z.array(z.lazy(() => marshalSyncedTable_SyncedTableSpec_TypeOverrideSchema)).optional(),
    extraIndexDefinitions: z.array(z.lazy(() => marshalSyncedTable_SyncedTableSpec_SecondaryIndexSchema)).optional(),
    extraColumnDefinitions: z.array(z.lazy(() => marshalSyncedTable_SyncedTableSpec_ExtraColumnDefinitionSchema)).optional(),
  })
  .transform(d => ({
    postgres_database: d.postgresDatabase,
    branch: d.branch,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalSyncedTable_SyncedTableSpec_ExtraColumnDefinitionSchema: z.ZodType = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalSyncedTable_SyncedTableSpec_SecondaryIndexSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    definition: z.string().optional(),
    creationPoint: z.enum(SyncedTable_SyncedTableSpec_SecondaryIndex_CreationPoint).optional(),
  })
  .transform(d => ({
    name: d.name,
    definition: d.definition,
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalSyncedTable_SyncedTableSpec_TypeOverrideSchema: z.ZodType = z
  .object({
    columnName: z.string().optional(),
