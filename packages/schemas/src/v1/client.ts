...
export class Client {
   ...
   */
  async createSchema(signal: AbortSignal | undefined, req: CreateSchema, options?: Options): Promise<SchemaInfo> {
   ...
   */
  async deleteSchema(signal: AbortSignal | undefined, req: DeleteSchema, options?: Options): Promise<DeleteSchema_Response> {
   ...
   */
  async getSchema(signal: AbortSignal | undefined, req: GetSchema, options?: Options): Promise<SchemaInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/schemas/${req.fullNameArg ?? ''}`;
    const params = new URLSearchParams();
   ...
   */
  async listSchemas(signal: AbortSignal | undefined, req: ListSchemas, options?: Options): Promise<ListSchemas_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/schemas`;
    const params = new URLSearchParams();
  ...
  async *listSchemasIter(signal: AbortSignal | undefined, req: ListSchemas, options?: Options): AsyncGenerator<SchemaInfo> {
   ...
   */
  async updateSchema(signal: AbortSignal | undefined, req: UpdateSchema, options?: Options): Promise<SchemaInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/schemas/${req.fullNameArg ?? ''}`;
