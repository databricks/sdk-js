...
export class Client {
   ...
   */
  async createCredential(signal: AbortSignal | undefined, req: CreateCredential, options?: Options): Promise<StorageCredentialInfo> {
   ...
   */
  async createStorageCredential(signal: AbortSignal | undefined, req: CreateStorageCredential, options?: Options): Promise<StorageCredentialInfo> {
  ...
  async deleteCredential(signal: AbortSignal | undefined, req: DeleteCredential, options?: Options): Promise<DeleteCredential_Response> {
  ...
  async deleteStorageCredential(signal: AbortSignal | undefined, req: DeleteStorageCredential, options?: Options): Promise<DeleteStorageCredential_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('DELETE', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalDeleteStorageCredential_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async generateTemporaryPathCredential(signal: AbortSignal | undefined, req: GenerateTemporaryPathCredential, options?: Options): Promise<GenerateTemporaryPathCredential_Response> {
    const url = `${this.host}/api/2.0/unity-catalog/temporary-path-credentials`;
    const body = marshalRequest(req, marshalGenerateTemporaryPathCredentialSchema);
    let resp: GenerateTemporaryPathCredential_Response | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers({'Content-Type': 'application/json'});
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGenerateTemporaryPathCredential_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async generateTemporaryServiceCredential(signal: AbortSignal | undefined, req: GenerateTemporaryServiceCredential, options?: Options): Promise<TemporaryCredentials> {
    const url = `${this.host}/api/2.1/unity-catalog/temporary-service-credentials`;
    const body = marshalRequest(req, marshalGenerateTemporaryServiceCredentialSchema);
   ...
   * by catalog owners.
   */
  async generateTemporaryTableCredential(signal: AbortSignal | undefined, req: GenerateTemporaryTableCredential, options?: Options): Promise<GenerateTemporaryTableCredential_Response> {
    const url = `${this.host}/api/2.0/unity-catalog/temporary-table-credentials`;
    const body = marshalRequest(req, marshalGenerateTemporaryTableCredentialSchema);
    let resp: GenerateTemporaryTableCredential_Response | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers({'Content-Type': 'application/json'});
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGenerateTemporaryTableCredential_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   * by catalog owners.
   */
  async generateTemporaryVolumeCredential(signal: AbortSignal | undefined, req: GenerateTemporaryVolumeCredential, options?: Options): Promise<GenerateTemporaryVolumeCredential_Response> {
    const url = `${this.host}/api/2.0/unity-catalog/temporary-volume-credentials`;
    const body = marshalRequest(req, marshalGenerateTemporaryVolumeCredentialSchema);
    let resp: GenerateTemporaryVolumeCredential_Response | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers({'Content-Type': 'application/json'});
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGenerateTemporaryVolumeCredential_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async getCredential(signal: AbortSignal | undefined, req: GetCredential, options?: Options): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/credentials/${req.nameArg ?? ''}`;
    let resp: StorageCredentialInfo | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   */
  async getStorageCredential(signal: AbortSignal | undefined, req: GetStorageCredential, options?: Options): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/storage-credentials/${req.nameArg ?? ''}`;
    let resp: StorageCredentialInfo | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   */
  async listCredentials(signal: AbortSignal | undefined, req: ListCredentials, options?: Options): Promise<ListCredentials_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/credentials`;
    const params = new URLSearchParams();
  ...
  async *listCredentialsIter(signal: AbortSignal | undefined, req: ListCredentials, options?: Options): AsyncGenerator<CredentialInfo> {
   ...
   * Clients must continue reading pages until next_page_token is absent, which is the only indication that the end of results has been reached.
   */
  async listStorageCredentials(signal: AbortSignal | undefined, req: ListStorageCredentials, options?: Options): Promise<ListStorageCredentials_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/storage-credentials`;
    const params = new URLSearchParams();
    if (req.includeUnbound !== undefined) {
      params.append('include_unbound', String(req.includeUnbound));
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalListStorageCredentials_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *listStorageCredentialsIter(signal: AbortSignal | undefined, req: ListStorageCredentials, options?: Options): AsyncGenerator<StorageCredentialInfo> {
   ...
   */
  async updateCredential(signal: AbortSignal | undefined, req: UpdateCredential, options?: Options): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/credentials/${req.nameArg ?? ''}`;
   ...
   */
  async updateStorageCredential(signal: AbortSignal | undefined, req: UpdateStorageCredential, options?: Options): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/storage-credentials/${req.nameArg ?? ''}`;
   ...
   */
  async validateCredential(signal: AbortSignal | undefined, req: ValidateCredential, options?: Options): Promise<ValidateCredential_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalValidateCredential_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async validateStorageCredential(signal: AbortSignal | undefined, req: ValidateStorageCredential, options?: Options): Promise<ValidateStorageCredential_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalValidateStorageCredential_ResponseSchema);
    };
    await execute(signal, call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
