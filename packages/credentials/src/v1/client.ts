...
export class Client {
   ...
   */
  async createAccountsStorageCredential(req: AccountsCreateStorageCredentialRequest, options?: CallOptions): Promise<AccountsCreateStorageCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      resp = parseResponse(respBody, unmarshalAccountsCreateStorageCredentialRequest_ResponseSchema);
    };
  ...
  async deleteAccountsStorageCredential(req: AccountsDeleteStorageCredentialRequest, options?: CallOptions): Promise<AccountsDeleteStorageCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalAccountsDeleteStorageCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async getAccountsStorageCredential(req: AccountsGetStorageCredentialRequest, options?: CallOptions): Promise<AccountsGetStorageCredentialRequest_Response> {
    const url = `${this.host}/api/2.0/accounts/${req.accountId ?? this.accountId ?? ''}/metastores/${req.metastoreId ?? ''}/storage-credentials/${req.nameArg ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalAccountsGetStorageCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async listAccountsStorageCredentials(req: AccountsListStorageCredentialsRequest, options?: CallOptions): Promise<AccountsListStorageCredentialsRequest_Response> {
    const url = `${this.host}/api/2.0/accounts/${req.accountId ?? this.accountId ?? ''}/metastores/${req.metastoreId ?? ''}/storage-credentials`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', url, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalAccountsListStorageCredentialsRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async updateAccountsStorageCredential(req: AccountsUpdateStorageCredentialRequest, options?: CallOptions): Promise<AccountsUpdateStorageCredentialRequest_Response> {
    const url = `${this.host}/api/2.0/accounts/${req.accountId ?? this.accountId ?? ''}/metastores/${req.metastoreId ?? ''}/storage-credentials/${req.nameArg ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalAccountsUpdateStorageCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async createCredential(req: CreateCredentialRequest, options?: CallOptions): Promise<StorageCredentialInfo> {
   ...
   */
  async createStorageCredential(req: CreateStorageCredentialRequest, options?: CallOptions): Promise<StorageCredentialInfo> {
  ...
  async deleteCredential(req: DeleteCredentialRequest, options?: CallOptions): Promise<DeleteCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('DELETE', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalDeleteCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  /** Deletes a storage credential from the metastore. The caller must be an owner of the storage credential. */
  async deleteStorageCredential(req: DeleteStorageCredentialRequest, options?: CallOptions): Promise<DeleteStorageCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('DELETE', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalDeleteStorageCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async generateTemporaryPathCredential(req: GenerateTemporaryPathCredentialRequest, options?: CallOptions): Promise<GenerateTemporaryPathCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGenerateTemporaryPathCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async generateTemporaryServiceCredential(req: GenerateTemporaryServiceCredentialRequest, options?: CallOptions): Promise<TemporaryCredentials> {
   ...
   * by catalog owners.
   */
  async generateTemporaryTableCredential(req: GenerateTemporaryTableCredentialRequest, options?: CallOptions): Promise<GenerateTemporaryTableCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGenerateTemporaryTableCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   * by catalog owners.
   */
  async generateTemporaryVolumeCredential(req: GenerateTemporaryVolumeCredentialRequest, options?: CallOptions): Promise<GenerateTemporaryVolumeCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGenerateTemporaryVolumeCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async getCredential(req: GetCredentialRequest, options?: CallOptions): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/credentials/${req.nameArg ?? ''}`;
    let resp: StorageCredentialInfo | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   */
  async getStorageCredential(req: GetStorageCredentialRequest, options?: CallOptions): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/storage-credentials/${req.nameArg ?? ''}`;
    let resp: StorageCredentialInfo | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
   ...
   */
  async listCredentials(req: ListCredentialsRequest, options?: CallOptions): Promise<ListCredentialsRequest_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/credentials`;
    const params = new URLSearchParams();
  ...
  async *listCredentialsIter(req: ListCredentialsRequest, options?: CallOptions): AsyncGenerator<CredentialInfo> {
   ...
   * Clients must continue reading pages until next_page_token is absent, which is the only indication that the end of results has been reached.
   */
  async listStorageCredentials(req: ListStorageCredentialsRequest, options?: CallOptions): Promise<ListStorageCredentialsRequest_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/storage-credentials`;
    const params = new URLSearchParams();
    if (req.includeUnbound !== undefined) {
      params.append('include_unbound', String(req.includeUnbound));
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalListStorageCredentialsRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *listStorageCredentialsIter(req: ListStorageCredentialsRequest, options?: CallOptions): AsyncGenerator<StorageCredentialInfo> {
   ...
   */
  async updateCredential(req: UpdateCredentialRequest, options?: CallOptions): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/credentials/${req.nameArg ?? ''}`;
   ...
   */
  async updateStorageCredential(req: UpdateStorageCredentialRequest, options?: CallOptions): Promise<StorageCredentialInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/storage-credentials/${req.nameArg ?? ''}`;
   ...
   */
  async validateCredential(req: ValidateCredentialRequest, options?: CallOptions): Promise<ValidateCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalValidateCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async validateStorageCredential(req: ValidateStorageCredentialRequest, options?: CallOptions): Promise<ValidateStorageCredentialRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalValidateStorageCredentialRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
   ...
   */
  async createCredentialsPublic(req: CreateCredentialsRequest, options?: CallOptions): Promise<Credentials> {
  ...
  async deleteCredentialsPublic(req: DeleteCredentialsRequest, options?: CallOptions): Promise<Credentials> {
  ...
  async getCredentialsPublic(req: GetCredentialsRequest, options?: CallOptions): Promise<Credentials> {
    const url = `${this.host}/api/2.0/accounts/${req.accountId ?? this.accountId ?? ''}/credentials/${req.credentialsId ?? ''}`;
    let resp: Credentials | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
  ...
  async listCredentialsPublic(req: ListCredentialsPublicRequest, options?: CallOptions): Promise<ListCredentialsResponse> {
    const url = `${this.host}/api/2.0/accounts/${req.accountId ?? this.accountId ?? ''}/credentials`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = {
        credentials: parseResponse(respBody, z.array(z.lazy(() => unmarshalCredentialsSchema))),
      };
    };
    await executeCall(call, options);
    if (resp === undefined) {
