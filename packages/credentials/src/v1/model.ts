...
export const unmarshalUpdateCredentialSchema: z.ZodType<UpdateCredential> = z
  .object({
    name_arg: z.string().optional(),
...
export const marshalAwsCredentialsSchema = z
  .object({
...
export const marshalAzureActiveDirectoryTokenSchema = z
  .object({
    aadToken: z.string().optional(),
  })
  .transform(d => ({
    aad_token: d.aadToken,
  }));
...
export const marshalAzureUserDelegationSasSchema = z
  .object({
...
export const marshalCreateCredentialSchema = z
  .object({
...
export const marshalCreateStorageCredentialSchema = z
  .object({
    skipValidation: z.boolean().optional(),
    name: z.string().optional(),
    awsIamRole: z.lazy(() => marshalAwsIamRoleSchema).optional(),
...
export const marshalCredentialInfoSchema = z
  .object({
    name: z.string().optional(),
    awsIamRole: z.lazy(() => marshalAwsIamRoleSchema).optional(),
    azureServicePrincipal: z
...
export const marshalDeleteCredentialSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteCredential_ResponseSchema = z.object({});

export const marshalDeleteStorageCredentialSchema = z
  .object({
    nameArg: z.string().optional(),
    force: z.boolean().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteStorageCredential_ResponseSchema = z.object({});

export const marshalGcpOauthTokenSchema = z
  .object({
...
export const marshalGenerateTemporaryPathCredentialSchema = z
  .object({
    url: z.string().optional(),
    operation: z.enum(PathOperation).optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGenerateTemporaryPathCredential_ResponseSchema = z
  .object({
...
export const marshalGenerateTemporaryServiceCredentialSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGenerateTemporaryServiceCredential_AzureOptionsSchema = z
  .object({
    resources: z.array(z.string()).optional(),
  })
  .transform(d => ({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGenerateTemporaryServiceCredential_GcpOptionsSchema = z
  .object({
    scopes: z.array(z.string()).optional(),
  })
  .transform(d => ({
...
export const marshalGenerateTemporaryTableCredentialSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGenerateTemporaryTableCredential_ResponseSchema = z
  .object({
    awsTempCredentials: z.lazy(() => marshalAwsCredentialsSchema).optional(),
    azureUserDelegationSas: z
      .lazy(() => marshalAzureUserDelegationSasSchema)
...
export const marshalGetCredentialSchema = z
  .object({
    nameArg: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalGetStorageCredentialSchema = z
  .object({
    nameArg: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalListCredentialsSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListCredentials_ResponseSchema = z
  .object({
    credentials: z.array(z.lazy(() => marshalCredentialInfoSchema)).optional(),
...
export const marshalListStorageCredentialsSchema = z
  .object({
    includeUnbound: z.boolean().optional(),
    maxResults: z.number().optional(),
    pageToken: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListStorageCredentials_ResponseSchema = z
  .object({
  ...
  .transform(d => ({
    storage_credentials: d.storageCredentials,
    next_page_token: d.nextPageToken,
  }));

export const marshalR2CredentialsSchema = z
  .object({
    accessKeyId: z.string().optional(),
    secretAccessKey: z.string().optional(),
    sessionToken: z.string().optional(),
...
export const marshalStorageCredentialInfoSchema = z
  .object({
    name: z.string().optional(),
    awsIamRole: z.lazy(() => marshalAwsIamRoleSchema).optional(),
    azureServicePrincipal: z
...
export const marshalTemporaryCredentialsSchema = z
  .object({
    awsTempCredentials: z.lazy(() => marshalAwsCredentialsSchema).optional(),
    azureUserDelegationSas: z
      .lazy(() => marshalAzureUserDelegationSasSchema)
...
export const marshalUcEncryptedTokenSchema = z
  .object({
...
export const marshalUpdateCredentialSchema = z
  .object({
    nameArg: z.string().optional(),
...
export const marshalUpdateStorageCredentialSchema = z
  .object({
    nameArg: z.string().optional(),
    newName: z.string().optional(),
    skipValidation: z.boolean().optional(),
...
export const marshalValidateCredentialSchema = z
  .object({
    credentialName: z.string().optional(),
    awsIamRole: z.lazy(() => marshalAwsIamRoleSchema).optional(),
    azureManagedIdentity: z
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalValidateCredential_ResponseSchema = z
  .object({
    results: z
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalValidateCredential_ValidationResultSchema = z
  .object({
    result: z.enum(ValidateCredential_Result).optional(),
    message: z.string().optional(),
  })
...
export const marshalValidateStorageCredentialSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalValidateStorageCredential_ResponseSchema = z
  .object({
    isDir: z.boolean().optional(),
    results: z
      .array(
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalValidateStorageCredential_ValidationResultSchema = z
  .object({
    operation: z.enum(ValidateStorageCredential_FileOperation).optional(),
    result: z.enum(ValidateStorageCredential_Result).optional(),
    message: z.string().optional(),
