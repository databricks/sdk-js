...
export const marshalAzureActiveDirectoryTokenSchema: z.ZodType = z
  .object({
...
export const marshalAzureUserDelegationSasSchema: z.ZodType = z
  .object({
...
export const marshalCredentialInfoSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    awsIamRole: z.lazy(() => marshalAwsIamRoleSchema).optional(),
    azureServicePrincipal: z
...
export const marshalR2CredentialsSchema: z.ZodType = z
  .object({
    accessKeyId: z.string().optional(),
    secretAccessKey: z.string().optional(),
    sessionToken: z.string().optional(),
...
export const marshalStorageCredentialInfoSchema: z.ZodType = z
  .object({
    name: z.string().optional(),
    awsIamRole: z.lazy(() => marshalAwsIamRoleSchema).optional(),
    azureServicePrincipal: z
...
export const marshalUcEncryptedTokenSchema: z.ZodType = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalValidateCredential_ValidationResultSchema: z.ZodType = z
  .object({
    result: z.enum(ValidateCredential_Result).optional(),
    message: z.string().optional(),
  })
