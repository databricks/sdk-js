# @databricks/sdk-keyconfigurations
...
```bash
npm install @databricks/sdk-keyconfigurations
```

## Usage

```typescript
import {KeyConfigurationsClient} from '@databricks/sdk-keyconfigurations/v1';

const client = new KeyConfigurationsClient({});
```
