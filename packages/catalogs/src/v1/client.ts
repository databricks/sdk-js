...
export class Client {
  ...
  async createCatalog(signal: AbortSignal | undefined, req: CreateCatalog, options?: Options): Promise<CatalogInfo> {
  ...
  async deleteCatalog(signal: AbortSignal | undefined, req: DeleteCatalog, options?: Options): Promise<DeleteCatalog_Response> {
   ...
   */
  async getCatalog(signal: AbortSignal | undefined, req: GetCatalog, options?: Options): Promise<CatalogInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/catalogs/${req.nameArg ?? ''}`;
    const params = new URLSearchParams();
   ...
   */
  async listCatalogs(signal: AbortSignal | undefined, req: ListCatalogs, options?: Options): Promise<ListCatalogs_Response> {
    const url = `${this.host}/api/2.1/unity-catalog/catalogs`;
    const params = new URLSearchParams();
    if (req.includeBrowse !== undefined) {
      params.append('include_browse', String(req.includeBrowse));
  ...
  async *listCatalogsIter(signal: AbortSignal | undefined, req: ListCatalogs, options?: Options): AsyncGenerator<CatalogInfo> {
   ...
   */
  async updateCatalog(signal: AbortSignal | undefined, req: UpdateCatalog, options?: Options): Promise<CatalogInfo> {
    const url = `${this.host}/api/2.1/unity-catalog/catalogs/${req.nameArg ?? ''}`;
