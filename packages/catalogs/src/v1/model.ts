...
export interface DrReplicationInfo {
  ...
  replicatedEntities?: ReadableStream | undefined;
}
...
export const unmarshalDrReplicationInfoSchema: z.ZodType<DrReplicationInfo> = z
  .object({
    ...
    replicated_entities: z.any().optional(),
  })
  .transform(d => ({
    status: d.status,
...
export const marshalCatalogInfoSchema = z
  .object({
    name: z.string().optional(),
    owner: z.string().optional(),
    comment: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCatalogInfo_OptionsEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCatalogInfo_PropertiesEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const marshalConversionInfoSchema = z
  .object({
    state: z.enum(ConversionInfo_State).optional(),
  })
  .transform(d => ({
...
export const marshalCreateCatalogSchema = z
  .object({
    name: z.string().optional(),
    owner: z.string().optional(),
    comment: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCreateCatalog_OptionsEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalCreateCatalog_PropertiesEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
export const marshalDeleteCatalogSchema = z
  .object({
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalDeleteCatalog_ResponseSchema = z.object({});

export const marshalDrReplicationInfoSchema = z
  .object({
    status: z.enum(DrReplicationStatus).optional(),
    replicatedEntities: z.any().optional(),
  })
  .transform(d => ({
    status: d.status,
...
export const marshalGetCatalogSchema = z
  .object({
    nameArg: z.string().optional(),
...
export const marshalListCatalogsSchema = z
  .object({
    includeBrowse: z.boolean().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalListCatalogs_ResponseSchema = z
  .object({
...
export const marshalUpdateCatalogSchema = z
  .object({
    nameArg: z.string().optional(),
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateCatalog_OptionsEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalUpdateCatalog_PropertiesEntrySchema = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
