...
export class Client {
  ...
  async batchGetListings(req: BatchGetListingsRequest, options?: CallOptions): Promise<BatchGetListingsResponse> {
  ...
  async batchGetProviders(req: BatchGetProvidersRequest, options?: CallOptions): Promise<BatchGetProvidersResponse> {
  ...
  async createPersonalizationRequest(req: CreatePersonalizationRequest, options?: CallOptions): Promise<CreatePersonalizationRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalCreatePersonalizationRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async getAllInstallations(req: GetAllInstallations, options?: CallOptions): Promise<GetAllInstallations_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetAllInstallations_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *getAllInstallationsIter(req: GetAllInstallations, options?: CallOptions): AsyncGenerator<InstallationDetail> {
  ...
  async getAllPersonalizationRequestsForConsumer(req: GetAllPersonalizationRequestsForConsumer, options?: CallOptions): Promise<GetAllPersonalizationRequestsForConsumer_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetAllPersonalizationRequestsForConsumer_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *getAllPersonalizationRequestsForConsumerIter(req: GetAllPersonalizationRequestsForConsumer, options?: CallOptions): AsyncGenerator<PersonalizationRequest> {
    const pageReq: GetAllPersonalizationRequestsForConsumer = {...req};
    for (;;) {
      const resp = await this.getAllPersonalizationRequestsForConsumer(pageReq, options);
  ...
  async getInstallationDetails(req: GetInstallationDetails, options?: CallOptions): Promise<GetInstallationDetails_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetInstallationDetails_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *getInstallationDetailsIter(req: GetInstallationDetails, options?: CallOptions): AsyncGenerator<InstallationDetail> {
  ...
  async getListingContent(req: GetListingContent, options?: CallOptions): Promise<GetListingContent_Response> {
  ...
  async *getListingContentIter(req: GetListingContent, options?: CallOptions): AsyncGenerator<SharedDataObject> {
   ...
   */
  async getListingFulfillments(req: GetListingFulfillments, options?: CallOptions): Promise<GetListingFulfillments_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetListingFulfillments_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *getListingFulfillmentsIter(req: GetListingFulfillments, options?: CallOptions): AsyncGenerator<ListingFulfillment> {
  ...
  async getPersonalizationRequestsForConsumer(req: GetPersonalizationRequestsForConsumer, options?: CallOptions): Promise<GetPersonalizationRequestsForConsumer_Response> {
    const url = `${this.host}/api/2.1/marketplace-consumer/listings/${req.listingId ?? ''}/personalization-requests`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetPersonalizationRequestsForConsumer_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async getPublishedListingForConsumer(req: GetPublishedListingForConsumer, options?: CallOptions): Promise<GetPublishedListingForConsumer_Response> {
  ...
  async getPublishedListingsForConsumer(req: GetPublishedListingsForConsumer, options?: CallOptions): Promise<GetPublishedListingsForConsumer_Response> {
    ...
    if (req.tags !== undefined) {
      flattenQueryParams('tags', marshalListingTagSchema.parse(req.tags), params);
    }
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetPublishedListingsForConsumer_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *getPublishedListingsForConsumerIter(req: GetPublishedListingsForConsumer, options?: CallOptions): AsyncGenerator<Listing> {
  ...
  async getPublishedProviderForConsumer(req: GetPublishedProviderForConsumer, options?: CallOptions): Promise<GetPublishedProviderForConsumer_Response> {
  ...
  async installListing(req: InstallListing, options?: CallOptions): Promise<InstallListing_Response> {
    const url = `${this.host}/api/2.1/marketplace-consumer/listings/${req.listingId ?? ''}/installations`;
  ...
  async listPublishedProvidersForConsumer(req: ListPublishedProvidersForConsumer, options?: CallOptions): Promise<ListPublishedProvidersForConsumer_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalListPublishedProvidersForConsumer_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *listPublishedProvidersForConsumerIter(req: ListPublishedProvidersForConsumer, options?: CallOptions): AsyncGenerator<ProviderInfo> {
    const pageReq: ListPublishedProvidersForConsumer = {...req};
    for (;;) {
      const resp = await this.listPublishedProvidersForConsumer(pageReq, options);
   ...
   */
  async searchPublishedListingsForConsumer(req: SearchPublishedListingsForConsumer, options?: CallOptions): Promise<SearchPublishedListingsForConsumer_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalSearchPublishedListingsForConsumer_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *searchPublishedListingsForConsumerIter(req: SearchPublishedListingsForConsumer, options?: CallOptions): AsyncGenerator<Listing> {
    const pageReq: SearchPublishedListingsForConsumer = {...req};
    for (;;) {
      const resp = await this.searchPublishedListingsForConsumer(pageReq, options);
      for (const item of resp.listings ?? []) {
        yield item;
      }
      if (resp.nextPageToken === undefined || resp.nextPageToken === '') {
  ...
  async uninstallListing(req: UninstallListing, options?: CallOptions): Promise<UninstallListing_Response> {
   ...
   */
  async updateInstallationDetail(req: UpdateInstallationDetail, options?: CallOptions): Promise<UpdateInstallationDetail_Response> {
    const url = `${this.host}/api/2.1/marketplace-consumer/listings/${req.listingId ?? ''}/installations/${req.installationId ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdateInstallationDetail_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async addExchangeForListing(req: AddExchangeForListingRequest, options?: CallOptions): Promise<AddExchangeForListingResponse> {
  ...
  /** Create an exchange */
  async createExchange(req: CreateExchangeRequest, options?: CallOptions): Promise<CreateExchangeResponse> {
  ...
  async createExchangeFilter(req: CreateExchangeFilterRequest, options?: CallOptions): Promise<CreateExchangeFilterResponse> {
  ...
  async createFile(req: CreateFileRequest, options?: CallOptions): Promise<CreateFileRequest_Response> {
  ...
  async createListing(req: CreateListingRequest, options?: CallOptions): Promise<CreateListingRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalCreateListingRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  /** Create a provider */
  async createProvider(req: CreateProviderRequest, options?: CallOptions): Promise<CreateProviderRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalCreateProviderRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async createProviderAnalyticsDashboard(req: CreateProviderAnalyticsDashboardRequest, options?: CallOptions): Promise<CreateProviderAnalyticsDashboardRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('POST', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalCreateProviderAnalyticsDashboardRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async deleteExchange(req: DeleteExchangeRequest, options?: CallOptions): Promise<DeleteExchangeResponse> {
  ...
  async deleteExchangeFilter(req: DeleteExchangeFilterRequest, options?: CallOptions): Promise<DeleteExchangeFilterResponse> {
  ...
  /** Delete a file */
  async deleteFile(req: DeleteFileRequest, options?: CallOptions): Promise<DeleteFileRequest_Response> {
  ...
  /** Delete a listing */
  async deleteListing(req: DeleteListingRequest, options?: CallOptions): Promise<DeleteListingRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('DELETE', url, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalDeleteListingRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  /** Delete provider */
  async deleteProvider(req: DeleteProviderRequest, options?: CallOptions): Promise<DeleteProviderRequest_Response> {
  ...
  /** Get an exchange. */
  async getExchange(req: GetExchangeRequest, options?: CallOptions): Promise<GetExchangeResponse> {
    const url = `${this.host}/api/2.0/marketplace-exchange/exchanges/${req.id ?? ''}`;
  ...
  /** Get a file */
  async getFile(req: GetFileRequest, options?: CallOptions): Promise<GetFileRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/files/${req.fileId ?? ''}`;
  ...
  async getLatestVersionProviderAnalyticsDashboard(_req: GetLatestVersionProviderAnalyticsDashboardRequest, options?: CallOptions): Promise<GetLatestVersionProviderAnalyticsDashboardRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/analytics_dashboard/latest`;
    let resp: GetLatestVersionProviderAnalyticsDashboardRequest_Response | undefined;
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      const headers = new Headers();
      headers.set('User-Agent', this.userAgent);
      const httpReq = buildHttpRequest('GET', url, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetLatestVersionProviderAnalyticsDashboardRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  /** Get a listing */
  async getListing(req: GetListingRequest, options?: CallOptions): Promise<GetListingRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/listings/${req.id ?? ''}`;
  ...
  async getListings(req: GetListingsRequest, options?: CallOptions): Promise<GetListingsRequest_Response> {
  ...
  async *getListingsIter(req: GetListingsRequest, options?: CallOptions): AsyncGenerator<Listing> {
   ...
   */
  async getPersonalizationRequestsForProvider(req: GetPersonalizationRequestsForProviderRequest, options?: CallOptions): Promise<GetPersonalizationRequestsForProviderRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', fullUrl, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetPersonalizationRequestsForProviderRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async *getPersonalizationRequestsForProviderIter(req: GetPersonalizationRequestsForProviderRequest, options?: CallOptions): AsyncGenerator<PersonalizationRequest> {
    const pageReq: GetPersonalizationRequestsForProviderRequest = {...req};
    for (;;) {
      const resp = await this.getPersonalizationRequestsForProvider(pageReq, options);
      for (const item of resp.personalizationRequests ?? []) {
        yield item;
      }
      if (resp.nextPageToken === undefined || resp.nextPageToken === '') {
  ...
  async getProvider(req: GetProviderRequest, options?: CallOptions): Promise<GetProviderRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/providers/${req.id ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', url, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalGetProviderRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async listExchangeFilters(req: ListExchangeFiltersRequest, options?: CallOptions): Promise<ListExchangeFiltersResponse> {
    const url = `${this.host}/api/2.0/marketplace-exchange/filters`;
    const params = new URLSearchParams();
  ...
  async *listExchangeFiltersIter(req: ListExchangeFiltersRequest, options?: CallOptions): AsyncGenerator<ExchangeFilter> {
  ...
  async listExchanges(req: ListExchangesRequest, options?: CallOptions): Promise<ListExchangesResponse> {
    const url = `${this.host}/api/2.0/marketplace-exchange/exchanges`;
    const params = new URLSearchParams();
    if (req.pageToken !== undefined) {
      params.append('page_token', req.pageToken);
  ...
  async *listExchangesIter(req: ListExchangesRequest, options?: CallOptions): AsyncGenerator<Exchange> {
  ...
  async listExchangesForListing(req: ListExchangesForListingRequest, options?: CallOptions): Promise<ListExchangesForListingResponse> {
    const url = `${this.host}/api/2.0/marketplace-exchange/exchanges-for-listing`;
    const params = new URLSearchParams();
  ...
  async *listExchangesForListingIter(req: ListExchangesForListingRequest, options?: CallOptions): AsyncGenerator<ExchangeListing> {
  ...
  async listFiles(req: ListFilesRequest, options?: CallOptions): Promise<ListFilesRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/files`;
    const params = new URLSearchParams();
  ...
  async *listFilesIter(req: ListFilesRequest, options?: CallOptions): AsyncGenerator<FileInfo> {
  ...
  async listListingsForExchange(req: ListListingsForExchangeRequest, options?: CallOptions): Promise<ListListingsForExchangeResponse> {
  ...
  async *listListingsForExchangeIter(req: ListListingsForExchangeRequest, options?: CallOptions): AsyncGenerator<ExchangeListing> {
  ...
  async listProviderAnalyticsDashboard(_req: ListProviderAnalyticsDashboardRequest, options?: CallOptions): Promise<ListProviderAnalyticsDashboardRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/analytics_dashboard`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('GET', url, headers, callSignal);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalListProviderAnalyticsDashboardRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async listProviders(req: ListProvidersRequest, options?: CallOptions): Promise<ListProvidersRequest_Response> {
  ...
  async *listProvidersIter(req: ListProvidersRequest, options?: CallOptions): AsyncGenerator<ProviderInfo> {
  ...
  async removeExchangeForListing(req: RemoveExchangeForListingRequest, options?: CallOptions): Promise<RemoveExchangeForListingResponse> {
  ...
  /** Update an exchange */
  async updateExchange(req: UpdateExchangeRequest, options?: CallOptions): Promise<UpdateExchangeResponse> {
    const url = `${this.host}/api/2.0/marketplace-exchange/exchanges/${req.id ?? ''}`;
  ...
  async updateExchangeFilter(req: UpdateExchangeFilterRequest, options?: CallOptions): Promise<UpdateExchangeFilterResponse> {
    const url = `${this.host}/api/2.0/marketplace-exchange/filters/${req.id ?? ''}`;
  ...
  /** Update a listing */
  async updateListing(req: UpdateListingRequest, options?: CallOptions): Promise<UpdateListingRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/listings/${req.id ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('PUT', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdateListingRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async updatePersonalizationRequestStatus(req: UpdatePersonalizationRequestStatusRequest, options?: CallOptions): Promise<UpdatePersonalizationRequestStatusRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('PUT', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdatePersonalizationRequestStatusRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async updateProvider(req: UpdateProviderRequest, options?: CallOptions): Promise<UpdateProviderRequest_Response> {
    const url = `${this.host}/api/2.0/marketplace-provider/providers/${req.id ?? ''}`;
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('PUT', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdateProviderRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
  ...
  async updateProviderAnalyticsDashboard(req: UpdateProviderAnalyticsDashboardRequest, options?: CallOptions): Promise<UpdateProviderAnalyticsDashboardRequest_Response> {
    ...
    const call: Call = async (callSignal?: AbortSignal): Promise<void> => {
      ...
      const httpReq = buildHttpRequest('PUT', url, headers, callSignal, body);
      const respBody = await executeHttpCall({request: httpReq, httpClient: this.httpClient, logger: this.logger});
      resp = parseResponse(respBody, unmarshalUpdateProviderAnalyticsDashboardRequest_ResponseSchema);
    };
    await executeCall(call, options);
    if (resp === undefined) {
      throw new Error('API call completed without a result.');
