...
export const marshalCreateEntityTagAssignmentRequestSchema = z
  .object({
...
export const marshalDeleteEntityTagAssignmentRequestSchema = z
  .object({
...
export const marshalEntityTagAssignmentSchema = z
  .object({
    entityName: z.string().optional(),
    tagKey: z.string().optional(),
...
export const marshalGetEntityTagAssignmentRequestSchema = z
  .object({
    entityName: z.string().optional(),
    tagKey: z.string().optional(),
    entityType: z.string().optional(),
...
export const marshalListEntityTagAssignmentsRequestSchema = z
  .object({
    entityName: z.string().optional(),
...
export const marshalListEntityTagAssignmentsResponseSchema = z
  .object({
    tagAssignments: z
...
export const marshalUpdateEntityTagAssignmentRequestSchema = z
  .object({
    tagAssignment: z.lazy(() => marshalEntityTagAssignmentSchema).optional(),
