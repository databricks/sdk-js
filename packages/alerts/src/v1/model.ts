...
export const marshalAlertSchema = z
  .object({
    id: z.string().optional(),
...
export const marshalAlertConditionSchema = z
  .object({
    op: z.enum(AlertOperator).optional(),
...
export const marshalAlertOperandSchema = z
  .object({
...
export const marshalAlertOperandColumnSchema = z
  .object({
    name: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalAlertOperandValueSchema = z
  .object({
...
export const marshalCreateAlertRequestSchema = z
  .object({
...
export const marshalCreateAlertRequestAlertSchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    queryId: z.string().optional(),
...
export const marshalGetAlertRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalListAlertsRequestSchema = z
  .object({
...
export const marshalListAlertsResponseSchema = z
  .object({
    results: z
...
export const marshalListAlertsResponseAlertSchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    queryId: z.string().optional(),
...
export const marshalTrashAlertRequestSchema = z
  .object({
    id: z.string().optional(),
  })
  .transform(d => ({
...
export const marshalUpdateAlertRequestSchema = z
  .object({
...
export const marshalUpdateAlertRequestAlertSchema = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
    queryId: z.string().optional(),
