...
export const marshalAlertEvaluationSchema = z
  .object({
...
export const marshalAlertNotificationSchema = z
  .object({
    subscriptions: z
...
export const marshalAlertRunAsSchema = z
  .object({
...
export const marshalAlertSubscriptionSchema = z
  .object({
