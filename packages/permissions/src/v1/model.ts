...
export const unmarshalAccessControlRequestSchema = z
  .object({
...
export const unmarshalAccessControlResponseSchema = z
  .object({
    user_name: z.string().optional(),
    group_name: z.string().optional(),
    service_principal_name: z.string().optional(),
...
export const unmarshalGetObjectPermissionsSchema = z
  .object({
...
export const unmarshalGetPermissionLevelsSchema = z
  .object({
    request_object_type: z.string().optional(),
    request_object_id: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const unmarshalGetPermissionLevels_ResponseSchema = z
  .object({
    permission_levels: z
...
export const unmarshalPermissionSchema = z
  .object({
    permission_level: z.enum(PermissionLevel).optional(),
...
export const unmarshalPermissionsDescriptionSchema = z
  .object({
    permission_level: z.enum(PermissionLevel).optional(),
...
export const unmarshalPermissionsResponseSchema = z
  .object({
...
export const unmarshalSetObjectPermissionsSchema = z
  .object({
    request_object_type: z.string().optional(),
    request_object_id: z.string().optional(),
    access_control_list: z
...
export const unmarshalUpdateObjectPermissionsSchema = z
  .object({
    request_object_type: z.string().optional(),
    request_object_id: z.string().optional(),
    access_control_list: z
...
export const marshalAccessControlRequestSchema = z
  .object({
...
export const marshalAccessControlResponseSchema = z
  .object({
    userName: z.string().optional(),
    groupName: z.string().optional(),
    servicePrincipalName: z.string().optional(),
...
export const marshalGetObjectPermissionsSchema = z
  .object({
...
export const marshalGetPermissionLevelsSchema = z
  .object({
    requestObjectType: z.string().optional(),
    requestObjectId: z.string().optional(),
  })
...
// eslint-disable-next-line @typescript-eslint/naming-convention -- Proto-style nested message name.
export const marshalGetPermissionLevels_ResponseSchema = z
  .object({
    permissionLevels: z
...
export const marshalPermissionSchema = z
  .object({
    permissionLevel: z.enum(PermissionLevel).optional(),
    inherited: z.boolean().optional(),
...
export const marshalPermissionsDescriptionSchema = z
  .object({
    permissionLevel: z.enum(PermissionLevel).optional(),
    description: z.string().optional(),
  })
...
export const marshalPermissionsResponseSchema = z
  .object({
...
export const marshalSetObjectPermissionsSchema = z
  .object({
    requestObjectType: z.string().optional(),
    requestObjectId: z.string().optional(),
    accessControlList: z
...
export const marshalUpdateObjectPermissionsSchema = z
  .object({
    requestObjectType: z.string().optional(),
    requestObjectId: z.string().optional(),
    accessControlList: z
