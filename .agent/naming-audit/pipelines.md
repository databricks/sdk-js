...
**Files audited:**
- `src/v2/model.ts` (5,461 lines) — 26 enums, 100 interfaces, marshal/unmarshal schemas.
- `src/v2/client.ts` (642 lines) — 11 public RPC methods + 2 paginators + private `stopBase` + `StopWaiter`.
- `src/v2/utils.ts` (181 lines) — generic HTTP/marshal helpers (no domain names).
- `src/v2/index.ts` (135 lines) — re-exports.
...
- **Locations:** `model.ts:229` (`UpdateCause`), `model.ts:251` (`UpdateState`), `model.ts:904` (`GetUpdateRequest`), `model.ts:1432` (`ListUpdatesRequest`), `model.ts:2408` (`StartUpdateRequest`), `model.ts:2513` (`UpdateInfo`), `model.ts:2551` (`UpdateStateInfo`), `client.ts:368` (`getUpdate`), `client.ts:458` (`listUpdates`), `client.ts:499` (`start`).
...
- **Locations:** `model.ts:352` (`ScdType_ScdType`), `index.ts:27`.
...
- **Locations:** `model.ts:1500`, plus all `notifications?: Notifications[]` field declarations.
...
- **Locations:** `model.ts:2239`, `model.ts:2244`.
- **Category:** 16.
...
- **Locations:** `model.ts:2307` (`cascade`), `model.ts:2309` (`resetCheckpoints`).
- **Category:** 16.
