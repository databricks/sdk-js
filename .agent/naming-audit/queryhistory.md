...
### 1. `QueryInfo` — "Info" suffix on a top-level domain entity — `src/v1/model.ts:192`
...
### 2. `PlansState` — vague type name — `src/v1/model.ts:19`
...
### 3. `QueryTag.key` — required field marked optional — `src/v1/model.ts:359`
