...
### 1. `ListNetworkRequest` — `src/v1/model.ts:1294`
- **Why weird:** The noun is singular (`Network`) where the sibling list
  ...
  at line 1280, `ListNetworkConnectivityConfigsRequest` at line 1266).
...
### 2. `ListNetworkResponse` — `src/v1/model.ts:1298`
- **Why weird:** Same singular/plural mismatch as #1. Sibling list
  response types pluralise (`ListNetworkPoliciesResponse` at line 1287,
  `ListNetworkConnectivityConfigsResponse` at line 1274).
- **Category:** Singular/plural inconsistency.
- **Suggested name:** `ListNetworksResponse`.
- **Rationale:** Same as #1.

### 3. `ListVpcEndpointRequest` — `src/v1/model.ts:1310`
- **Why weird:** Same singular/plural mismatch as #1. The list request
  for VPC endpoints uses a singular noun.
- **Category:** Singular/plural inconsistency.
...
### 4. `ListVpcEndpointResponse` — `src/v1/model.ts:1314`
