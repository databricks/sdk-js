...
### 22. `Dataset[]` plural-singular consistency — `src/v1/model.ts:32,52`
...
### 23. `customLlmFieldMask` function name — `src/v1/model.ts:259`
...
### 25. `readAll` helper — `src/v1/utils.ts:40`
...
### 26. `Call` import alias — `src/v1/client.ts:4`
...
### 27. `info` / `host` / `body` short locals — `src/v1/client.ts:58,73,74`
...
### 28. `resp` local variable in every method — `src/v1/client.ts:98,142,171,197`
...
### 29. Action verbs in `Client` are consistent
