...
### 7. `CustomPolicyTag` type name — `src/v1/model.ts:51`
...
### 8. `CustomPolicyTag` reserved-key documentation — `src/v1/model.ts:55-56`
...
### 9. `Filter.policyName` / `Filter.creatorUserId` / `Filter.creatorUserName` — `src/v1/model.ts:80,85,90`
...
### 10. `Filter.creatorUserId: number` vs `Filter.creatorUserName: string` — `src/v1/model.ts:85,90`
...
### 11. `Filter.creatorUserId: number` representation — `src/v1/model.ts:85`
...
### 12. `SortSpec` type — `src/v1/model.ts:147`
...
### 13. `SortSpec.field` JSDoc typo "The filed to sort by" — `src/v1/model.ts:148`
...
### 14. `ListBudgetPoliciesResponse.policies` field name — `src/v1/model.ts:134`
...
### 15. `ListBudgetPoliciesResponse.previousPageToken` — `src/v1/model.ts:144`
...
### 16. `ListBudgetPoliciesResponse.previousPageToken` doc typo — `src/v1/model.ts:142`
...
### 17. `SortSpec_Field` enum name — `src/v1/model.ts:6`
...
### 18. `CreateBudgetPolicyRequest.policy` field with confusing JSDoc — `src/v1/model.ts:44-46`
...
### 19. `UpdateBudgetPolicyRequest.policy` doc mentions `creator_user_id` — `src/v1/model.ts:157`
...
### 20. `executeCall` / `executeHttpCall` naming pair — `src/v1/utils.ts:26,65`
...
### 24. `PACKAGE_SEGMENT` constant — `src/v1/client.ts:41`
...
### 25. `Client` class plain name — `src/v1/client.ts:46`
...
### 26. `req` parameter name on client methods — `src/v1/client.ts:77,103,122,147,194,212`
...
### 28. Wire-form vs TS-form casing of `policyId` (path interpolation) — `src/v1/client.ts:80,106,125,150,215`
...
### 29. Package name `budgetpolicy` overlaps with `budgets` and `usagepolicy`
