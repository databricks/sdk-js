...
### 1. `ExternalLineageRelationshipObject.tpe` discriminator — `src/v1/model.ts:140`
...
### 2. `LineageFileInfo.securableName`, `securableType`, `storageLocation` — `src/v1/model.ts:179-183`
