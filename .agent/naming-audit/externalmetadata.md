...
### 11. `ExternalMetadata.systemType: SystemType` — `src/v1/model.ts:47`
...
### 12. `ExternalMetadata.entityType` — `src/v1/model.ts:49`
...
### 13. `ExternalMetadata.url` — `src/v1/model.ts:51`
...
### 14. `ExternalMetadata.description` — `src/v1/model.ts:53`
...
### 15. `ExternalMetadata.columns: string[]` — `src/v1/model.ts:55`
...
### 16. `ExternalMetadata.properties` — `src/v1/model.ts:57`
...
### 17. `ExternalMetadata.owner` — `src/v1/model.ts:59`
...
### 18. `ExternalMetadata.metastoreId` — `src/v1/model.ts:61`
...
### 19. `ExternalMetadata.createTime` / `updateTime` — `src/v1/model.ts:63,67`
...
### 20. `ExternalMetadata.updateTime` vs. `Client.updateExternalMetadataV2` — `src/v1/model.ts:67, src/v1/client.ts:212`
...
### 21. `UpdateExternalMetadataRequest.updateMask: FieldMask<ExternalMetadata>` — `src/v1/model.ts:101`
...
### 22. `executeCall` vs. `executeHttpCall` — `src/v1/utils.ts:26,65`
...
### 23. `CreateExternalMetadataRequest` / `DeleteExternalMetadataRequest` / `GetExternalMetadataRequest` / `ListExternalMetadataRequest` / `UpdateExternalMetadataRequest` — `src/v1/model.ts:35,39,80,84,99`
...
### 24. `ListExternalMetadataResponseV2.externalMetadata: ExternalMetadata[]` — `src/v1/model.ts:95`
...
### 26. `Call` type and `call` variable — `src/v1/client.ts:80,107,130,169,228`
...
### 27. `req` / `resp` / `respBody` / `httpReq` variables — `src/v1/client.ts:71-95, 103-118, etc.`
...
### 28. `pageReq` — `src/v1/client.ts:194`
...
### 29. `body` parameter on `buildHttpRequest` — `src/v1/utils.ts:101`
...
### 31. `readAll(body)` — `src/v1/utils.ts:40`
...
### 32. `HttpCallOptions` — `src/v1/utils.ts:15`
...
- `properties` — user-defined `Record<string,string>` (see #16 for naming concern).
