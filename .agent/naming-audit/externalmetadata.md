...
**Path:** `packages/uc/externalmetadata/src/v1/`
**Versions audited:** v1
...
### 1. `ExternalMetadata` — `src/v1/model.ts:47`
...
### 2. `ListExternalMetadataResponseV2` — `src/v1/model.ts:92`
...
### 3. `ExternalMetadataClient.createExternalMetadataV2` / `deleteExternalMetadataV2` / `getExternalMetadataV2` / `listExternalMetadataV2` / `updateExternalMetadataV2` / `listExternalMetadataV2Iter` — `src/v1/client.ts:71,107,133,167,229,207`
