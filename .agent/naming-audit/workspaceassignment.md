...
### 5. `GetWorkspacePermissionAssignments` request type for an HTTP `GET` that returns a *list* — `src/v1/model.ts:26`, `src/v1/client.ts:102`
...
### 6. `ListWorkspacePermissions` returns a static catalog, not data — `src/v1/model.ts:50`, `src/v1/client.ts:142`
...
### 7. `PermissionOutput` / `PrincipalOutput` / `WorkspacePermissionAssignmentOutput` `Output` suffix — `src/v1/model.ts:63,70,115`
...
### 8. `WorkspacePermissionAssignmentOutput` vs `iam.WorkspaceAssignmentDetail` duplicate concept — `src/v1/model.ts:115` vs `packages/iam/src/v2/model.ts:983`
...
### 9. `PrincipalOutput.principalName` discriminated union — `src/v1/model.ts:71-87`
...
### 10. `accountId` doc comment "The account ID." — `src/v1/model.ts:14,28,51,95`
...
### 11. `workspaceId?: number` typed as `number` — `src/v1/model.ts:17,30,53,97`
...
### 14. `WorkspacePermissionAssignmentOutput.error?: string` — `src/v1/model.ts:121`
...
### 15. `PermissionOutput.description` doc comment "The results of a permissions query." — `src/v1/model.ts:65-66`
...
### 16. `PrincipalOutput.principalName` discriminator tag values use camelCase — `src/v1/model.ts:73,78,83`
...
### 17. `PrincipalOutput.principalId: number` opaque ID doc — `src/v1/model.ts:88-89`
...
### 18. `UpdateWorkspacePermissionAssignment.permissions` doc paragraph — `src/v1/model.ts:101-107`
...
### 19. `PrincipalOutput.principalName.servicePrincipalName: string` — `src/v1/model.ts:83-86`
...
### 20. `nextPageToken` / `prevPageToken` asymmetric naming — `src/v1/model.ts:44,46`
...
### 21. `GetWorkspacePermissionAssignments.filter?: string` — `src/v1/model.ts:36`
...
### 22. `GetWorkspacePermissionAssignments.maxResults` plural-confusing — `src/v1/model.ts:34`
...
### 23. `permissionassignments` URL fragment is one word — `src/v1/client.ts:78,106,146,174`
...
### 24. `accountId?: string | undefined` doc placement — `src/v1/model.ts:14,15`
...
### 25. `displayName` doc terseness — `src/v1/model.ts:91`
...
### 26. `Permission.USER` doc string — `src/v1/model.ts:7-8`
...
### 27. `URL path interpolation uses unencoded segments` — `src/v1/client.ts:78,106,146,174`
...
### 28. Side-by-side `getWorkspacePermissionAssignments` and `listWorkspacePermissions` — `src/v1/client.ts:102,142`
